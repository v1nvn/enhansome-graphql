...
* [GraphQL](https://github.com/graphql/graphql-spec) ⭐ 14,754 | 🐛 204 | 🌐 JavaScript | 📅 2026-03-09 - Working draft of the specification for GraphQL.
...
* [graphql-js](https://github.com/graphql/graphql-js) ⭐ 20,333 | 🐛 132 | 🌐 TypeScript | 📅 2026-03-12 - A reference implementation of GraphQL for JavaScript.
...
* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,725 | 🐛 421 | 🌐 TypeScript | 📅 2026-03-15 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
* [aws-amplify](https://github.com/aws-amplify/amplify-js) ⭐ 9,595 | 🐛 476 | 🌐 TypeScript | 📅 2026-03-13 - A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.
...
* [graphql-zeus](https://github.com/graphql-editor/graphql-zeus) ⭐ 1,976 | 🐛 54 | 🌐 TypeScript | 📅 2026-02-20 - GraphQL Zeus creates autocomplete client library for `JavaScript` or `TypeScript` which provides autocompletion for strongly typed queries.
* [gqty](https://github.com/gqty-dev/gqty) ⭐ 1,033 | 🐛 51 | 🌐 TypeScript | 📅 2026-03-15 - A No GraphQL client for TypeScript
...
* [sveltekit-kitql](https://github.com/jycouet/kitql) ⭐ 453 | 🐛 13 | 🌐 TypeScript | 📅 2026-03-14 - A set of tools, helping you building efficient apps in a fast way with SvelteKit and GraphQL.
...
* [relay](https://github.com/facebook/relay) ⭐ 18,938 | 🐛 819 | 🌐 Rust | 📅 2026-03-16 - Relay is a JavaScript framework for building data-driven React applications.
* [urql](https://github.com/FormidableLabs/urql) ⭐ 8,940 | 🐛 36 | 🌐 TypeScript | 📅 2026-02-26 - A simple caching GraphQL client for React.
...
* [@gqty/react](https://github.com/gqty-dev/gqty) ⭐ 1,033 | 🐛 51 | 🌐 TypeScript | 📅 2026-03-15 - A No GraphQL client for TypeScript
...
* [apollo-server](https://github.com/apollographql/apollo-server) ⭐ 13,954 | 🐛 79 | 🌐 TypeScript | 📅 2026-03-14 - Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
* [graphql-yoga](https://github.com/prisma-labs/graphql-yoga) ⭐ 8,496 | 🐛 128 | 🌐 TypeScript | 📅 2026-03-16 - Fully-featured GraphQL Server with focus on easy setup, performance and great developer experience.
* [mercurius](https://github.com/mercurius-js/mercurius) ⭐ 2,477 | 🐛 67 | 🌐 JavaScript | 📅 2026-03-13 - GraphQL plugin for Fastify.
...
* [pylon](https://github.com/getcronit/pylon) ⭐ 367 | 🐛 27 | 🌐 TypeScript | 📅 2026-03-15 - Write full-feature APIs with just functions. No more boilerplate code, no more setup. Just write functions and deploy.
* [gql](https://github.com/deno-libs/gql) ⭐ 202 | 🐛 0 | 🌐 TypeScript | 📅 2026-01-20 - Universal GraphQL HTTP middleware for Deno.
* [graphitejs](https://github.com/graphitejs/server) ⭐ 122 | 🐛 16 | 🌐 JavaScript | 📅 2026-03-13 - Framework NodeJS for GraphQL.
...
* [graphql-scalars](https://github.com/Urigo/graphql-scalars) ⭐ 1,935 | 🐛 43 | 🌐 TypeScript | 📅 2026-03-16 - A library of custom GraphQL Scalars for creating precise type-safe GraphQL schemas.

#### Type

* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,223 | 🐛 617 | 🌐 TypeScript | 📅 2026-03-14: GraphQL code generator with flexible support for custom plugins and templates like TypeScript (frontend and backend), React Hooks, resolvers signatures and more.
* [type-graphql](https://github.com/19majkel94/type-graphql) ⭐ 8,094 | 🐛 111 | 🌐 TypeScript | 📅 2026-03-10 - Create GraphQL schema and resolvers with TypeScript, using classes and decorators!
* [graphql-nexus](https://github.com/graphql-nexus/nexus) ⭐ 3,423 | 🐛 254 | 🌐 TypeScript | 📅 2023-11-19 - Code-First, Type-Safe, GraphQL Schema Construction.
* [gql.tada](https://github.com/0no-co/gql.tada) ⭐ 2,921 | 🐛 25 | 🌐 TypeScript | 📅 2025-11-12 - GraphQL document authoring library, inferring the result and variables types of GraphQL queries and fragments in the TypeScript type system.
* [pothos](https://github.com/hayes/pothos) ⭐ 2,582 | 🐛 62 | 🌐 TypeScript | 📅 2026-02-25 - Pothos is a plugin based GraphQL schema builder for typescript. It makes building graphql schemas in typescript easy, fast and enjoyable.
...
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 94 | 🐛 10 | 🌐 TypeScript | 📅 2026-03-16 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,495 | 🐛 136 | 🌐 TypeScript | 📅 2026-03-13, [Zod](https://github.com/colinhacks/zod) ⭐ 42,132 | 🐛 283 | 🌐 TypeScript | 📅 2026-02-15, or [Yup](https://github.com/jquense/yup) ⭐ 23,692 | 🐛 240 | 🌐 TypeScript | 📅 2026-03-15.
...
* [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,423 | 🐛 151 | 🌐 TypeScript | 📅 2026-03-16 - Tool library for building and maintaining GraphQL-JS servers.
* [graphql-shield](https://github.com/maticzav/graphql-shield) ⭐ 3,575 | 🐛 108 | 🌐 TypeScript | 📅 2026-03-13 - A library that helps creating a permission layer for a graphql api.
* [graphql-mesh](https://github.com/urigo/graphql-mesh) ⭐ 3,489 | 🐛 213 | 🌐 TypeScript | 📅 2026-03-16 - use GraphQL query language to access data in remote APIs that don't run GraphQL (and also ones that do run GraphQL).
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,109 | 🐛 37 | 🌐 Python | 📅 2026-03-15 - Runs arbitrary queries matching a GraphQL schema to find server errors.
* [graphql-tag](https://github.com/apollographql/graphql-tag) ⭐ 2,337 | 🐛 100 | 🌐 TypeScript | 📅 2024-01-25 - A JavaScript template literal tag that parses GraphQL queries.
...
* [graphql-ws](https://github.com/enisdenjo/graphql-ws) ⭐ 1,859 | 🐛 10 | 🌐 TypeScript | 📅 2026-01-27 - Coherent, zero-dependency, lazy, simple, GraphQL over WebSocket Protocol compliant server and client.
* [graphql-relay-js](https://github.com/graphql/graphql-relay-js) ⭐ 1,546 | 🐛 25 | 🌐 TypeScript | 📅 2025-10-02 - A library to help construct a graphql-js server supporting react-relay.
* [graphql-modules](https://github.com/Urigo/graphql-modules) ⭐ 1,328 | 🐛 53 | 🌐 TypeScript | 📅 2026-03-16 - Separate GraphQL server into smaller, reusable parts by modules or features.
* [eslint-plugin-graphql](https://github.com/apollographql/eslint-plugin-graphql) ⭐ 1,216 | 🐛 100 | 🌐 JavaScript | 📅 2026-03-13 - An ESLint plugin that checks your GraphQL strings against a schema.
...
* [graphql-config](https://github.com/kamilkisiela/graphql-config) ⭐ 1,199 | 🐛 25 | 🌐 TypeScript | 📅 2026-03-15 - One configuration for all your GraphQL tools (supported by most tools, editors & IDEs).
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,175 | 🐛 151 | 🌐 TypeScript | 📅 2026-03-15 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
...
* [sofa](https://github.com/Urigo/sofa) ⭐ 1,115 | 🐛 38 | 🌐 TypeScript | 📅 2026-03-15 - Generate REST API from your GraphQL API.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 816 | 🐛 41 | 🌐 Go | 📅 2026-03-13 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
* [GraphQL Constraint Directive](https://github.com/confuser/graphql-constraint-directive) ⭐ 577 | 🐛 43 | 🌐 JavaScript | 📅 2026-03-13 - Allows using @constraint as a directive to validate input data. Inspired by Constraints Directives RFC and OpenAPI
* [graphql-armor](https://github.com/Escape-Technologies/graphql-armor) ⭐ 576 | 🐛 30 | 🌐 TypeScript | 📅 2026-03-15 - An instant security layer for production GraphQL Endpoints.
* [graphql-let](https://github.com/piglovesyou/graphql-let) ⭐ 452 | 🐛 64 | 🌐 TypeScript | 📅 2026-03-13 - A webpack loader to import type-protected codegen results directly from GraphQL documents
* [graphql-live-query](https://github.com/n1ru4l/graphql-live-query) ⭐ 441 | 🐛 52 | 🌐 TypeScript | 📅 2026-03-14 - Realtime GraphQL Live Queries with JavaScript.
...
* [microfiber](https://github.com/anvilco/graphql-introspection-tools) ⭐ 37 | 🐛 9 | 🌐 JavaScript | 📅 2024-01-29 - Query and manipulate GraphQL introspection query results in useful ways.
* [supertest-graphql](https://github.com/alexstrat/supertest-graphql) ⭐ 34 | 🐛 12 | 🌐 TypeScript | 📅 2023-01-24 - Extends [supertest](https://github.com/visionmedia/supertest) ⭐ 14,334 | 🐛 181 | 🌐 JavaScript | 📅 2026-02-28 to easily test a GraphQL endpoint
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 138,341 | 🐛 3,481 | 🌐 JavaScript | 📅 2026-03-16 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
* [React Starter Kit](https://github.com/kriasoft/react-starter-kit) ⭐ 23,542 | 🐛 9 | 🌐 TypeScript | 📅 2026-03-02 - front-end starter kit using React, Relay, GraphQL, and JAM stack architecture.
...
* [NAPERG](https://github.com/alan345/naperg) ⭐ 1,372 | 🐛 0 | 🌐 TypeScript | 📅 2026-03-08 - Fullstack Boilerplate GraphQL. Made with React & Prisma + authentication & roles.
...
* [Relay TodoMVC](https://github.com/taion/relay-todomvc) ⭐ 158 | 🐛 39 | 🌐 JavaScript | 📅 2026-03-13 - Relay TodoMVC with routing.
...
* [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,430 | 🐛 76 | 🌐 Ruby | 📅 2026-03-12 - Ruby implementation of Facebook's GraphQL.
...
* [agoo](https://github.com/ohler55/agoo) ⭐ 926 | 🐛 5 | 🌐 C | 📅 2025-09-24 - Ruby web server that implements Facebook's GraphQL.
...
* [agoo-demo](https://github.com/ohler55/agoo/tree/develop/example/graphql) ⭐ 926 | 🐛 5 | 🌐 C | 📅 2025-09-24 - Use of the Agoo server to demonstrate a simple GraphQL application.
...
* [graphql-php](https://github.com/webonyx/graphql-php) ⭐ 4,710 | 🐛 56 | 🌐 PHP | 📅 2026-03-15 - A PHP port of GraphQL reference implementation.
* [wp-graphql](https://github.com/wp-graphql/wp-graphql) ⭐ 3,772 | 🐛 106 | 🌐 PHP | 📅 2026-03-16 - GraphQL API for WordPress.
* [lighthouse](https://github.com/nuwave/lighthouse) ⭐ 3,483 | 🐛 133 | 🌐 PHP | 📅 2026-03-09 - A PHP package that allows to serve a GraphQL endpoint from your Laravel application.
* [graphql-laravel](https://github.com/rebing/graphql-laravel) ⭐ 2,213 | 🐛 13 | 🌐 PHP | 📅 2026-03-06 - Laravel wrapper for Facebook's GraphQL.
...
* [overblog/graphql-bundle](https://github.com/overblog/GraphQLBundle) ⭐ 797 | 🐛 131 | 🌐 PHP | 📅 2026-03-12 - This bundle provides tools to build a complete GraphQL server in your Symfony App. Supports react-relay.
...
* [graphene](https://github.com/graphql-python/graphene) ⭐ 8,253 | 🐛 111 | 🌐 Python | 📅 2025-09-04 - A package for creating GraphQL schemas/types in a Pythonic easy way.
* [strawberry](https://github.com/strawberry-graphql/strawberry) ⭐ 4,631 | 🐛 455 | 🌐 Python | 📅 2026-03-15 - A new GraphQL library for Python.
...
* [Ariadne](https://github.com/mirumee/ariadne) ⭐ 2,326 | 🐛 27 | 🌐 Python | 📅 2026-03-13 - library for implementing GraphQL servers using schema-first approach. Asynchronous query execution, batteries included for ASGI, WSGI and popular webframeworks, [fully documented](https://ariadnegraphql.org).
...
* [turms](https://github.com/jhnnsrs/turms) ⭐ 75 | 🐛 21 | 🌐 Python | 📅 2025-10-29 - A pythonic graphql codegenerator built around graphql-core and pydantic
...
* [graphql-java](https://github.com/graphql-java/graphql-java) ⭐ 6,233 | 🐛 68 | 🌐 Java | 📅 2026-03-16 - GraphQL Java implementation.
* [DGS Framework](https://github.com/Netflix/dgs-framework) ⭐ 3,307 | 🐛 49 | 🌐 Kotlin | 📅 2026-03-16 - A GraphQL server framework for Spring Boot, developed by Netflix.
...
* [federation-jvm](https://github.com/apollographql/federation-jvm) ⭐ 272 | 🐛 22 | 🌐 Java | 📅 2026-03-10 - Apollo Federation on the JVM.
* [graphql-java-servlet](https://github.com/graphql-java-kickstart/graphql-java-servlet) ⭐ 226 | 🐛 23 | 🌐 Java | 📅 2026-03-13 - A framework-agnostic java servlet for exposing graphql-java query endpoints with GET, POST, and multipart uploads.
...
* [graphql-java-codegen-maven-plugin](https://github.com/kobylynskyi/graphql-java-codegen-maven-plugin) ⭐ 17 | 🐛 0 | 📅 2020-04-09 - Schema-first maven plugin for generating Java types and Resolver interfaces. Works perfectly in conjunction with graphql-java-tools. Inspired by [swagger-codegen-maven-plugin](https://github.com/swagger-api/swagger-codegen/tree/master/modules/swagger-codegen-maven-plugin) ⭐ 17,718 | 🐛 3,443 | 🌐 Mustache | 📅 2026-03-14.
...
* [graphql-java-datetime](https://github.com/donbeave/graphql-java-datetime) ⭐ 152 | 🐛 6 | 🌐 Java | 📅 2026-03-15 - GraphQL ISO Date is a set of RFC 3339 compliant date/time scalar types to be used with graphql-java.
...
* [graphql-kotlin](https://github.com/ExpediaGroup/graphql-kotlin) ⭐ 1,799 | 🐛 90 | 🌐 Kotlin | 📅 2026-03-12 - GraphQL Kotlin implementation.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,688 | 🐛 379 | 🌐 Go | 📅 2026-03-13 - Go generate based graphql server library.
...
* [graphql-go](https://github.com/graph-gophers/graphql-go) ⭐ 4,748 | 🐛 21 | 🌐 Go | 📅 2026-03-14 - GraphQL server with a focus on ease of use.
* [graphjin](https://github.com/dosco/graphjin) ⭐ 3,033 | 🐛 17 | 🌐 Go | 📅 2026-03-15: Build APIs in 5 minutes with GraphQL. An instant GraphQL to SQL compiler.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 816 | 🐛 41 | 🌐 Go | 📅 2026-03-13 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
* [sangria](https://github.com/sangria-graphql/sangria) ⭐ 1,963 | 🐛 65 | 🌐 Scala | 📅 2026-03-08 - Scala GraphQL server implementation.
* [caliban](https://github.com/ghostdogpr/caliban) ⭐ 988 | 🐛 27 | 🌐 Scala | 📅 2026-03-14 - Caliban is a purely functional library for creating GraphQL backends in Scala.
* [sangria-relay](https://github.com/sangria-graphql/sangria-relay) ⭐ 90 | 🐛 10 | 🌐 Scala | 📅 2026-03-14 - Sangria Relay Support.
...
* [graphql-dotnet](https://github.com/graphql-dotnet/graphql-dotnet) ⭐ 5,983 | 🐛 106 | 🌐 C# | 📅 2026-03-15 - GraphQL for .NET.
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,672 | 🐛 358 | 🌐 C# | 📅 2026-03-15 - GraphQL server for .Net Core and .NET Framework.
* [graphql-net](https://github.com/ckimes89/graphql-net) ⭐ 887 | 🐛 43 | 🌐 C# | 📅 2022-06-22 - GraphQL to IQueryable for .NET.
* [EntityGraphQL](https://github.com/EntityGraphQL/EntityGraphQL) ⭐ 452 | 🐛 17 | 🌐 C# | 📅 2026-03-13 - library to build a GraphQL API on top of data model with the extensibility to bring multiple data sources together in the single GraphQL schema.
* [ZeroQL](https://github.com/byme8/ZeroQL) ⭐ 317 | 🐛 11 | 🌐 C# | 📅 2025-12-28 - type-safe GraphQL client with Linq-like interface for C#
* [Snowflaqe](https://github.com/Zaid-Ajaj/Snowflaqe) ⭐ 160 | 🐛 22 | 🌐 F# | 📅 2024-10-10 - Type-safe GraphQL code generator for F# and [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,066 | 🐛 234 | 🌐 F# | 📅 2026-03-16
...
* [absinthe-graphql](https://github.com/absinthe-graphql/absinthe) ⭐ 4,395 | 🐛 75 | 🌐 Elixir | 📅 2026-03-15 - Fully Featured Elixir GraphQL Library.
...
* [Hasura](https://github.com/hasura/graphql-engine) ⭐ 31,925 | 🐛 2,376 | 🌐 TypeScript | 📅 2026-03-12 - Hasura gives Instant Realtime GraphQL APIs over PostgreSQL. Works with an existing database too.
...
* [Lacinia](https://github.com/walmartlabs/lacinia) ⭐ 1,854 | 🐛 15 | 🌐 Clojure | 📅 2026-03-10 - GraphQL implementation in pure Clojure.
...
* [GraphQL](https://github.com/GraphQLSwift/GraphQL) ⭐ 963 | 🐛 7 | 🌐 Swift | 📅 2026-02-28 - The Swift implementation for GraphQL.
...
* [apollo-android](https://github.com/apollographql/apollo-android) ⭐ 3,951 | 🐛 111 | 🌐 Kotlin | 📅 2026-03-11 - 📟 A strongly-typed, caching GraphQL client for Android, written in Java.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,725 | 🐛 109 | 🌐 Java | 📅 2026-03-08 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [apollo-ios](https://github.com/apollographql/apollo-ios) ⭐ 4,036 | 🐛 98 | 🌐 Swift | 📅 2026-03-13 - 📱 A strongly-typed, caching GraphQL client for iOS, written in Swift.
...
* [graphql-flutter](https://github.com/zino-app/graphql-flutter) ⭐ 3,272 | 🐛 159 | 🌐 Dart | 📅 2026-03-14 - A GraphQL client for Flutter.
...
* [juniper](https://github.com/graphql-rust/juniper) ⭐ 5,947 | 🐛 102 | 🌐 Rust | 📅 2026-03-14 - GraphQL server library for Rust.
* [async-graphql](https://github.com/async-graphql/async-graphql) ⭐ 3,635 | 🐛 239 | 🌐 Rust | 📅 2026-03-13 - High-performance server-side library that supports all GraphQL specifications.
* [tailcall](https://github.com/tailcallhq/tailcall) ⭐ 1,433 | 🐛 11 | 🌐 Rust | 📅 2026-03-15 - A platform for building high-performance GraphQL backends.
...
* [graphql-crystal](https://github.com/ziprandom/graphql-crystal) ⭐ 213 | 🐛 9 | 🌐 Crystal | 📅 2020-07-01 - library inspired by [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,430 | 🐛 76 | 🌐 Ruby | 📅 2026-03-12 & [go-graphql](https://github.com/playlyfe/go-graphql) ⭐ 246 | 🐛 18 | 🌐 Go | 📅 2020-01-22 & [graphql-parser](https://github.com/graphql-dotnet/parser) ⭐ 220 | 🐛 7 | 🌐 C# | 📅 2026-02-27.
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 41,821 | 🐛 1,794 | 🌐 JavaScript | 📅 2026-03-13 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,814 | 🐛 411 | 🌐 TypeScript | 📅 2026-03-05 - An in-browser IDE for exploring GraphQL.
...
* [Altair GraphQL Client](https://github.com/altair-graphql/altair) ⭐ 5,398 | 🐛 53 | 🌐 TypeScript | 📅 2026-03-15 - A beautiful feature-rich GraphQL Client for all platforms.
...
* [graphql-to-karate](https://github.com/wbaldoumas/graphql-to-karate) ⭐ 16 | 🐛 3 | 🌐 C# | 📅 2026-03-13 - **Generate Karate API tests** from your GraphQL schemas
* [mockd](https://github.com/getmockd/mockd) ⭐ 3 | 🐛 0 | 🌐 Go | 📅 2026-03-16 - Multi-protocol mock server with GraphQL schema mocking, resolver configuration, and query validation. Also supports HTTP, gRPC, WebSocket, MQTT, and SOAP.
...
* [InQL Scanner](https://github.com/doyensec/inql) ⭐ 1,744 | 🐛 34 | 🌐 Kotlin | 📅 2026-02-16 - A Burp Extension for GraphQL Security Testing
* [GraphQL Cop](https://github.com/dolevf/graphql-cop) ⭐ 627 | 🐛 1 | 🌐 Python | 📅 2025-11-20 - Security Audit Utility for GraphQL
...
* [GraphQLer](https://github.com/omar2535/GraphQLer) ⭐ 162 | 🐛 13 | 🌐 Python | 📅 2026-03-14 - Dependency-aware dynamic GraphQL testing tool
...
* [Apollo Client Developer Tools](https://github.com/apollographql/apollo-client-devtools) ⭐ 1,524 | 🐛 51 | 🌐 TypeScript | 📅 2026-03-15 - GraphQL debugging tools for Apollo Client in the Chrome developer console
...
* [js-graphql-intellij-plugin](https://github.com/jimkyndemeyer/js-graphql-intellij-plugin/) ⭐ 895 | 🐛 156 | 🌐 Java | 📅 2026-03-13 - GraphQL language support for IntelliJ IDEA and WebStorm, including Relay.QL tagged templates in JavaScript and TypeScript.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 45,534 | 🐛 2,516 | 🌐 TypeScript | 📅 2026-03-13 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.
* [Bit](https://github.com/teambit/bit) ⭐ 18,365 | 🐛 66 | 🌐 TypeScript | 📅 2026-03-15 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).
* [amplication](https://github.com/amplication/amplication) ⭐ 16,004 | 🐛 620 | 🌐 TypeScript | 📅 2026-03-13: Amplication is an open‑source low code development tool. It builds database applications with REST API and GraphQL for CRUD with relations, sorting, filtering, pagination.
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,223 | 🐛 617 | 🌐 TypeScript | 📅 2026-03-14 - GraphQL code generator based on schema and documents.
...
* [raphql-inspector](https://github.com/kamilkisiela/graphql-inspector) ⭐ 1,738 | 🐛 132 | 🌐 TypeScript | 📅 2026-03-15: alidate schema, get schema change notifications, validate operations, find breaking changes, look for similar types, schema coverage.
...
* [ts-graphql-plugin](https://github.com/Quramy/ts-graphql-plugin) ⭐ 760 | 🐛 26 | 🌐 TypeScript | 📅 2026-03-15 - A language service plugin complete and validate GraphQL query in TypeScript template strings.
...
* [Typetta](https://github.com/twinlogix/typetta) ⭐ 116 | 🐛 58 | 🌐 TypeScript | 📅 2026-03-13 - Node.js ORM written in TypeScript for type lovers. Typetta is the perfect ORM for the GraphQL + NodeJS + Typescript stack.
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 19,633 | 🐛 893 | 🌐 Rust | 📅 2026-03-15
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 15,805 | 🐛 603 | 🌐 Go | 📅 2026-03-16 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 22,705 | 🐛 249 | 🌐 Python | 📅 2026-03-13 - GraphQL-first headless e-commerce platform.
