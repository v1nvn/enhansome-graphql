...
* [GraphQL over HTTP](https://github.com/graphql/graphql-over-http) ⭐ 422 | 🐛 31 | 🌐 JavaScript | 📅 2026-04-29 - Working draft of "GraphQL over HTTP" specification.
...
* [GraphQL APIs](https://github.com/APIs-guru/graphql-apis) ⭐ 4,653 | 🐛 1 | 📅 2024-09-26 - A collective list of public GraphQL APIs.
...
* [graphql-js](https://github.com/graphql/graphql-js) ⭐ 20,313 | 🐛 131 | 🌐 TypeScript | 📅 2026-04-29 - A reference implementation of GraphQL for JavaScript.
...
* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,712 | 🐛 416 | 🌐 TypeScript | 📅 2026-04-29 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
* [aws-amplify](https://github.com/aws-amplify/amplify-js) ⭐ 9,582 | 🐛 484 | 🌐 TypeScript | 📅 2026-04-29 - A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.
* [graphql-request](https://github.com/prisma-labs/graphql-request) ⭐ 6,116 | 🐛 54 | 🌐 TypeScript | 📅 2026-04-06 - A minimal GraphQL client for Node and browsers.
...
* [gqty](https://github.com/gqty-dev/gqty) ⭐ 1,033 | 🐛 54 | 🌐 TypeScript | 📅 2026-04-29 - A No GraphQL client for TypeScript
...
* [sveltekit-kitql](https://github.com/jycouet/kitql) ⭐ 455 | 🐛 12 | 🌐 TypeScript | 📅 2026-04-29 - A set of tools, helping you building efficient apps in a fast way with SvelteKit and GraphQL.
...
* [relay](https://github.com/facebook/relay) ⭐ 18,935 | 🐛 838 | 🌐 Rust | 📅 2026-04-30 - Relay is a JavaScript framework for building data-driven React applications.
...
* [@gqty/react](https://github.com/gqty-dev/gqty) ⭐ 1,033 | 🐛 54 | 🌐 TypeScript | 📅 2026-04-29 - A No GraphQL client for TypeScript
...
* [apollo-server](https://github.com/apollographql/apollo-server) ⭐ 13,936 | 🐛 83 | 🌐 TypeScript | 📅 2026-04-29 - Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
...
* [graphitejs](https://github.com/graphitejs/server) ⭐ 122 | 🐛 18 | 🌐 JavaScript | 📅 2026-04-29 - Framework NodeJS for GraphQL.
...
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,238 | 🐛 591 | 🌐 TypeScript | 📅 2026-04-29: GraphQL code generator with flexible support for custom plugins and templates like TypeScript (frontend and backend), React Hooks, resolvers signatures and more.
...
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 97 | 🐛 8 | 🌐 TypeScript | 📅 2026-04-27 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,590 | 🐛 125 | 🌐 TypeScript | 📅 2026-04-19, [Zod](https://github.com/colinhacks/zod) ⭐ 42,536 | 🐛 128 | 🌐 TypeScript | 📅 2026-04-30, or [Yup](https://github.com/jquense/yup) ⭐ 23,683 | 🐛 239 | 🌐 TypeScript | 📅 2026-04-29.
...
* [graphql-shield](https://github.com/maticzav/graphql-shield) ⭐ 3,574 | 🐛 107 | 🌐 TypeScript | 📅 2026-04-29 - A library that helps creating a permission layer for a graphql api.
...
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,249 | 🐛 24 | 🌐 Python | 📅 2026-04-29 - Runs arbitrary queries matching a GraphQL schema to find server errors.
...
* [eslint-plugin-graphql](https://github.com/apollographql/eslint-plugin-graphql) ⭐ 1,216 | 🐛 100 | 🌐 JavaScript | 📅 2026-04-29 - An ESLint plugin that checks your GraphQL strings against a schema.
...
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,202 | 🐛 154 | 🌐 TypeScript | 📅 2026-04-29 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
...
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 821 | 🐛 46 | 🌐 Go | 📅 2026-04-29 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
* [graphql-armor](https://github.com/Escape-Technologies/graphql-armor) ⭐ 582 | 🐛 31 | 🌐 TypeScript | 📅 2026-04-29 - An instant security layer for production GraphQL Endpoints.
* [GraphQL Constraint Directive](https://github.com/confuser/graphql-constraint-directive) ⭐ 576 | 🐛 43 | 🌐 JavaScript | 📅 2026-04-29 - Allows using @constraint as a directive to validate input data. Inspired by Constraints Directives RFC and OpenAPI
...
* [graphql-live-query](https://github.com/n1ru4l/graphql-live-query) ⭐ 439 | 🐛 52 | 🌐 TypeScript | 📅 2026-04-29 - Realtime GraphQL Live Queries with JavaScript.
...
* [supertest-graphql](https://github.com/alexstrat/supertest-graphql) ⭐ 34 | 🐛 12 | 🌐 TypeScript | 📅 2023-01-24 - Extends [supertest](https://github.com/visionmedia/supertest) ⭐ 14,353 | 🐛 184 | 🌐 JavaScript | 📅 2026-04-02 to easily test a GraphQL endpoint
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 139,224 | 🐛 3,851 | 🌐 JavaScript | 📅 2026-04-29 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
...
* [NAPERG](https://github.com/alan345/naperg) ⭐ 1,394 | 🐛 0 | 🌐 TypeScript | 📅 2026-04-19 - Fullstack Boilerplate GraphQL. Made with React & Prisma + authentication & roles.
* [SWAPI GraphQL Wrapper](https://github.com/graphql/swapi-graphql) ⭐ 1,064 | 🐛 26 | 🌐 JavaScript | 📅 2025-12-04 - A GraphQL schema and server wrapping SWAPI.
* [Relay TodoMVC](https://github.com/taion/relay-todomvc) ⭐ 158 | 🐛 40 | 🌐 JavaScript | 📅 2026-04-29 - Relay TodoMVC with routing.
...
* [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,430 | 🐛 69 | 🌐 Ruby | 📅 2026-04-29 - Ruby implementation of Facebook's GraphQL.
...
* [graphql-php](https://github.com/webonyx/graphql-php) ⭐ 4,710 | 🐛 59 | 🌐 PHP | 📅 2026-04-29 - A PHP port of GraphQL reference implementation.
...
* [graphene](https://github.com/graphql-python/graphene) ⭐ 8,241 | 🐛 113 | 🌐 Python | 📅 2025-09-04 - A package for creating GraphQL schemas/types in a Pythonic easy way.
* [strawberry](https://github.com/strawberry-graphql/strawberry) ⭐ 4,648 | 🐛 450 | 🌐 Python | 📅 2026-04-29 - A new GraphQL library for Python.
...
* [graphql-core](https://github.com/graphql-python/graphql-core) ⭐ 526 | 🐛 30 | 🌐 Python | 📅 2026-04-21 - GraphQL implementation for Python based on GraphQL.js v16.3.0 reference implementation
...
* [graphql-java](https://github.com/graphql-java/graphql-java) ⭐ 6,238 | 🐛 50 | 🌐 Java | 📅 2026-04-27 - GraphQL Java implementation.
* [DGS Framework](https://github.com/Netflix/dgs-framework) ⭐ 3,336 | 🐛 45 | 🌐 Kotlin | 📅 2026-04-28 - A GraphQL server framework for Spring Boot, developed by Netflix.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,734 | 🐛 110 | 🌐 Java | 📅 2026-04-14 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [Light Java GraphQL](https://github.com/networknt/light-graphql-4j) ⭐ 34 | 🐛 10 | 🌐 JavaScript | 📅 2026-04-29: A lightweight, fast microservices framework with all cross-cutting concerns addressed and ready to plug in GraphQL schema.
...
* [graphql-java-codegen-maven-plugin](https://github.com/kobylynskyi/graphql-java-codegen-maven-plugin) ⭐ 17 | 🐛 0 | 📅 2020-04-09 - Schema-first maven plugin for generating Java types and Resolver interfaces. Works perfectly in conjunction with graphql-java-tools. Inspired by [swagger-codegen-maven-plugin](https://github.com/swagger-api/swagger-codegen/tree/master/modules/swagger-codegen-maven-plugin) ⭐ 17,736 | 🐛 3,441 | 🌐 Mustache | 📅 2026-04-27.
...
* [light-java-graphql examples](https://github.com/networknt/light-example-4j/tree/master/graphql) ⭐ 150 | 🐛 14 | 🌐 Java | 📅 2026-04-29 - Examples of Light Java GraphQL and tutorials.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,716 | 🐛 381 | 🌐 Go | 📅 2026-04-27 - Go generate based graphql server library.
...
* [graphql-go](https://github.com/graph-gophers/graphql-go) ⭐ 4,749 | 🐛 10 | 🌐 Go | 📅 2026-04-29 - GraphQL server with a focus on ease of use.
* [graphjin](https://github.com/dosco/graphjin) ⭐ 3,052 | 🐛 21 | 🌐 Go | 📅 2026-04-29: Build APIs in 5 minutes with GraphQL. An instant GraphQL to SQL compiler.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 821 | 🐛 46 | 🌐 Go | 📅 2026-04-29 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
* [graphql-dotnet](https://github.com/graphql-dotnet/graphql-dotnet) ⭐ 5,980 | 🐛 121 | 🌐 C# | 📅 2026-04-24 - GraphQL for .NET.
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,689 | 🐛 374 | 🌐 C# | 📅 2026-04-29 - GraphQL server for .Net Core and .NET Framework.
* [graphql-net](https://github.com/ckimes89/graphql-net) ⭐ 887 | 🐛 43 | 🌐 C# | 📅 2022-06-22 - GraphQL to IQueryable for .NET.
* [EntityGraphQL](https://github.com/EntityGraphQL/EntityGraphQL) ⭐ 454 | 🐛 11 | 🌐 C# | 📅 2026-04-23 - library to build a GraphQL API on top of data model with the extensibility to bring multiple data sources together in the single GraphQL schema.
* [ZeroQL](https://github.com/byme8/ZeroQL) ⭐ 320 | 🐛 11 | 🌐 C# | 📅 2025-12-28 - type-safe GraphQL client with Linq-like interface for C#
* [Snowflaqe](https://github.com/Zaid-Ajaj/Snowflaqe) ⭐ 161 | 🐛 22 | 🌐 F# | 📅 2024-10-10 - Type-safe GraphQL code generator for F# and [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,073 | 🐛 222 | 🌐 F# | 📅 2026-04-29
...
* [Hasura](https://github.com/hasura/graphql-engine) ⭐ 31,967 | 🐛 2,370 | 🌐 TypeScript | 📅 2026-04-25 - Hasura gives Instant Realtime GraphQL APIs over PostgreSQL. Works with an existing database too.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,921 | 🐛 151 | 🌐 TypeScript | 📅 2026-04-28 - Lightning-fast GraphQL APIs for PostgreSQL: highly customisable; extensible via plugins; realtime.
...
* [apollo-android](https://github.com/apollographql/apollo-android) ⭐ 3,953 | 🐛 110 | 🌐 Kotlin | 📅 2026-04-30 - 📟 A strongly-typed, caching GraphQL client for Android, written in Java.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,734 | 🐛 110 | 🌐 Java | 📅 2026-04-14 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [juniper](https://github.com/graphql-rust/juniper) ⭐ 5,957 | 🐛 103 | 🌐 Rust | 📅 2026-04-29 - GraphQL server library for Rust.
* [async-graphql](https://github.com/async-graphql/async-graphql) ⭐ 3,655 | 🐛 243 | 🌐 Rust | 📅 2026-04-21 - High-performance server-side library that supports all GraphQL specifications.
...
* [graphql-crystal](https://github.com/ziprandom/graphql-crystal) ⭐ 213 | 🐛 9 | 🌐 Crystal | 📅 2020-07-01 - library inspired by [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,430 | 🐛 69 | 🌐 Ruby | 📅 2026-04-29 & [go-graphql](https://github.com/playlyfe/go-graphql) ⭐ 246 | 🐛 18 | 🌐 Go | 📅 2020-01-22 & [graphql-parser](https://github.com/graphql-dotnet/parser) ⭐ 218 | 🐛 9 | 🌐 C# | 📅 2026-04-10.
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 43,386 | 🐛 1,656 | 🌐 JavaScript | 📅 2026-04-29 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
...
* [Altair GraphQL Client](https://github.com/altair-graphql/altair) ⭐ 5,402 | 🐛 167 | 🌐 TypeScript | 📅 2026-04-28 - A beautiful feature-rich GraphQL Client for all platforms.
...
* [Apollo Client Developer Tools](https://github.com/apollographql/apollo-client-devtools) ⭐ 1,525 | 🐛 54 | 🌐 TypeScript | 📅 2026-04-29 - GraphQL debugging tools for Apollo Client in the Chrome developer console
...
* [js-graphql-intellij-plugin](https://github.com/jimkyndemeyer/js-graphql-intellij-plugin/) ⭐ 898 | 🐛 157 | 🌐 Java | 📅 2026-04-29 - GraphQL language support for IntelliJ IDEA and WebStorm, including Relay.QL tagged templates in JavaScript and TypeScript.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 45,859 | 🐛 2,580 | 🌐 TypeScript | 📅 2026-04-29 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.

* [Bit](https://github.com/teambit/bit) ⭐ 18,378 | 🐛 75 | 🌐 TypeScript | 📅 2026-04-30 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).

* [amplication](https://github.com/amplication/amplication) ⭐ 15,994 | 🐛 630 | 🌐 TypeScript | 📅 2026-04-23: Amplication is an open‑source low code development tool. It builds database applications with REST API and GraphQL for CRUD with relations, sorting, filtering, pagination.

* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,238 | 🐛 591 | 🌐 TypeScript | 📅 2026-04-29 - GraphQL code generator based on schema and documents.
...
* [ts-graphql-plugin](https://github.com/Quramy/ts-graphql-plugin) ⭐ 755 | 🐛 30 | 🌐 TypeScript | 📅 2026-04-29 - A language service plugin complete and validate GraphQL query in TypeScript template strings.
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 19,884 | 🐛 962 | 🌐 Rust | 📅 2026-04-30
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 16,101 | 🐛 575 | 🌐 Go | 📅 2026-04-30 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 22,856 | 🐛 243 | 🌐 Python | 📅 2026-04-29 - GraphQL-first headless e-commerce platform.
