...
* [GraphQL](https://github.com/graphql/graphql-spec) ⭐ 14,599 | 🐛 196 | 🌐 JavaScript | 📅 2026-04-17 - Working draft of the specification for GraphQL.
* [GraphQL over HTTP](https://github.com/graphql/graphql-over-http) ⭐ 422 | 🐛 30 | 🌐 JavaScript | 📅 2026-04-23 - Working draft of "GraphQL over HTTP" specification.
...
* [GraphQL APIs](https://github.com/APIs-guru/graphql-apis) ⭐ 4,652 | 🐛 1 | 📅 2024-09-26 - A collective list of public GraphQL APIs.
...
* [graphql-js](https://github.com/graphql/graphql-js) ⭐ 20,314 | 🐛 130 | 🌐 TypeScript | 📅 2026-04-25 - A reference implementation of GraphQL for JavaScript.
* [graphql-jit](https://github.com/zalando-incubator/graphql-jit) ⭐ 1,084 | 🐛 31 | 🌐 TypeScript | 📅 2026-03-23 - GraphQL execution using a JIT compiler.
* [Gra*fast*](https://grafast.org) - a cutting edge planning and execution engine for GraphQL.

#### Clients

* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,716 | 🐛 422 | 🌐 TypeScript | 📅 2026-04-25 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
* [aws-amplify](https://github.com/aws-amplify/amplify-js) ⭐ 9,581 | 🐛 482 | 🌐 TypeScript | 📅 2026-04-24 - A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.
* [graphql-request](https://github.com/prisma-labs/graphql-request) ⭐ 6,115 | 🐛 53 | 🌐 TypeScript | 📅 2026-04-06 - A minimal GraphQL client for Node and browsers.
* [graphqurl](https://github.com/hasura/graphqurl) ⭐ 3,381 | 🐛 44 | 🌐 JavaScript | 📅 2025-02-13 - curl for GraphQL with autocomplete, subscriptions and GraphiQL. Also a dead-simple universal javascript GraphQL client.
* [graphql-zeus](https://github.com/graphql-editor/graphql-zeus) ⭐ 1,974 | 🐛 54 | 🌐 TypeScript | 📅 2026-04-07 - GraphQL Zeus creates autocomplete client library for `JavaScript` or `TypeScript` which provides autocompletion for strongly typed queries.
* [gqty](https://github.com/gqty-dev/gqty) ⭐ 1,033 | 🐛 53 | 🌐 TypeScript | 📅 2026-04-25 - A No GraphQL client for TypeScript
...
* [vue-apollo](https://github.com/vuejs/vue-apollo) ⭐ 6,043 | 🐛 278 | 🌐 TypeScript | 📅 2026-03-04 - Apollo/GraphQL integration for VueJS.
* [apollo-angular](https://github.com/kamilkisiela/apollo-angular) ⭐ 1,516 | 🐛 21 | 🌐 TypeScript | 📅 2026-04-15 - A fully-featured, production ready caching GraphQL client for Angular and every GraphQL server.
* [svelte-apollo](https://github.com/timhall/svelte-apollo) ⭐ 948 | 🐛 33 | 🌐 TypeScript | 📅 2023-08-03 - Svelte integration for Apollo GraphQL.
* [sveltekit-kitql](https://github.com/jycouet/kitql) ⭐ 455 | 🐛 12 | 🌐 TypeScript | 📅 2026-04-25 - A set of tools, helping you building efficient apps in a fast way with SvelteKit and GraphQL.
* [apollo-elements](https://github.com/apollo-elements/apollo-elements) ⭐ 421 | 🐛 7 | 🌐 TypeScript | 📅 2026-04-10 - GraphQL web components that work in any frontend framework.
...
* [relay](https://github.com/facebook/relay) ⭐ 18,933 | 🐛 838 | 🌐 Rust | 📅 2026-04-26 - Relay is a JavaScript framework for building data-driven React applications.
* [urql](https://github.com/FormidableLabs/urql) ⭐ 8,945 | 🐛 35 | 🌐 TypeScript | 📅 2026-04-15 - A simple caching GraphQL client for React.
...
* [@gqty/react](https://github.com/gqty-dev/gqty) ⭐ 1,033 | 🐛 53 | 🌐 TypeScript | 📅 2026-04-25 - A No GraphQL client for TypeScript
...
* [apollo-server](https://github.com/apollographql/apollo-server) ⭐ 13,934 | 🐛 83 | 🌐 TypeScript | 📅 2026-04-25 - Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
* [graphql-yoga](https://github.com/prisma-labs/graphql-yoga) ⭐ 8,518 | 🐛 142 | 🌐 TypeScript | 📅 2026-04-25 - Fully-featured GraphQL Server with focus on easy setup, performance and great developer experience.
* [mercurius](https://github.com/mercurius-js/mercurius) ⭐ 2,477 | 🐛 64 | 🌐 JavaScript | 📅 2026-04-21 - GraphQL plugin for Fastify.
...
* [pylon](https://github.com/getcronit/pylon) ⭐ 370 | 🐛 27 | 🌐 TypeScript | 📅 2026-04-22 - Write full-feature APIs with just functions. No more boilerplate code, no more setup. Just write functions and deploy.
* [gql](https://github.com/deno-libs/gql) ⭐ 202 | 🐛 0 | 🌐 TypeScript | 📅 2026-01-20 - Universal GraphQL HTTP middleware for Deno.
* [graphitejs](https://github.com/graphitejs/server) ⭐ 122 | 🐛 18 | 🌐 JavaScript | 📅 2026-04-17 - Framework NodeJS for GraphQL.
...
* [graphql-sequelize](https://github.com/mickhansen/graphql-sequelize) ⭐ 1,887 | 🐛 1 | 🌐 JavaScript | 📅 2022-11-16 - Sequelize helpers for GraphQL.
...
* [graphql-scalars](https://github.com/Urigo/graphql-scalars) ⭐ 1,934 | 🐛 42 | 🌐 TypeScript | 📅 2026-04-22 - A library of custom GraphQL Scalars for creating precise type-safe GraphQL schemas.

#### Type

* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,238 | 🐛 591 | 🌐 TypeScript | 📅 2026-04-25: GraphQL code generator with flexible support for custom plugins and templates like TypeScript (frontend and backend), React Hooks, resolvers signatures and more.
...
* [gql.tada](https://github.com/0no-co/gql.tada) ⭐ 2,928 | 🐛 25 | 🌐 TypeScript | 📅 2026-04-01 - GraphQL document authoring library, inferring the result and variables types of GraphQL queries and fragments in the TypeScript type system.
* [pothos](https://github.com/hayes/pothos) ⭐ 2,587 | 🐛 65 | 🌐 TypeScript | 📅 2026-04-25 - Pothos is a plugin based GraphQL schema builder for typescript. It makes building graphql schemas in typescript easy, fast and enjoyable.
...
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 96 | 🐛 8 | 🌐 TypeScript | 📅 2026-04-20 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,591 | 🐛 122 | 🌐 TypeScript | 📅 2026-04-19, [Zod](https://github.com/colinhacks/zod) ⭐ 42,501 | 🐛 325 | 🌐 TypeScript | 📅 2026-02-15, or [Yup](https://github.com/jquense/yup) ⭐ 23,686 | 🐛 239 | 🌐 TypeScript | 📅 2026-04-17.
...
* [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,425 | 🐛 161 | 🌐 TypeScript | 📅 2026-04-24 - Tool library for building and maintaining GraphQL-JS servers.
...
* [graphql-mesh](https://github.com/urigo/graphql-mesh) ⭐ 3,498 | 🐛 228 | 🌐 TypeScript | 📅 2026-04-24 - use GraphQL query language to access data in remote APIs that don't run GraphQL (and also ones that do run GraphQL).
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,238 | 🐛 25 | 🌐 Python | 📅 2026-04-26 - Runs arbitrary queries matching a GraphQL schema to find server errors.
...
* [graphql-cli](https://github.com/urigo/graphql-cli) ⭐ 2,019 | 🐛 48 | 🌐 TypeScript | 📅 2026-03-30 - A command line tool for common GraphQL development workflows.
...
* [eslint-plugin-graphql](https://github.com/apollographql/eslint-plugin-graphql) ⭐ 1,216 | 🐛 100 | 🌐 JavaScript | 📅 2026-04-17 - An ESLint plugin that checks your GraphQL strings against a schema.
...
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,203 | 🐛 154 | 🌐 TypeScript | 📅 2026-04-24 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
...
* [graphql-middleware](https://github.com/maticzav/graphql-middleware) ⭐ 1,148 | 🐛 43 | 🌐 TypeScript | 📅 2026-04-08 - Split up your GraphQL resolvers in middleware functions.
* [sofa](https://github.com/Urigo/sofa) ⭐ 1,116 | 🐛 38 | 🌐 TypeScript | 📅 2026-04-22 - Generate REST API from your GraphQL API.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 822 | 🐛 47 | 🌐 Go | 📅 2026-04-24 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
* [graphql-armor](https://github.com/Escape-Technologies/graphql-armor) ⭐ 582 | 🐛 31 | 🌐 TypeScript | 📅 2026-04-24 - An instant security layer for production GraphQL Endpoints.
* [GraphQL Constraint Directive](https://github.com/confuser/graphql-constraint-directive) ⭐ 576 | 🐛 43 | 🌐 JavaScript | 📅 2026-04-23 - Allows using @constraint as a directive to validate input data. Inspired by Constraints Directives RFC and OpenAPI
...
* [graphql-live-query](https://github.com/n1ru4l/graphql-live-query) ⭐ 440 | 🐛 52 | 🌐 TypeScript | 📅 2026-04-18 - Realtime GraphQL Live Queries with JavaScript.
...
* [supertest-graphql](https://github.com/alexstrat/supertest-graphql) ⭐ 34 | 🐛 12 | 🌐 TypeScript | 📅 2023-01-24 - Extends [supertest](https://github.com/visionmedia/supertest) ⭐ 14,350 | 🐛 184 | 🌐 JavaScript | 📅 2026-04-02 to easily test a GraphQL endpoint
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 139,163 | 🐛 3,849 | 🌐 JavaScript | 📅 2026-04-26 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
* [React Starter Kit](https://github.com/kriasoft/react-starter-kit) ⭐ 23,563 | 🐛 9 | 🌐 TypeScript | 📅 2026-03-02 - front-end starter kit using React, Relay, GraphQL, and JAM stack architecture.
...
* [NAPERG](https://github.com/alan345/naperg) ⭐ 1,392 | 🐛 0 | 🌐 TypeScript | 📅 2026-04-19 - Fullstack Boilerplate GraphQL. Made with React & Prisma + authentication & roles.
...
* [Relay TodoMVC](https://github.com/taion/relay-todomvc) ⭐ 158 | 🐛 40 | 🌐 JavaScript | 📅 2026-04-17 - Relay TodoMVC with routing.
...
* [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,431 | 🐛 74 | 🌐 Ruby | 📅 2026-04-24 - Ruby implementation of Facebook's GraphQL.
* [graphql-batch](https://github.com/Shopify/graphql-batch) ⭐ 1,438 | 🐛 14 | 🌐 Ruby | 📅 2026-04-24 - A query batching executor for the graphql gem.
...
* [graphql-php](https://github.com/webonyx/graphql-php) ⭐ 4,709 | 🐛 58 | 🌐 PHP | 📅 2026-04-24 - A PHP port of GraphQL reference implementation.
* [wp-graphql](https://github.com/wp-graphql/wp-graphql) ⭐ 3,776 | 🐛 106 | 🌐 PHP | 📅 2026-04-23 - GraphQL API for WordPress.
* [lighthouse](https://github.com/nuwave/lighthouse) ⭐ 3,491 | 🐛 132 | 🌐 PHP | 📅 2026-04-11 - A PHP package that allows to serve a GraphQL endpoint from your Laravel application.
* [graphql-laravel](https://github.com/rebing/graphql-laravel) ⭐ 2,212 | 🐛 3 | 🌐 PHP | 📅 2026-04-20 - Laravel wrapper for Facebook's GraphQL.
...
* [overblog/graphql-bundle](https://github.com/overblog/GraphQLBundle) ⭐ 797 | 🐛 134 | 🌐 PHP | 📅 2026-04-13 - This bundle provides tools to build a complete GraphQL server in your Symfony App. Supports react-relay.
* [graphqlite](https://github.com/thecodingmachine/graphqlite) ⭐ 572 | 🐛 25 | 🌐 MDX | 📅 2026-04-25 - Framework agnostic library that allows you to write GraphQL server by annotating your PHP classes.
...
* [graphene](https://github.com/graphql-python/graphene) ⭐ 8,244 | 🐛 113 | 🌐 Python | 📅 2025-09-04 - A package for creating GraphQL schemas/types in a Pythonic easy way.
* [strawberry](https://github.com/strawberry-graphql/strawberry) ⭐ 4,651 | 🐛 453 | 🌐 Python | 📅 2026-04-26 - A new GraphQL library for Python.
* [graphene-django](https://github.com/graphql-python/graphene-django) ⭐ 4,387 | 🐛 166 | 🌐 Python | 📅 2026-02-03 - A Django integration for Graphene.
* [Ariadne](https://github.com/mirumee/ariadne) ⭐ 2,335 | 🐛 29 | 🌐 Python | 📅 2026-04-22 - library for implementing GraphQL servers using schema-first approach. Asynchronous query execution, batteries included for ASGI, WSGI and popular webframeworks, [fully documented](https://ariadnegraphql.org).
...
* [graphql-core](https://github.com/graphql-python/graphql-core) ⭐ 530 | 🐛 30 | 🌐 Python | 📅 2026-04-21 - GraphQL implementation for Python based on GraphQL.js v16.3.0 reference implementation
...
* [graphql-java](https://github.com/graphql-java/graphql-java) ⭐ 6,237 | 🐛 51 | 🌐 Java | 📅 2026-04-24 - GraphQL Java implementation.
* [DGS Framework](https://github.com/Netflix/dgs-framework) ⭐ 3,332 | 🐛 51 | 🌐 Kotlin | 📅 2026-04-24 - A GraphQL server framework for Spring Boot, developed by Netflix.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,735 | 🐛 109 | 🌐 Java | 📅 2026-04-14 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [graphql-java-tools](https://github.com/graphql-java-kickstart/graphql-java-tools) ⭐ 824 | 🐛 88 | 🌐 Kotlin | 📅 2026-04-23 - Schema-first graphql-java convenience library that makes it easy to bring your own implementations as data resolvers. Inspired by [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,425 | 🐛 161 | 🌐 TypeScript | 📅 2026-04-24 for JS.
* [graphql-java-annotations](https://github.com/Enigmatis/graphql-java-annotations) ⭐ 393 | 🐛 1 | 🌐 Java | 📅 2025-10-03 - Provides annotations-based syntax for schema definition with GraphQL Java.
* [federation-jvm](https://github.com/apollographql/federation-jvm) ⭐ 272 | 🐛 22 | 🌐 Java | 📅 2026-04-23 - Apollo Federation on the JVM.
* [graphql-java-servlet](https://github.com/graphql-java-kickstart/graphql-java-servlet) ⭐ 227 | 🐛 23 | 🌐 Java | 📅 2026-04-23 - A framework-agnostic java servlet for exposing graphql-java query endpoints with GET, POST, and multipart uploads.
...
* [Light Java GraphQL](https://github.com/networknt/light-graphql-4j) ⭐ 34 | 🐛 10 | 🌐 JavaScript | 📅 2026-04-22: A lightweight, fast microservices framework with all cross-cutting concerns addressed and ready to plug in GraphQL schema.
...
* [graphql-java-codegen-maven-plugin](https://github.com/kobylynskyi/graphql-java-codegen-maven-plugin) ⭐ 17 | 🐛 0 | 📅 2020-04-09 - Schema-first maven plugin for generating Java types and Resolver interfaces. Works perfectly in conjunction with graphql-java-tools. Inspired by [swagger-codegen-maven-plugin](https://github.com/swagger-api/swagger-codegen/tree/master/modules/swagger-codegen-maven-plugin) ⭐ 17,728 | 🐛 3,441 | 🌐 Mustache | 📅 2026-04-24.
* [dgs-extended-formatters](https://github.com/setchy/dgs-extended-formatters) ⭐ 6 | 🐛 3 | 🌐 Java | 📅 2026-04-23 - An experimental set of DGS Directives for common formatting use-cases.
...
* [graphql-java-datetime](https://github.com/donbeave/graphql-java-datetime) ⭐ 153 | 🐛 7 | 🌐 Java | 📅 2026-04-23 - GraphQL ISO Date is a set of RFC 3339 compliant date/time scalar types to be used with graphql-java.

<a name="java-example" />

#### Java Examples

* [light-java-graphql examples](https://github.com/networknt/light-example-4j/tree/master/graphql) ⭐ 150 | 🐛 14 | 🌐 Java | 📅 2026-04-22 - Examples of Light Java GraphQL and tutorials.
* [graphql-java-kickstart\_samples](https://github.com/graphql-java-kickstart/samples) ⭐ 120 | 🐛 16 | 🌐 Java | 📅 2026-04-23 - Samples for using the GraphQL Java Kickstart projects.
...
* [graphql-kotlin](https://github.com/ExpediaGroup/graphql-kotlin) ⭐ 1,801 | 🐛 90 | 🌐 Kotlin | 📅 2026-04-24 - GraphQL Kotlin implementation.
...
* [cppgraphqlgen](https://github.com/Microsoft/cppgraphqlgen) ⭐ 348 | 🐛 16 | 🌐 C++ | 📅 2025-10-05 - C++ GraphQL schema service generator.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,714 | 🐛 384 | 🌐 Go | 📅 2026-04-25 - Go generate based graphql server library.
...
* [graphql-go](https://github.com/graph-gophers/graphql-go) ⭐ 4,748 | 🐛 15 | 🌐 Go | 📅 2026-04-25 - GraphQL server with a focus on ease of use.
* [graphjin](https://github.com/dosco/graphjin) ⭐ 3,051 | 🐛 20 | 🌐 Go | 📅 2026-04-25: Build APIs in 5 minutes with GraphQL. An instant GraphQL to SQL compiler.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 822 | 🐛 47 | 🌐 Go | 📅 2026-04-24 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
* [gql](https://github.com/kadirpekel/gql) ⭐ 7 | 🐛 0 | 🌐 Go | 📅 2026-04-18 - Code first graphql (graphql-go/graphql) schema builder.
...
* [go-graphql-subscription-example](https://github.com/ccamel/go-graphql-subscription-example) ⭐ 46 | 🐛 11 | 🌐 Go | 📅 2026-04-24 - A GraphQL schema and server that demonstrates GraphQL [subscriptions](https://github.com/apollographql/subscriptions-transport-ws/blob/v0.9.4/PROTOCOL.md) ⚠️ Archived (over Websocket) to consume [Apache Kafka](https://kafka.apache.org/) messages.
...
* [sangria](https://github.com/sangria-graphql/sangria) ⭐ 1,964 | 🐛 64 | 🌐 Scala | 📅 2026-04-21 - Scala GraphQL server implementation.
* [caliban](https://github.com/ghostdogpr/caliban) ⭐ 992 | 🐛 27 | 🌐 Scala | 📅 2026-04-25 - Caliban is a purely functional library for creating GraphQL backends in Scala.
* [sangria-relay](https://github.com/sangria-graphql/sangria-relay) ⭐ 90 | 🐛 11 | 🌐 Scala | 📅 2026-04-25 - Sangria Relay Support.
...
* [graphql-dotnet](https://github.com/graphql-dotnet/graphql-dotnet) ⭐ 5,980 | 🐛 118 | 🌐 C# | 📅 2026-04-24 - GraphQL for .NET.
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,687 | 🐛 373 | 🌐 C# | 📅 2026-04-25 - GraphQL server for .Net Core and .NET Framework.
* [graphql-net](https://github.com/ckimes89/graphql-net) ⭐ 887 | 🐛 43 | 🌐 C# | 📅 2022-06-22 - GraphQL to IQueryable for .NET.
* [EntityGraphQL](https://github.com/EntityGraphQL/EntityGraphQL) ⭐ 453 | 🐛 11 | 🌐 C# | 📅 2026-04-23 - library to build a GraphQL API on top of data model with the extensibility to bring multiple data sources together in the single GraphQL schema.
* [ZeroQL](https://github.com/byme8/ZeroQL) ⭐ 320 | 🐛 11 | 🌐 C# | 📅 2025-12-28 - type-safe GraphQL client with Linq-like interface for C#
* [Snowflaqe](https://github.com/Zaid-Ajaj/Snowflaqe) ⭐ 161 | 🐛 22 | 🌐 F# | 📅 2024-10-10 - Type-safe GraphQL code generator for F# and [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,073 | 🐛 236 | 🌐 F# | 📅 2026-04-26
...
* [absinthe-graphql](https://github.com/absinthe-graphql/absinthe) ⭐ 4,405 | 🐛 74 | 🌐 Elixir | 📅 2026-04-03 - Fully Featured Elixir GraphQL Library.
...
* [graphql\_parser](https://github.com/graphql-elixir/graphql_parser) ⭐ 24 | 🐛 3 | 🌐 Elixir | 📅 2023-07-02 - Elixir bindings for [libgraphqlparser](https://github.com/graphql/libgraphqlparser) ⭐ 1,103 | 🐛 39 | 🌐 C++ | 📅 2025-10-02
...
* [Hasura](https://github.com/hasura/graphql-engine) ⭐ 31,958 | 🐛 2,370 | 🌐 TypeScript | 📅 2026-04-25 - Hasura gives Instant Realtime GraphQL APIs over PostgreSQL. Works with an existing database too.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,917 | 🐛 148 | 🌐 TypeScript | 📅 2026-04-22 - Lightning-fast GraphQL APIs for PostgreSQL: highly customisable; extensible via plugins; realtime.
...
* [GraphQL](https://github.com/GraphQLSwift/GraphQL) ⭐ 963 | 🐛 8 | 🌐 Swift | 📅 2026-04-06 - The Swift implementation for GraphQL.
...
* [apollo-android](https://github.com/apollographql/apollo-android) ⭐ 3,953 | 🐛 111 | 🌐 Kotlin | 📅 2026-04-26 - 📟 A strongly-typed, caching GraphQL client for Android, written in Java.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,735 | 🐛 109 | 🌐 Java | 📅 2026-04-14 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [apollo-ios](https://github.com/apollographql/apollo-ios) ⭐ 4,036 | 🐛 88 | 🌐 Swift | 📅 2026-04-23 - 📱 A strongly-typed, caching GraphQL client for iOS, written in Swift.
...
* [juniper](https://github.com/graphql-rust/juniper) ⭐ 5,956 | 🐛 103 | 🌐 Rust | 📅 2026-04-23 - GraphQL server library for Rust.
* [async-graphql](https://github.com/async-graphql/async-graphql) ⭐ 3,654 | 🐛 242 | 🌐 Rust | 📅 2026-04-21 - High-performance server-side library that supports all GraphQL specifications.
* [tailcall](https://github.com/tailcallhq/tailcall) ⭐ 1,436 | 🐛 14 | 🌐 Rust | 📅 2026-04-23 - A platform for building high-performance GraphQL backends.
* [graphql-client](https://github.com/tomhoule/graphql-client) ⭐ 1,253 | 🐛 112 | 🌐 Rust | 📅 2026-02-20 - GraphQL client library for Rust with WebAssembly (wasm) support.
...
* [graphql-crystal](https://github.com/ziprandom/graphql-crystal) ⭐ 213 | 🐛 9 | 🌐 Crystal | 📅 2020-07-01 - library inspired by [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,431 | 🐛 74 | 🌐 Ruby | 📅 2026-04-24 & [go-graphql](https://github.com/playlyfe/go-graphql) ⭐ 246 | 🐛 18 | 🌐 Go | 📅 2020-01-22 & [graphql-parser](https://github.com/graphql-dotnet/parser) ⭐ 218 | 🐛 9 | 🌐 C# | 📅 2026-04-10.
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 43,275 | 🐛 1,676 | 🌐 JavaScript | 📅 2026-04-24 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,825 | 🐛 383 | 🌐 TypeScript | 📅 2026-04-26 - An in-browser IDE for exploring GraphQL.
* [GraphQL Voyager](https://github.com/APIs-guru/graphql-voyager) ⭐ 8,122 | 🐛 106 | 🌐 TypeScript | 📅 2026-03-30 - Represent any GraphQL API as an interactive graph.
* [GraphQL Editor](https://github.com/graphql-editor/graphql-editor) ⭐ 6,069 | 🐛 20 | 🌐 TypeScript | 📅 2025-09-10 - Visual Editor & GraphQL IDE.
* [Altair GraphQL Client](https://github.com/altair-graphql/altair) ⭐ 5,404 | 🐛 163 | 🌐 TypeScript | 📅 2026-04-24 - A beautiful feature-rich GraphQL Client for all platforms.
...
* [GraphQL Faker](https://github.com/APIs-guru/graphql-faker) ⭐ 2,712 | 🐛 80 | 🌐 TypeScript | 📅 2023-11-24 - 🎲 Mock or extend your GraphQL API with faked data. No coding required.
* [mockd](https://github.com/getmockd/mockd) ⭐ 119 | 🐛 13 | 🌐 Go | 📅 2026-04-24 - Multi-protocol mock server with GraphQL schema mocking, resolver configuration, and query validation. Also supports HTTP, gRPC, WebSocket, MQTT, and SOAP.
* [graphql-to-karate](https://github.com/wbaldoumas/graphql-to-karate) ⭐ 16 | 🐛 3 | 🌐 C# | 📅 2026-04-25 - **Generate Karate API tests** from your GraphQL schemas
...
* [InQL Scanner](https://github.com/doyensec/inql) ⭐ 1,770 | 🐛 36 | 🌐 Kotlin | 📅 2026-04-22 - A Burp Extension for GraphQL Security Testing
* [GraphQL Cop](https://github.com/dolevf/graphql-cop) ⭐ 643 | 🐛 1 | 🌐 Python | 📅 2025-11-20 - Security Audit Utility for GraphQL
...
* [GraphQLer](https://github.com/omar2535/GraphQLer) ⭐ 163 | 🐛 20 | 🌐 Python | 📅 2026-04-25 - Dependency-aware dynamic GraphQL testing tool
...
* [Apollo Client Developer Tools](https://github.com/apollographql/apollo-client-devtools) ⭐ 1,525 | 🐛 55 | 🌐 TypeScript | 📅 2026-04-25 - GraphQL debugging tools for Apollo Client in the Chrome developer console
...
* [spectaql](https://github.com/anvilco/spectaql) ⭐ 1,222 | 🐛 89 | 🌐 JavaScript | 📅 2026-04-10 - Autogenerate static GraphQL API documentation.
...
* [js-graphql-intellij-plugin](https://github.com/jimkyndemeyer/js-graphql-intellij-plugin/) ⭐ 897 | 🐛 157 | 🌐 Java | 📅 2026-04-24 - GraphQL language support for IntelliJ IDEA and WebStorm, including Relay.QL tagged templates in JavaScript and TypeScript.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 45,839 | 🐛 2,579 | 🌐 TypeScript | 📅 2026-04-24 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.

* [Bit](https://github.com/teambit/bit) ⭐ 18,379 | 🐛 73 | 🌐 TypeScript | 📅 2026-04-24 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).

* [amplication](https://github.com/amplication/amplication) ⭐ 15,992 | 🐛 630 | 🌐 TypeScript | 📅 2026-04-23: Amplication is an open‑source low code development tool. It builds database applications with REST API and GraphQL for CRUD with relations, sorting, filtering, pagination.

* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,238 | 🐛 591 | 🌐 TypeScript | 📅 2026-04-25 - GraphQL code generator based on schema and documents.
...
* [raphql-inspector](https://github.com/kamilkisiela/graphql-inspector) ⭐ 1,743 | 🐛 138 | 🌐 TypeScript | 📅 2026-04-24: alidate schema, get schema change notifications, validate operations, find breaking changes, look for similar types, schema coverage.
...
* [ts-graphql-plugin](https://github.com/Quramy/ts-graphql-plugin) ⭐ 754 | 🐛 30 | 🌐 TypeScript | 📅 2026-04-24 - A language service plugin complete and validate GraphQL query in TypeScript template strings.
...
* [Typetta](https://github.com/twinlogix/typetta) ⭐ 116 | 🐛 59 | 🌐 TypeScript | 📅 2026-04-23 - Node.js ORM written in TypeScript for type lovers. Typetta is the perfect ORM for the GraphQL + NodeJS + Typescript stack.
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 19,866 | 🐛 953 | 🌐 Rust | 📅 2026-04-26
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 16,080 | 🐛 558 | 🌐 Go | 📅 2026-04-25 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 22,847 | 🐛 243 | 🌐 Python | 📅 2026-04-24 - GraphQL-first headless e-commerce platform.
