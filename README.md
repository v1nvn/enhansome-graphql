...
* [GraphQL](https://github.com/graphql/graphql-spec) ⭐ 14,597 | 🐛 194 | 🌐 JavaScript | 📅 2026-04-30 - Working draft of the specification for GraphQL.
* [GraphQL over HTTP](https://github.com/graphql/graphql-over-http) ⭐ 422 | 🐛 31 | 🌐 JavaScript | 📅 2026-04-30 - Working draft of "GraphQL over HTTP" specification.
...
* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,714 | 🐛 415 | 🌐 TypeScript | 📅 2026-04-30 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
* [aws-amplify](https://github.com/aws-amplify/amplify-js) ⭐ 9,582 | 🐛 485 | 🌐 TypeScript | 📅 2026-04-30 - A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.
...
* [apollo-angular](https://github.com/kamilkisiela/apollo-angular) ⭐ 1,515 | 🐛 21 | 🌐 TypeScript | 📅 2026-04-30 - A fully-featured, production ready caching GraphQL client for Angular and every GraphQL server.
* [svelte-apollo](https://github.com/timhall/svelte-apollo) ⭐ 948 | 🐛 33 | 🌐 TypeScript | 📅 2023-08-03 - Svelte integration for Apollo GraphQL.
* [sveltekit-kitql](https://github.com/jycouet/kitql) ⭐ 455 | 🐛 9 | 🌐 TypeScript | 📅 2026-05-01 - A set of tools, helping you building efficient apps in a fast way with SvelteKit and GraphQL.
...
* [relay](https://github.com/facebook/relay) ⭐ 18,935 | 🐛 841 | 🌐 Rust | 📅 2026-05-01 - Relay is a JavaScript framework for building data-driven React applications.
...
* [apollo-server](https://github.com/apollographql/apollo-server) ⭐ 13,936 | 🐛 82 | 🌐 TypeScript | 📅 2026-04-30 - Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
* [graphql-yoga](https://github.com/prisma-labs/graphql-yoga) ⭐ 8,520 | 🐛 137 | 🌐 TypeScript | 📅 2026-04-28 - Fully-featured GraphQL Server with focus on easy setup, performance and great developer experience.
...
* [graphitejs](https://github.com/graphitejs/server) ⭐ 122 | 🐛 18 | 🌐 JavaScript | 📅 2026-04-30 - Framework NodeJS for GraphQL.
...
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,238 | 🐛 591 | 🌐 TypeScript | 📅 2026-04-30: GraphQL code generator with flexible support for custom plugins and templates like TypeScript (frontend and backend), React Hooks, resolvers signatures and more.
...
* [gql.tada](https://github.com/0no-co/gql.tada) ⭐ 2,929 | 🐛 27 | 🌐 TypeScript | 📅 2026-04-01 - GraphQL document authoring library, inferring the result and variables types of GraphQL queries and fragments in the TypeScript type system.
...
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 97 | 🐛 8 | 🌐 TypeScript | 📅 2026-04-27 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,592 | 🐛 124 | 🌐 TypeScript | 📅 2026-05-01, [Zod](https://github.com/colinhacks/zod) ⭐ 42,545 | 🐛 87 | 🌐 TypeScript | 📅 2026-04-30, or [Yup](https://github.com/jquense/yup) ⭐ 23,684 | 🐛 239 | 🌐 TypeScript | 📅 2026-04-29.
...
* [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,425 | 🐛 159 | 🌐 TypeScript | 📅 2026-04-30 - Tool library for building and maintaining GraphQL-JS servers.
* [graphql-shield](https://github.com/maticzav/graphql-shield) ⭐ 3,574 | 🐛 107 | 🌐 TypeScript | 📅 2026-05-01 - A library that helps creating a permission layer for a graphql api.
* [graphql-mesh](https://github.com/urigo/graphql-mesh) ⭐ 3,499 | 🐛 225 | 🌐 TypeScript | 📅 2026-04-30 - use GraphQL query language to access data in remote APIs that don't run GraphQL (and also ones that do run GraphQL).
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,254 | 🐛 24 | 🌐 Python | 📅 2026-05-01 - Runs arbitrary queries matching a GraphQL schema to find server errors.
...
* [eslint-plugin-graphql](https://github.com/apollographql/eslint-plugin-graphql) ⭐ 1,216 | 🐛 100 | 🌐 JavaScript | 📅 2026-05-01 - An ESLint plugin that checks your GraphQL strings against a schema.
...
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,202 | 🐛 154 | 🌐 TypeScript | 📅 2026-04-30 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
...
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 820 | 🐛 47 | 🌐 Go | 📅 2026-04-30 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
* [graphql-live-query](https://github.com/n1ru4l/graphql-live-query) ⭐ 439 | 🐛 52 | 🌐 TypeScript | 📅 2026-04-30 - Realtime GraphQL Live Queries with JavaScript.
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 139,238 | 🐛 3,855 | 🌐 JavaScript | 📅 2026-05-01 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
...
* [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,430 | 🐛 70 | 🌐 Ruby | 📅 2026-04-29 - Ruby implementation of Facebook's GraphQL.
...
* [agoo](https://github.com/ohler55/agoo) ⭐ 927 | 🐛 5 | 🌐 C | 📅 2026-05-01 - Ruby web server that implements Facebook's GraphQL.
...
* [agoo-demo](https://github.com/ohler55/agoo/tree/develop/example/graphql) ⭐ 927 | 🐛 5 | 🌐 C | 📅 2026-05-01 - Use of the Agoo server to demonstrate a simple GraphQL application.
...
* [graphql-php](https://github.com/webonyx/graphql-php) ⭐ 4,710 | 🐛 58 | 🌐 PHP | 📅 2026-04-30 - A PHP port of GraphQL reference implementation.
...
* [strawberry](https://github.com/strawberry-graphql/strawberry) ⭐ 4,648 | 🐛 449 | 🌐 Python | 📅 2026-04-29 - A new GraphQL library for Python.
...
* [DGS Framework](https://github.com/Netflix/dgs-framework) ⭐ 3,338 | 🐛 45 | 🌐 Kotlin | 📅 2026-04-28 - A GraphQL server framework for Spring Boot, developed by Netflix.
...
* [federation-jvm](https://github.com/apollographql/federation-jvm) ⭐ 273 | 🐛 23 | 🌐 Java | 📅 2026-04-28 - Apollo Federation on the JVM.
...
* [dgs-extended-formatters](https://github.com/setchy/dgs-extended-formatters) ⭐ 6 | 🐛 4 | 🌐 Java | 📅 2026-04-30 - An experimental set of DGS Directives for common formatting use-cases.
...
* [caliban](https://github.com/ghostdogpr/caliban) ⭐ 992 | 🐛 28 | 🌐 Scala | 📅 2026-04-25 - Caliban is a purely functional library for creating GraphQL backends in Scala.
...
* [graphql-dotnet](https://github.com/graphql-dotnet/graphql-dotnet) ⭐ 5,981 | 🐛 121 | 🌐 C# | 📅 2026-04-24 - GraphQL for .NET.
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,688 | 🐛 372 | 🌐 C# | 📅 2026-05-01 - GraphQL server for .Net Core and .NET Framework.
...
* [Snowflaqe](https://github.com/Zaid-Ajaj/Snowflaqe) ⭐ 161 | 🐛 22 | 🌐 F# | 📅 2024-10-10 - Type-safe GraphQL code generator for F# and [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,075 | 🐛 223 | 🌐 F# | 📅 2026-05-01
...
* [Hasura](https://github.com/hasura/graphql-engine) ⭐ 31,967 | 🐛 2,370 | 🌐 TypeScript | 📅 2026-04-30 - Hasura gives Instant Realtime GraphQL APIs over PostgreSQL. Works with an existing database too.
...
* [apollo-android](https://github.com/apollographql/apollo-android) ⭐ 3,953 | 🐛 111 | 🌐 Kotlin | 📅 2026-05-01 - 📟 A strongly-typed, caching GraphQL client for Android, written in Java.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,734 | 🐛 110 | 🌐 Java | 📅 2026-04-14 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [apollo-ios](https://github.com/apollographql/apollo-ios) ⭐ 4,034 | 🐛 88 | 🌐 Swift | 📅 2026-04-23 - 📱 A strongly-typed, caching GraphQL client for iOS, written in Swift.
...
* [graphql-crystal](https://github.com/ziprandom/graphql-crystal) ⭐ 213 | 🐛 9 | 🌐 Crystal | 📅 2020-07-01 - library inspired by [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,430 | 🐛 70 | 🌐 Ruby | 📅 2026-04-29 & [go-graphql](https://github.com/playlyfe/go-graphql) ⭐ 246 | 🐛 18 | 🌐 Go | 📅 2020-01-22 & [graphql-parser](https://github.com/graphql-dotnet/parser) ⭐ 218 | 🐛 9 | 🌐 C# | 📅 2026-04-10.
...
* [graphql](https://github.com/ballerina-platform/module-ballerina-graphql) ⭐ 138 | 🐛 2 | 🌐 Ballerina | 📅 2026-04-30 - Ballerina standard library for GraphQL. This library provides a GraphQL client and server implementations including builtin support for GraphQL subscriptions.
...
* [Ballerina GraphQL Examples](https://github.com/ballerina-platform/module-ballerina-graphql/tree/master/examples) ⭐ 138 | 🐛 2 | 🌐 Ballerina | 📅 2026-04-30
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 43,417 | 🐛 1,655 | 🌐 JavaScript | 📅 2026-04-30 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,824 | 🐛 383 | 🌐 TypeScript | 📅 2026-04-26 - An in-browser IDE for exploring GraphQL.
* [GraphQL Voyager](https://github.com/APIs-guru/graphql-voyager) ⭐ 8,125 | 🐛 106 | 🌐 TypeScript | 📅 2026-03-30 - Represent any GraphQL API as an interactive graph.
...
* [graphql-to-karate](https://github.com/wbaldoumas/graphql-to-karate) ⭐ 16 | 🐛 3 | 🌐 C# | 📅 2026-05-01 - **Generate Karate API tests** from your GraphQL schemas
...
* [js-graphql-intellij-plugin](https://github.com/jimkyndemeyer/js-graphql-intellij-plugin/) ⭐ 898 | 🐛 157 | 🌐 Java | 📅 2026-04-30 - GraphQL language support for IntelliJ IDEA and WebStorm, including Relay.QL tagged templates in JavaScript and TypeScript.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 45,861 | 🐛 2,580 | 🌐 TypeScript | 📅 2026-04-29 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.

* [Bit](https://github.com/teambit/bit) ⭐ 18,378 | 🐛 75 | 🌐 TypeScript | 📅 2026-05-01 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).

* [amplication](https://github.com/amplication/amplication) ⭐ 15,996 | 🐛 630 | 🌐 TypeScript | 📅 2026-04-23: Amplication is an open‑source low code development tool. It builds database applications with REST API and GraphQL for CRUD with relations, sorting, filtering, pagination.

* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,238 | 🐛 591 | 🌐 TypeScript | 📅 2026-04-30 - GraphQL code generator based on schema and documents.
...
* [raphql-inspector](https://github.com/kamilkisiela/graphql-inspector) ⭐ 1,744 | 🐛 134 | 🌐 TypeScript | 📅 2026-04-30: alidate schema, get schema change notifications, validate operations, find breaking changes, look for similar types, schema coverage.
...
* [ts-graphql-plugin](https://github.com/Quramy/ts-graphql-plugin) ⭐ 755 | 🐛 30 | 🌐 TypeScript | 📅 2026-04-30 - A language service plugin complete and validate GraphQL query in TypeScript template strings.
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 19,893 | 🐛 962 | 🌐 Rust | 📅 2026-05-01
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 16,108 | 🐛 573 | 🌐 Go | 📅 2026-05-01 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 22,857 | 🐛 243 | 🌐 Python | 📅 2026-04-29 - GraphQL-first headless e-commerce platform.
