...
* [GraphQL](https://github.com/graphql/graphql-spec) ⭐ 14,723 | 🐛 192 | 🌐 JavaScript | 📅 2026-04-02 - Working draft of the specification for GraphQL.
* [GraphQL over HTTP](https://github.com/graphql/graphql-over-http) ⭐ 420 | 🐛 35 | 🌐 JavaScript | 📅 2026-04-03 - Working draft of "GraphQL over HTTP" specification.
...
* [graphql-js](https://github.com/graphql/graphql-js) ⭐ 20,327 | 🐛 132 | 🌐 TypeScript | 📅 2026-03-31 - A reference implementation of GraphQL for JavaScript.
...
* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,724 | 🐛 422 | 🌐 TypeScript | 📅 2026-04-03 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
* [aws-amplify](https://github.com/aws-amplify/amplify-js) ⭐ 9,589 | 🐛 477 | 🌐 TypeScript | 📅 2026-04-03 - A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.
...
* [sveltekit-kitql](https://github.com/jycouet/kitql) ⭐ 453 | 🐛 12 | 🌐 TypeScript | 📅 2026-04-03 - A set of tools, helping you building efficient apps in a fast way with SvelteKit and GraphQL.
...
* [relay](https://github.com/facebook/relay) ⭐ 18,935 | 🐛 831 | 🌐 Rust | 📅 2026-04-04 - Relay is a JavaScript framework for building data-driven React applications.
...
* [apollo-server](https://github.com/apollographql/apollo-server) ⭐ 13,946 | 🐛 82 | 🌐 TypeScript | 📅 2026-04-03 - Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
* [graphql-yoga](https://github.com/prisma-labs/graphql-yoga) ⭐ 8,506 | 🐛 133 | 🌐 TypeScript | 📅 2026-04-03 - Fully-featured GraphQL Server with focus on easy setup, performance and great developer experience.
* [mercurius](https://github.com/mercurius-js/mercurius) ⭐ 2,476 | 🐛 63 | 🌐 JavaScript | 📅 2026-04-03 - GraphQL plugin for Fastify.
...
* [graphitejs](https://github.com/graphitejs/server) ⭐ 122 | 🐛 18 | 🌐 JavaScript | 📅 2026-04-03 - Framework NodeJS for GraphQL.
...
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,230 | 🐛 604 | 🌐 TypeScript | 📅 2026-04-04: GraphQL code generator with flexible support for custom plugins and templates like TypeScript (frontend and backend), React Hooks, resolvers signatures and more.
* [type-graphql](https://github.com/19majkel94/type-graphql) ⭐ 8,093 | 🐛 114 | 🌐 TypeScript | 📅 2026-04-03 - Create GraphQL schema and resolvers with TypeScript, using classes and decorators!
...
* [pothos](https://github.com/hayes/pothos) ⭐ 2,585 | 🐛 63 | 🌐 TypeScript | 📅 2026-04-01 - Pothos is a plugin based GraphQL schema builder for typescript. It makes building graphql schemas in typescript easy, fast and enjoyable.
...
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 95 | 🐛 5 | 🌐 TypeScript | 📅 2026-04-04 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,542 | 🐛 119 | 🌐 TypeScript | 📅 2026-04-04, [Zod](https://github.com/colinhacks/zod) ⭐ 42,298 | 🐛 310 | 🌐 TypeScript | 📅 2026-02-15, or [Yup](https://github.com/jquense/yup) ⭐ 23,689 | 🐛 240 | 🌐 TypeScript | 📅 2026-04-03.
...
* [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,423 | 🐛 154 | 🌐 TypeScript | 📅 2026-04-04 - Tool library for building and maintaining GraphQL-JS servers.
* [graphql-shield](https://github.com/maticzav/graphql-shield) ⭐ 3,573 | 🐛 108 | 🌐 TypeScript | 📅 2026-04-01 - A library that helps creating a permission layer for a graphql api.
* [graphql-mesh](https://github.com/urigo/graphql-mesh) ⭐ 3,497 | 🐛 218 | 🌐 TypeScript | 📅 2026-04-03 - use GraphQL query language to access data in remote APIs that don't run GraphQL (and also ones that do run GraphQL).
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,196 | 🐛 21 | 🌐 Python | 📅 2026-04-03 - Runs arbitrary queries matching a GraphQL schema to find server errors.
* [graphql-tag](https://github.com/apollographql/graphql-tag) ⭐ 2,332 | 🐛 100 | 🌐 TypeScript | 📅 2024-01-25 - A JavaScript template literal tag that parses GraphQL queries.
...
* [eslint-plugin-graphql](https://github.com/apollographql/eslint-plugin-graphql) ⭐ 1,216 | 🐛 100 | 🌐 JavaScript | 📅 2026-04-03 - An ESLint plugin that checks your GraphQL strings against a schema.
...
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,191 | 🐛 162 | 🌐 TypeScript | 📅 2026-04-03 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
...
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 818 | 🐛 45 | 🌐 Go | 📅 2026-04-03 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
* [graphql-armor](https://github.com/Escape-Technologies/graphql-armor) ⭐ 581 | 🐛 34 | 🌐 TypeScript | 📅 2026-04-04 - An instant security layer for production GraphQL Endpoints.
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 138,605 | 🐛 3,668 | 🌐 JavaScript | 📅 2026-04-04 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
* [React Starter Kit](https://github.com/kriasoft/react-starter-kit) ⭐ 23,549 | 🐛 9 | 🌐 TypeScript | 📅 2026-03-02 - front-end starter kit using React, Relay, GraphQL, and JAM stack architecture.
...
* [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,428 | 🐛 77 | 🌐 Ruby | 📅 2026-04-03 - Ruby implementation of Facebook's GraphQL.
...
* [graphql-php](https://github.com/webonyx/graphql-php) ⭐ 4,707 | 🐛 57 | 🌐 PHP | 📅 2026-04-03 - A PHP port of GraphQL reference implementation.
* [wp-graphql](https://github.com/wp-graphql/wp-graphql) ⭐ 3,779 | 🐛 113 | 🌐 PHP | 📅 2026-04-03 - GraphQL API for WordPress.
* [lighthouse](https://github.com/nuwave/lighthouse) ⭐ 3,484 | 🐛 132 | 🌐 PHP | 📅 2026-03-30 - A PHP package that allows to serve a GraphQL endpoint from your Laravel application.
* [graphql-laravel](https://github.com/rebing/graphql-laravel) ⭐ 2,214 | 🐛 3 | 🌐 PHP | 📅 2026-03-29 - Laravel wrapper for Facebook's GraphQL.
...
* [strawberry](https://github.com/strawberry-graphql/strawberry) ⭐ 4,637 | 🐛 448 | 🌐 Python | 📅 2026-04-02 - A new GraphQL library for Python.
...
* [Ariadne](https://github.com/mirumee/ariadne) ⭐ 2,334 | 🐛 26 | 🌐 Python | 📅 2026-04-03 - library for implementing GraphQL servers using schema-first approach. Asynchronous query execution, batteries included for ASGI, WSGI and popular webframeworks, [fully documented](https://ariadnegraphql.org).
...
* [graphql-java](https://github.com/graphql-java/graphql-java) ⭐ 6,234 | 🐛 53 | 🌐 Java | 📅 2026-04-04 - GraphQL Java implementation.
* [DGS Framework](https://github.com/Netflix/dgs-framework) ⭐ 3,312 | 🐛 44 | 🌐 Kotlin | 📅 2026-04-02 - A GraphQL server framework for Spring Boot, developed by Netflix.
...
* [graphql-java-codegen-maven-plugin](https://github.com/kobylynskyi/graphql-java-codegen-maven-plugin) ⭐ 17 | 🐛 0 | 📅 2020-04-09 - Schema-first maven plugin for generating Java types and Resolver interfaces. Works perfectly in conjunction with graphql-java-tools. Inspired by [swagger-codegen-maven-plugin](https://github.com/swagger-api/swagger-codegen/tree/master/modules/swagger-codegen-maven-plugin) ⭐ 17,722 | 🐛 3,446 | 🌐 Mustache | 📅 2026-03-14.
...
* [graphql-kotlin](https://github.com/ExpediaGroup/graphql-kotlin) ⭐ 1,801 | 🐛 93 | 🌐 Kotlin | 📅 2026-04-03 - GraphQL Kotlin implementation.
...
* [libgraphqlparser](https://github.com/graphql/libgraphqlparser) ⭐ 1,102 | 🐛 39 | 🌐 C++ | 📅 2025-10-02 - A GraphQL query parser in C++ with C and C++ APIs.
...
* [graphjin](https://github.com/dosco/graphjin) ⭐ 3,043 | 🐛 18 | 🌐 Go | 📅 2026-04-04: Build APIs in 5 minutes with GraphQL. An instant GraphQL to SQL compiler.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 818 | 🐛 45 | 🌐 Go | 📅 2026-04-03 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
* [graphql-dotnet](https://github.com/graphql-dotnet/graphql-dotnet) ⭐ 5,980 | 🐛 115 | 🌐 C# | 📅 2026-03-27 - GraphQL for .NET.
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,682 | 🐛 361 | 🌐 C# | 📅 2026-04-03 - GraphQL server for .Net Core and .NET Framework.
* [graphql-net](https://github.com/ckimes89/graphql-net) ⭐ 886 | 🐛 43 | 🌐 C# | 📅 2022-06-22 - GraphQL to IQueryable for .NET.
* [EntityGraphQL](https://github.com/EntityGraphQL/EntityGraphQL) ⭐ 452 | 🐛 22 | 🌐 C# | 📅 2026-03-30 - library to build a GraphQL API on top of data model with the extensibility to bring multiple data sources together in the single GraphQL schema.
* [ZeroQL](https://github.com/byme8/ZeroQL) ⭐ 318 | 🐛 11 | 🌐 C# | 📅 2025-12-28 - type-safe GraphQL client with Linq-like interface for C#
* [Snowflaqe](https://github.com/Zaid-Ajaj/Snowflaqe) ⭐ 160 | 🐛 22 | 🌐 F# | 📅 2024-10-10 - Type-safe GraphQL code generator for F# and [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,069 | 🐛 219 | 🌐 F# | 📅 2026-04-04
...
* [absinthe-graphql](https://github.com/absinthe-graphql/absinthe) ⭐ 4,403 | 🐛 69 | 🌐 Elixir | 📅 2026-04-03 - Fully Featured Elixir GraphQL Library.
...
* [graphql\_parser](https://github.com/graphql-elixir/graphql_parser) ⭐ 23 | 🐛 3 | 🌐 Elixir | 📅 2023-07-02 - Elixir bindings for [libgraphqlparser](https://github.com/graphql/libgraphqlparser) ⭐ 1,102 | 🐛 39 | 🌐 C++ | 📅 2025-10-02
...
* [Hasura](https://github.com/hasura/graphql-engine) ⭐ 31,930 | 🐛 2,376 | 🌐 TypeScript | 📅 2026-04-02 - Hasura gives Instant Realtime GraphQL APIs over PostgreSQL. Works with an existing database too.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,918 | 🐛 150 | 🌐 TypeScript | 📅 2026-04-02 - Lightning-fast GraphQL APIs for PostgreSQL: highly customisable; extensible via plugins; realtime.
...
* [GraphQL](https://github.com/GraphQLSwift/GraphQL) ⭐ 961 | 🐛 7 | 🌐 Swift | 📅 2026-02-28 - The Swift implementation for GraphQL.
...
* [apollo-android](https://github.com/apollographql/apollo-android) ⭐ 3,951 | 🐛 116 | 🌐 Kotlin | 📅 2026-04-03 - 📟 A strongly-typed, caching GraphQL client for Android, written in Java.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,728 | 🐛 108 | 🌐 Java | 📅 2026-03-08 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [graphql-crystal](https://github.com/ziprandom/graphql-crystal) ⭐ 213 | 🐛 9 | 🌐 Crystal | 📅 2020-07-01 - library inspired by [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,428 | 🐛 77 | 🌐 Ruby | 📅 2026-04-03 & [go-graphql](https://github.com/playlyfe/go-graphql) ⭐ 246 | 🐛 18 | 🌐 Go | 📅 2020-01-22 & [graphql-parser](https://github.com/graphql-dotnet/parser) ⭐ 220 | 🐛 8 | 🌐 C# | 📅 2026-03-27.
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 42,536 | 🐛 1,596 | 🌐 JavaScript | 📅 2026-04-03 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
...
* [Altair GraphQL Client](https://github.com/altair-graphql/altair) ⭐ 5,400 | 🐛 71 | 🌐 TypeScript | 📅 2026-04-03 - A beautiful feature-rich GraphQL Client for all platforms.
...
* [mockd](https://github.com/getmockd/mockd) ⭐ 101 | 🐛 0 | 🌐 Go | 📅 2026-04-03 - Multi-protocol mock server with GraphQL schema mocking, resolver configuration, and query validation. Also supports HTTP, gRPC, WebSocket, MQTT, and SOAP.
* [graphql-to-karate](https://github.com/wbaldoumas/graphql-to-karate) ⭐ 16 | 🐛 3 | 🌐 C# | 📅 2026-04-03 - **Generate Karate API tests** from your GraphQL schemas
...
* [GraphQLer](https://github.com/omar2535/GraphQLer) ⭐ 162 | 🐛 15 | 🌐 Python | 📅 2026-04-03 - Dependency-aware dynamic GraphQL testing tool
...
* [spectaql](https://github.com/anvilco/spectaql) ⭐ 1,222 | 🐛 87 | 🌐 JavaScript | 📅 2026-03-27 - Autogenerate static GraphQL API documentation.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 45,653 | 🐛 2,544 | 🌐 TypeScript | 📅 2026-04-02 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.
* [Bit](https://github.com/teambit/bit) ⭐ 18,369 | 🐛 71 | 🌐 TypeScript | 📅 2026-04-03 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).
* [amplication](https://github.com/amplication/amplication) ⭐ 15,996 | 🐛 616 | 🌐 TypeScript | 📅 2026-04-03: Amplication is an open‑source low code development tool. It builds database applications with REST API and GraphQL for CRUD with relations, sorting, filtering, pagination.
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,230 | 🐛 604 | 🌐 TypeScript | 📅 2026-04-04 - GraphQL code generator based on schema and documents.
...
* [ts-graphql-plugin](https://github.com/Quramy/ts-graphql-plugin) ⭐ 757 | 🐛 24 | 🌐 TypeScript | 📅 2026-04-03 - A language service plugin complete and validate GraphQL query in TypeScript template strings.
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 19,754 | 🐛 927 | 🌐 Rust | 📅 2026-04-03
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 15,947 | 🐛 537 | 🌐 Go | 📅 2026-04-03 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 22,767 | 🐛 240 | 🌐 Python | 📅 2026-04-03 - GraphQL-first headless e-commerce platform.
