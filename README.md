...
* [graphql-js](https://github.com/graphql/graphql-js) ⭐ 20,333 | 🐛 134 | 🌐 TypeScript | 📅 2026-03-17 - A reference implementation of GraphQL for JavaScript.
...
* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,723 | 🐛 418 | 🌐 TypeScript | 📅 2026-03-18 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
* [aws-amplify](https://github.com/aws-amplify/amplify-js) ⭐ 9,591 | 🐛 474 | 🌐 TypeScript | 📅 2026-03-18 - A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.
...
* [genql](https://github.com/remorses/genql) ⭐ 967 | 🐛 9 | 🌐 TypeScript | 📅 2026-02-01 - Type safe TypeScript client for any GraphQL API.
...
* [relay](https://github.com/facebook/relay) ⭐ 18,937 | 🐛 818 | 🌐 Rust | 📅 2026-03-19 - Relay is a JavaScript framework for building data-driven React applications.
* [urql](https://github.com/FormidableLabs/urql) ⭐ 8,942 | 🐛 37 | 🌐 TypeScript | 📅 2026-02-26 - A simple caching GraphQL client for React.
...
* [apollo-server](https://github.com/apollographql/apollo-server) ⭐ 13,951 | 🐛 80 | 🌐 TypeScript | 📅 2026-03-16 - Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
* [graphql-yoga](https://github.com/prisma-labs/graphql-yoga) ⭐ 8,501 | 🐛 129 | 🌐 TypeScript | 📅 2026-03-19 - Fully-featured GraphQL Server with focus on easy setup, performance and great developer experience.
...
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,224 | 🐛 617 | 🌐 TypeScript | 📅 2026-03-18: GraphQL code generator with flexible support for custom plugins and templates like TypeScript (frontend and backend), React Hooks, resolvers signatures and more.
...
* [gql.tada](https://github.com/0no-co/gql.tada) ⭐ 2,921 | 🐛 26 | 🌐 TypeScript | 📅 2025-11-12 - GraphQL document authoring library, inferring the result and variables types of GraphQL queries and fragments in the TypeScript type system.
...
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 94 | 🐛 4 | 🌐 TypeScript | 📅 2026-03-18 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,501 | 🐛 112 | 🌐 TypeScript | 📅 2026-03-18, [Zod](https://github.com/colinhacks/zod) ⭐ 42,164 | 🐛 291 | 🌐 TypeScript | 📅 2026-02-15, or [Yup](https://github.com/jquense/yup) ⭐ 23,692 | 🐛 240 | 🌐 TypeScript | 📅 2026-03-15.
...
* [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,423 | 🐛 159 | 🌐 TypeScript | 📅 2026-03-19 - Tool library for building and maintaining GraphQL-JS servers.
...
* [graphql-mesh](https://github.com/urigo/graphql-mesh) ⭐ 3,492 | 🐛 219 | 🌐 TypeScript | 📅 2026-03-19 - use GraphQL query language to access data in remote APIs that don't run GraphQL (and also ones that do run GraphQL).
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,121 | 🐛 39 | 🌐 Python | 📅 2026-03-16 - Runs arbitrary queries matching a GraphQL schema to find server errors.
...
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,179 | 🐛 148 | 🌐 TypeScript | 📅 2026-03-18 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
...
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 817 | 🐛 44 | 🌐 Go | 📅 2026-03-18 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
* [graphql-armor](https://github.com/Escape-Technologies/graphql-armor) ⭐ 578 | 🐛 30 | 🌐 TypeScript | 📅 2026-03-18 - An instant security layer for production GraphQL Endpoints.
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 138,354 | 🐛 3,501 | 🌐 JavaScript | 📅 2026-03-19 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
* [React Starter Kit](https://github.com/kriasoft/react-starter-kit) ⭐ 23,544 | 🐛 9 | 🌐 TypeScript | 📅 2026-03-02 - front-end starter kit using React, Relay, GraphQL, and JAM stack architecture.
...
* [NAPERG](https://github.com/alan345/naperg) ⭐ 1,376 | 🐛 0 | 🌐 TypeScript | 📅 2026-03-17 - Fullstack Boilerplate GraphQL. Made with React & Prisma + authentication & roles.
...
* [Node.js API Starter](https://github.com/kriasoft/nodejs-api-starter) ⭐ 3,976 | 🐛 9 | 🌐 TypeScript | 📅 2024-11-10 - Yarn v2 based monorepo template (code-first GraphQL API, PostgreSQL, PnP, Zero-install, serverless).
...
* [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,431 | 🐛 77 | 🌐 Ruby | 📅 2026-03-16 - Ruby implementation of Facebook's GraphQL.
* [graphql-batch](https://github.com/Shopify/graphql-batch) ⭐ 1,437 | 🐛 17 | 🌐 Ruby | 📅 2026-03-16 - A query batching executor for the graphql gem.
...
* [wp-graphql](https://github.com/wp-graphql/wp-graphql) ⭐ 3,772 | 🐛 107 | 🌐 PHP | 📅 2026-03-18 - GraphQL API for WordPress.
* [lighthouse](https://github.com/nuwave/lighthouse) ⭐ 3,483 | 🐛 134 | 🌐 PHP | 📅 2026-03-17 - A PHP package that allows to serve a GraphQL endpoint from your Laravel application.
* [graphql-laravel](https://github.com/rebing/graphql-laravel) ⭐ 2,213 | 🐛 11 | 🌐 PHP | 📅 2026-03-18 - Laravel wrapper for Facebook's GraphQL.
...
* [overblog/graphql-bundle](https://github.com/overblog/GraphQLBundle) ⭐ 797 | 🐛 133 | 🌐 PHP | 📅 2026-03-12 - This bundle provides tools to build a complete GraphQL server in your Symfony App. Supports react-relay.
* [graphqlite](https://github.com/thecodingmachine/graphqlite) ⭐ 572 | 🐛 38 | 🌐 MDX | 📅 2026-03-18 - Framework agnostic library that allows you to write GraphQL server by annotating your PHP classes.
...
* [strawberry](https://github.com/strawberry-graphql/strawberry) ⭐ 4,630 | 🐛 448 | 🌐 Python | 📅 2026-03-18 - A new GraphQL library for Python.
* [graphene-django](https://github.com/graphql-python/graphene-django) ⭐ 4,385 | 🐛 164 | 🌐 Python | 📅 2026-02-03 - A Django integration for Graphene.
* [Ariadne](https://github.com/mirumee/ariadne) ⭐ 2,327 | 🐛 27 | 🌐 Python | 📅 2026-03-17 - library for implementing GraphQL servers using schema-first approach. Asynchronous query execution, batteries included for ASGI, WSGI and popular webframeworks, [fully documented](https://ariadnegraphql.org).
...
* [graphql-java](https://github.com/graphql-java/graphql-java) ⭐ 6,234 | 🐛 70 | 🌐 Java | 📅 2026-03-18 - GraphQL Java implementation.
* [DGS Framework](https://github.com/Netflix/dgs-framework) ⭐ 3,308 | 🐛 49 | 🌐 Kotlin | 📅 2026-03-16 - A GraphQL server framework for Spring Boot, developed by Netflix.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,727 | 🐛 108 | 🌐 Java | 📅 2026-03-08 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [federation-jvm](https://github.com/apollographql/federation-jvm) ⭐ 272 | 🐛 22 | 🌐 Java | 📅 2026-03-18 - Apollo Federation on the JVM.
...
* [dgs-extended-formatters](https://github.com/setchy/dgs-extended-formatters) ⭐ 6 | 🐛 4 | 🌐 Java | 📅 2026-03-18 - An experimental set of DGS Directives for common formatting use-cases.
...
* [graphql-java-extended-scalars](https://github.com/graphql-java/graphql-java-extended-scalars) ⭐ 282 | 🐛 3 | 🌐 Java | 📅 2026-03-09 - Extended scalars for graphql-java.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,689 | 🐛 389 | 🌐 Go | 📅 2026-03-17 - Go generate based graphql server library.
...
* [caliban](https://github.com/ghostdogpr/caliban) ⭐ 989 | 🐛 28 | 🌐 Scala | 📅 2026-03-18 - Caliban is a purely functional library for creating GraphQL backends in Scala.
...
* [graphql-dotnet](https://github.com/graphql-dotnet/graphql-dotnet) ⭐ 5,982 | 🐛 111 | 🌐 C# | 📅 2026-03-18 - GraphQL for .NET.
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,673 | 🐛 357 | 🌐 C# | 📅 2026-03-19 - GraphQL server for .Net Core and .NET Framework.
...
* [Snowflaqe](https://github.com/Zaid-Ajaj/Snowflaqe) ⭐ 160 | 🐛 22 | 🌐 F# | 📅 2024-10-10 - Type-safe GraphQL code generator for F# and [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,066 | 🐛 236 | 🌐 F# | 📅 2026-03-19
...
* [absinthe-graphql](https://github.com/absinthe-graphql/absinthe) ⭐ 4,399 | 🐛 75 | 🌐 Elixir | 📅 2026-03-17 - Fully Featured Elixir GraphQL Library.
...
* [Hasura](https://github.com/hasura/graphql-engine) ⭐ 31,923 | 🐛 2,376 | 🌐 TypeScript | 📅 2026-03-17 - Hasura gives Instant Realtime GraphQL APIs over PostgreSQL. Works with an existing database too.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,911 | 🐛 156 | 🌐 TypeScript | 📅 2026-03-18 - Lightning-fast GraphQL APIs for PostgreSQL: highly customisable; extensible via plugins; realtime.
...
* [Lacinia](https://github.com/walmartlabs/lacinia) ⭐ 1,855 | 🐛 15 | 🌐 Clojure | 📅 2026-03-10 - GraphQL implementation in pure Clojure.
...
* [apollo-android](https://github.com/apollographql/apollo-android) ⭐ 3,952 | 🐛 110 | 🌐 Kotlin | 📅 2026-03-18 - 📟 A strongly-typed, caching GraphQL client for Android, written in Java.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,727 | 🐛 108 | 🌐 Java | 📅 2026-03-08 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [juniper](https://github.com/graphql-rust/juniper) ⭐ 5,948 | 🐛 103 | 🌐 Rust | 📅 2026-03-18 - GraphQL server library for Rust.
...
* [tailcall](https://github.com/tailcallhq/tailcall) ⭐ 1,433 | 🐛 12 | 🌐 Rust | 📅 2026-03-19 - A platform for building high-performance GraphQL backends.
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 41,953 | 🐛 1,811 | 🌐 JavaScript | 📅 2026-03-18 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,816 | 🐛 411 | 🌐 TypeScript | 📅 2026-03-05 - An in-browser IDE for exploring GraphQL.
...
* [mockd](https://github.com/getmockd/mockd) ⭐ 4 | 🐛 1 | 🌐 Go | 📅 2026-03-19 - Multi-protocol mock server with GraphQL schema mocking, resolver configuration, and query validation. Also supports HTTP, gRPC, WebSocket, MQTT, and SOAP.
...
* [GraphQLer](https://github.com/omar2535/GraphQLer) ⭐ 162 | 🐛 16 | 🌐 Python | 📅 2026-03-19 - Dependency-aware dynamic GraphQL testing tool
...
* [Apollo Client Developer Tools](https://github.com/apollographql/apollo-client-devtools) ⭐ 1,524 | 🐛 51 | 🌐 TypeScript | 📅 2026-03-17 - GraphQL debugging tools for Apollo Client in the Chrome developer console
...
* [spectaql](https://github.com/anvilco/spectaql) ⭐ 1,223 | 🐛 87 | 🌐 JavaScript | 📅 2026-03-18 - Autogenerate static GraphQL API documentation.
...
* [js-graphql-intellij-plugin](https://github.com/jimkyndemeyer/js-graphql-intellij-plugin/) ⭐ 898 | 🐛 156 | 🌐 Java | 📅 2026-03-18 - GraphQL language support for IntelliJ IDEA and WebStorm, including Relay.QL tagged templates in JavaScript and TypeScript.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 45,556 | 🐛 2,515 | 🌐 TypeScript | 📅 2026-03-18 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.
* [Bit](https://github.com/teambit/bit) ⭐ 18,364 | 🐛 67 | 🌐 TypeScript | 📅 2026-03-18 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).
...
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,224 | 🐛 617 | 🌐 TypeScript | 📅 2026-03-18 - GraphQL code generator based on schema and documents.
...
* [ts-graphql-plugin](https://github.com/Quramy/ts-graphql-plugin) ⭐ 760 | 🐛 26 | 🌐 TypeScript | 📅 2026-03-18 - A language service plugin complete and validate GraphQL query in TypeScript template strings.
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 19,654 | 🐛 897 | 🌐 Rust | 📅 2026-03-18
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 15,829 | 🐛 584 | 🌐 Go | 📅 2026-03-19 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 22,717 | 🐛 252 | 🌐 Python | 📅 2026-03-18 - GraphQL-first headless e-commerce platform.
