...
* [GraphQL APIs](https://github.com/APIs-guru/graphql-apis) ⭐ 4,676 | 🐛 1 | 📅 2024-09-26 - A collective list of public GraphQL APIs.
...
* [graphql-js](https://github.com/graphql/graphql-js) ⭐ 20,315 | 🐛 136 | 🌐 TypeScript | 📅 2026-05-25 - A reference implementation of GraphQL for JavaScript.
...
* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,718 | 🐛 416 | 🌐 TypeScript | 📅 2026-05-31 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
* [aws-amplify](https://github.com/aws-amplify/amplify-js) ⭐ 9,573 | 🐛 492 | 🌐 TypeScript | 📅 2026-05-28 - A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.
* [graphql-request](https://github.com/prisma-labs/graphql-request) ⭐ 6,112 | 🐛 57 | 🌐 TypeScript | 📅 2026-05-11 - A minimal GraphQL client for Node and browsers.
...
* [gqty](https://github.com/gqty-dev/gqty) ⭐ 1,034 | 🐛 56 | 🌐 TypeScript | 📅 2026-05-28 - A No GraphQL client for TypeScript
...
* [apollo-angular](https://github.com/kamilkisiela/apollo-angular) ⭐ 1,514 | 🐛 21 | 🌐 TypeScript | 📅 2026-05-22 - A fully-featured, production ready caching GraphQL client for Angular and every GraphQL server.
* [svelte-apollo](https://github.com/timhall/svelte-apollo) ⭐ 948 | 🐛 33 | 🌐 TypeScript | 📅 2023-08-03 - Svelte integration for Apollo GraphQL.
* [sveltekit-kitql](https://github.com/jycouet/kitql) ⭐ 455 | 🐛 10 | 🌐 TypeScript | 📅 2026-05-30 - A set of tools, helping you building efficient apps in a fast way with SvelteKit and GraphQL.
...
* [relay](https://github.com/facebook/relay) ⭐ 18,946 | 🐛 836 | 🌐 Rust | 📅 2026-06-01 - Relay is a JavaScript framework for building data-driven React applications.
...
* [@gqty/react](https://github.com/gqty-dev/gqty) ⭐ 1,034 | 🐛 56 | 🌐 TypeScript | 📅 2026-05-28 - A No GraphQL client for TypeScript
...
* [apollo-server](https://github.com/apollographql/apollo-server) ⭐ 13,938 | 🐛 83 | 🌐 TypeScript | 📅 2026-06-01 - Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
* [graphql-yoga](https://github.com/prisma-labs/graphql-yoga) ⭐ 8,523 | 🐛 137 | 🌐 TypeScript | 📅 2026-05-28 - Fully-featured GraphQL Server with focus on easy setup, performance and great developer experience.
...
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,251 | 🐛 566 | 🌐 TypeScript | 📅 2026-05-31: GraphQL code generator with flexible support for custom plugins and templates like TypeScript (frontend and backend), React Hooks, resolvers signatures and more.
...
* [graphql-nexus](https://github.com/graphql-nexus/nexus) ⭐ 3,434 | 🐛 254 | 🌐 TypeScript | 📅 2023-11-19 - Code-First, Type-Safe, GraphQL Schema Construction.
...
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 97 | 🐛 8 | 🌐 TypeScript | 📅 2026-06-01 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,734 | 🐛 122 | 🌐 TypeScript | 📅 2026-05-31, [Zod](https://github.com/colinhacks/zod) ⭐ 42,832 | 🐛 165 | 🌐 TypeScript | 📅 2026-05-31, or [Yup](https://github.com/jquense/yup) ⭐ 23,682 | 🐛 240 | 🌐 TypeScript | 📅 2026-05-31.
...
* [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,429 | 🐛 159 | 🌐 TypeScript | 📅 2026-06-01 - Tool library for building and maintaining GraphQL-JS servers.
* [graphql-shield](https://github.com/maticzav/graphql-shield) ⭐ 3,576 | 🐛 107 | 🌐 TypeScript | 📅 2026-05-28 - A library that helps creating a permission layer for a graphql api.
* [graphql-mesh](https://github.com/urigo/graphql-mesh) ⭐ 3,504 | 🐛 232 | 🌐 TypeScript | 📅 2026-05-29 - use GraphQL query language to access data in remote APIs that don't run GraphQL (and also ones that do run GraphQL).
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,329 | 🐛 17 | 🌐 Python | 📅 2026-05-31 - Runs arbitrary queries matching a GraphQL schema to find server errors.
...
* [graphql-cli](https://github.com/urigo/graphql-cli) ⭐ 2,022 | 🐛 48 | 🌐 TypeScript | 📅 2026-05-19 - A command line tool for common GraphQL development workflows.
...
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,220 | 🐛 158 | 🌐 TypeScript | 📅 2026-05-30 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
* [eslint-plugin-graphql](https://github.com/apollographql/eslint-plugin-graphql) ⭐ 1,215 | 🐛 100 | 🌐 JavaScript | 📅 2026-05-29 - An ESLint plugin that checks your GraphQL strings against a schema.
...
* [graphql-armor](https://github.com/Escape-Technologies/graphql-armor) ⭐ 584 | 🐛 32 | 🌐 TypeScript | 📅 2026-05-28 - An instant security layer for production GraphQL Endpoints.
...
* [graphql-live-query](https://github.com/n1ru4l/graphql-live-query) ⭐ 439 | 🐛 51 | 🌐 TypeScript | 📅 2026-05-31 - Realtime GraphQL Live Queries with JavaScript.
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 139,633 | 🐛 3,991 | 🌐 JavaScript | 📅 2026-06-01 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
* [React Starter Kit](https://github.com/kriasoft/react-starter-kit) ⭐ 23,596 | 🐛 9 | 🌐 TypeScript | 📅 2026-03-02 - front-end starter kit using React, Relay, GraphQL, and JAM stack architecture.
...
* [NAPERG](https://github.com/alan345/naperg) ⭐ 1,401 | 🐛 0 | 🌐 TypeScript | 📅 2026-05-31 - Fullstack Boilerplate GraphQL. Made with React & Prisma + authentication & roles.
...
* [Relay TodoMVC](https://github.com/taion/relay-todomvc) ⭐ 158 | 🐛 40 | 🌐 JavaScript | 📅 2026-05-28 - Relay TodoMVC with routing.
...
* [wp-graphql](https://github.com/wp-graphql/wp-graphql) ⭐ 3,779 | 🐛 126 | 🌐 PHP | 📅 2026-06-01 - GraphQL API for WordPress.
...
* [graphql-laravel](https://github.com/rebing/graphql-laravel) ⭐ 2,212 | 🐛 0 | 🌐 PHP | 📅 2026-05-28 - Laravel wrapper for Facebook's GraphQL.
...
* [graphqlite](https://github.com/thecodingmachine/graphqlite) ⭐ 572 | 🐛 27 | 🌐 MDX | 📅 2026-05-20 - Framework agnostic library that allows you to write GraphQL server by annotating your PHP classes.
...
* [graphene](https://github.com/graphql-python/graphene) ⭐ 8,244 | 🐛 114 | 🌐 Python | 📅 2025-09-04 - A package for creating GraphQL schemas/types in a Pythonic easy way.
* [strawberry](https://github.com/strawberry-graphql/strawberry) ⭐ 4,665 | 🐛 456 | 🌐 Python | 📅 2026-05-31 - A new GraphQL library for Python.
...
* [graphql-core](https://github.com/graphql-python/graphql-core) ⭐ 528 | 🐛 30 | 🌐 Python | 📅 2026-05-23 - GraphQL implementation for Python based on GraphQL.js v16.3.0 reference implementation
...
* [graphql-java-servlet](https://github.com/graphql-java-kickstart/graphql-java-servlet) ⭐ 227 | 🐛 23 | 🌐 Java | 📅 2026-06-01 - A framework-agnostic java servlet for exposing graphql-java query endpoints with GET, POST, and multipart uploads.
...
* [Light Java GraphQL](https://github.com/networknt/light-graphql-4j) ⭐ 34 | 🐛 10 | 🌐 Java | 📅 2026-05-20: A lightweight, fast microservices framework with all cross-cutting concerns addressed and ready to plug in GraphQL schema.
...
* [graphql-java-codegen-maven-plugin](https://github.com/kobylynskyi/graphql-java-codegen-maven-plugin) ⭐ 17 | 🐛 0 | 📅 2020-04-09 - Schema-first maven plugin for generating Java types and Resolver interfaces. Works perfectly in conjunction with graphql-java-tools. Inspired by [swagger-codegen-maven-plugin](https://github.com/swagger-api/swagger-codegen/tree/master/modules/swagger-codegen-maven-plugin) ⭐ 17,750 | 🐛 3,449 | 🌐 Mustache | 📅 2026-05-19.
...
* [graphql-kotlin](https://github.com/ExpediaGroup/graphql-kotlin) ⭐ 1,802 | 🐛 83 | 🌐 Kotlin | 📅 2026-05-18 - GraphQL Kotlin implementation.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,727 | 🐛 382 | 🌐 Go | 📅 2026-05-31 - Go generate based graphql server library.
* [graphql](https://github.com/graphql-go/graphql) ⭐ 10,154 | 🐛 243 | 🌐 Go | 📅 2025-12-27 - An implementation of GraphQL for Go follows graphql-js
* [graphql-go](https://github.com/graph-gophers/graphql-go) ⭐ 4,752 | 🐛 9 | 🌐 Go | 📅 2026-05-31 - GraphQL server with a focus on ease of use.
* [graphjin](https://github.com/dosco/graphjin) ⭐ 3,076 | 🐛 21 | 🌐 Go | 📅 2026-05-31: Build APIs in 5 minutes with GraphQL. An instant GraphQL to SQL compiler.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 819 | 🐛 43 | 🌐 Go | 📅 2026-05-29 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
* [graphql-dotnet](https://github.com/graphql-dotnet/graphql-dotnet) ⭐ 5,985 | 🐛 129 | 🌐 C# | 📅 2026-05-24 - GraphQL for .NET.
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,702 | 🐛 390 | 🌐 C# | 📅 2026-05-31 - GraphQL server for .Net Core and .NET Framework.
...
* [apollo-android](https://github.com/apollographql/apollo-android) ⭐ 3,953 | 🐛 113 | 🌐 Kotlin | 📅 2026-06-01 - 📟 A strongly-typed, caching GraphQL client for Android, written in Java.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,741 | 🐛 110 | 🌐 Java | 📅 2026-05-24 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [apollo-ios](https://github.com/apollographql/apollo-ios) ⭐ 4,032 | 🐛 89 | 🌐 Swift | 📅 2026-05-21 - 📱 A strongly-typed, caching GraphQL client for iOS, written in Swift.
...
* [juniper](https://github.com/graphql-rust/juniper) ⭐ 5,959 | 🐛 103 | 🌐 Rust | 📅 2026-05-17 - GraphQL server library for Rust.
...
* [tailcall](https://github.com/tailcallhq/tailcall) ⭐ 1,440 | 🐛 18 | 🌐 Rust | 📅 2026-05-29 - A platform for building high-performance GraphQL backends.
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 44,599 | 🐛 1,686 | 🌐 JavaScript | 📅 2026-05-29 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,836 | 🐛 391 | 🌐 TypeScript | 📅 2026-05-28 - An in-browser IDE for exploring GraphQL.
...
* [Altair GraphQL Client](https://github.com/altair-graphql/altair) ⭐ 5,409 | 🐛 157 | 🌐 TypeScript | 📅 2026-05-30 - A beautiful feature-rich GraphQL Client for all platforms.
...
* [graphql-to-karate](https://github.com/wbaldoumas/graphql-to-karate) ⭐ 16 | 🐛 3 | 🌐 C# | 📅 2026-05-31 - **Generate Karate API tests** from your GraphQL schemas
...
* [InQL Scanner](https://github.com/doyensec/inql) ⭐ 1,779 | 🐛 37 | 🌐 Kotlin | 📅 2026-04-22 - A Burp Extension for GraphQL Security Testing
...
* [Apollo Client Developer Tools](https://github.com/apollographql/apollo-client-devtools) ⭐ 1,524 | 🐛 56 | 🌐 TypeScript | 📅 2026-06-01 - GraphQL debugging tools for Apollo Client in the Chrome developer console
...
* [js-graphql-intellij-plugin](https://github.com/jimkyndemeyer/js-graphql-intellij-plugin/) ⭐ 899 | 🐛 157 | 🌐 Java | 📅 2026-05-29 - GraphQL language support for IntelliJ IDEA and WebStorm, including Relay.QL tagged templates in JavaScript and TypeScript.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 46,045 | 🐛 2,626 | 🌐 TypeScript | 📅 2026-05-19 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.

* [Bit](https://github.com/teambit/bit) ⭐ 18,401 | 🐛 85 | 🌐 TypeScript | 📅 2026-05-30 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).

* [amplication](https://github.com/amplication/amplication) ⭐ 16,008 | 🐛 647 | 🌐 TypeScript | 📅 2026-05-30: Amplication is an open‑source low code development tool. It builds database applications with REST API and GraphQL for CRUD with relations, sorting, filtering, pagination.

* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,251 | 🐛 566 | 🌐 TypeScript | 📅 2026-05-31 - GraphQL code generator based on schema and documents.

* [json-graphql-server](https://github.com/marmelab/json-graphql-server) ⭐ 1,950 | 🐛 11 | 🌐 JavaScript | 📅 2026-04-07 - Get a full fake GraphQL API with zero coding in less than 30 seconds, based on a JSON data file.
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 20,077 | 🐛 992 | 🌐 Rust | 📅 2026-06-01
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 16,260 | 🐛 548 | 🌐 Go | 📅 2026-06-01 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 22,947 | 🐛 253 | 🌐 Python | 📅 2026-06-01 - GraphQL-first headless e-commerce platform.
