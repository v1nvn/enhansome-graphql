...
* [GraphQL](https://github.com/graphql/graphql-spec) ⭐ 14,570 | 🐛 194 | 🌐 JavaScript | 📅 2026-06-09 - Working draft of the specification for GraphQL.
* [GraphQL over HTTP](https://github.com/graphql/graphql-over-http) ⭐ 424 | 🐛 31 | 🌐 JavaScript | 📅 2026-06-04 - Working draft of "GraphQL over HTTP" specification.
...
* [GraphQL APIs](https://github.com/APIs-guru/graphql-apis) ⭐ 4,677 | 🐛 2 | 📅 2024-09-26 - A collective list of public GraphQL APIs.
...
* [graphql-js](https://github.com/graphql/graphql-js) ⭐ 20,360 | 🐛 90 | 🌐 TypeScript | 📅 2026-06-09 - A reference implementation of GraphQL for JavaScript.
...
* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,768 | 🐛 407 | 🌐 TypeScript | 📅 2026-06-09 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
* [aws-amplify](https://github.com/aws-amplify/amplify-js) ⭐ 9,575 | 🐛 492 | 🌐 TypeScript | 📅 2026-06-09 - A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.
* [graphql-request](https://github.com/prisma-labs/graphql-request) ⭐ 6,109 | 🐛 57 | 🌐 TypeScript | 📅 2026-05-11 - A minimal GraphQL client for Node and browsers.
...
* [graphql-zeus](https://github.com/graphql-editor/graphql-zeus) ⭐ 1,974 | 🐛 57 | 🌐 TypeScript | 📅 2026-04-07 - GraphQL Zeus creates autocomplete client library for `JavaScript` or `TypeScript` which provides autocompletion for strongly typed queries.
* [gqty](https://github.com/gqty-dev/gqty) ⭐ 1,035 | 🐛 56 | 🌐 TypeScript | 📅 2026-06-09 - A No GraphQL client for TypeScript
...
* [sveltekit-kitql](https://github.com/jycouet/kitql) ⭐ 454 | 🐛 12 | 🌐 TypeScript | 📅 2026-06-09 - A set of tools, helping you building efficient apps in a fast way with SvelteKit and GraphQL.
* [apollo-elements](https://github.com/apollo-elements/apollo-elements) ⭐ 422 | 🐛 17 | 🌐 TypeScript | 📅 2026-06-09 - GraphQL web components that work in any frontend framework.
...
* [relay](https://github.com/facebook/relay) ⭐ 18,941 | 🐛 844 | 🌐 Rust | 📅 2026-06-10 - Relay is a JavaScript framework for building data-driven React applications.
* [urql](https://github.com/FormidableLabs/urql) ⭐ 8,949 | 🐛 43 | 🌐 TypeScript | 📅 2026-06-06 - A simple caching GraphQL client for React.
* [graphql-hooks](https://github.com/nearform/graphql-hooks) ⭐ 1,886 | 🐛 9 | 🌐 TypeScript | 📅 2026-01-26 - Minimal hooks-first GraphQL client with caching and server-side rendering support.
* [@gqty/react](https://github.com/gqty-dev/gqty) ⭐ 1,035 | 🐛 56 | 🌐 TypeScript | 📅 2026-06-09 - A No GraphQL client for TypeScript
...
* [apollo-server](https://github.com/apollographql/apollo-server) ⭐ 13,937 | 🐛 82 | 🌐 TypeScript | 📅 2026-06-09 - Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
* [graphql-yoga](https://github.com/prisma-labs/graphql-yoga) ⭐ 8,522 | 🐛 140 | 🌐 TypeScript | 📅 2026-06-09 - Fully-featured GraphQL Server with focus on easy setup, performance and great developer experience.
...
* [pylon](https://github.com/getcronit/pylon) ⭐ 370 | 🐛 27 | 🌐 TypeScript | 📅 2026-06-02 - Write full-feature APIs with just functions. No more boilerplate code, no more setup. Just write functions and deploy.
* [gql](https://github.com/deno-libs/gql) ⭐ 203 | 🐛 0 | 🌐 TypeScript | 📅 2026-01-20 - Universal GraphQL HTTP middleware for Deno.
* [graphitejs](https://github.com/graphitejs/server) ⭐ 122 | 🐛 18 | 🌐 JavaScript | 📅 2026-05-30 - Framework NodeJS for GraphQL.
...
* [join-monster](https://github.com/acarl005/join-monster) ⭐ 2,701 | 🐛 32 | 🌐 JavaScript | 📅 2025-08-06 - A GraphQL-to-SQL query execution layer for batch data fetching.
* [graphql-sequelize](https://github.com/mickhansen/graphql-sequelize) ⭐ 1,885 | 🐛 1 | 🌐 JavaScript | 📅 2022-11-16 - Sequelize helpers for GraphQL.
...
* [graphql-scalars](https://github.com/Urigo/graphql-scalars) ⭐ 1,934 | 🐛 43 | 🌐 TypeScript | 📅 2026-05-29 - A library of custom GraphQL Scalars for creating precise type-safe GraphQL schemas.

#### Type

* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,252 | 🐛 563 | 🌐 TypeScript | 📅 2026-06-03: GraphQL code generator with flexible support for custom plugins and templates like TypeScript (frontend and backend), React Hooks, resolvers signatures and more.
...
* [graphql-nexus](https://github.com/graphql-nexus/nexus) ⭐ 3,432 | 🐛 254 | 🌐 TypeScript | 📅 2023-11-19 - Code-First, Type-Safe, GraphQL Schema Construction.
* [gql.tada](https://github.com/0no-co/gql.tada) ⭐ 2,935 | 🐛 29 | 🌐 TypeScript | 📅 2026-06-06 - GraphQL document authoring library, inferring the result and variables types of GraphQL queries and fragments in the TypeScript type system.
* [pothos](https://github.com/hayes/pothos) ⭐ 2,595 | 🐛 65 | 🌐 TypeScript | 📅 2026-05-21 - Pothos is a plugin based GraphQL schema builder for typescript. It makes building graphql schemas in typescript easy, fast and enjoyable.
* [garph](https://github.com/stepci/garph) ⭐ 1,314 | 🐛 27 | 🌐 TypeScript | 📅 2024-03-01 - Garph is full-stack framework for building type-safe GraphQL APIs in TypeScript.
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 99 | 🐛 7 | 🌐 TypeScript | 📅 2026-06-09 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,742 | 🐛 120 | 🌐 TypeScript | 📅 2026-06-08, [Zod](https://github.com/colinhacks/zod) ⭐ 42,913 | 🐛 190 | 🌐 TypeScript | 📅 2026-06-08, or [Yup](https://github.com/jquense/yup) ⭐ 23,674 | 🐛 241 | 🌐 TypeScript | 📅 2026-06-01.
...
* [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,425 | 🐛 170 | 🌐 TypeScript | 📅 2026-06-10 - Tool library for building and maintaining GraphQL-JS servers.
* [graphql-shield](https://github.com/maticzav/graphql-shield) ⭐ 3,573 | 🐛 107 | 🌐 TypeScript | 📅 2026-06-01 - A library that helps creating a permission layer for a graphql api.
* [graphql-mesh](https://github.com/urigo/graphql-mesh) ⭐ 3,504 | 🐛 231 | 🌐 TypeScript | 📅 2026-06-05 - use GraphQL query language to access data in remote APIs that don't run GraphQL (and also ones that do run GraphQL).
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,359 | 🐛 17 | 🌐 Python | 📅 2026-06-09 - Runs arbitrary queries matching a GraphQL schema to find server errors.
* [graphql-tag](https://github.com/apollographql/graphql-tag) ⭐ 2,331 | 🐛 99 | 🌐 TypeScript | 📅 2024-01-25 - A JavaScript template literal tag that parses GraphQL queries.
...
* [graphql-ws](https://github.com/enisdenjo/graphql-ws) ⭐ 1,865 | 🐛 11 | 🌐 TypeScript | 📅 2026-03-26 - Coherent, zero-dependency, lazy, simple, GraphQL over WebSocket Protocol compliant server and client.
...
* [graphql-modules](https://github.com/Urigo/graphql-modules) ⭐ 1,327 | 🐛 51 | 🌐 TypeScript | 📅 2026-05-26 - Separate GraphQL server into smaller, reusable parts by modules or features.
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,224 | 🐛 175 | 🌐 TypeScript | 📅 2026-06-09 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
* [eslint-plugin-graphql](https://github.com/apollographql/eslint-plugin-graphql) ⭐ 1,215 | 🐛 100 | 🌐 JavaScript | 📅 2026-06-09 - An ESLint plugin that checks your GraphQL strings against a schema.
...
* [graphql-config](https://github.com/kamilkisiela/graphql-config) ⭐ 1,198 | 🐛 29 | 🌐 TypeScript | 📅 2026-03-25 - One configuration for all your GraphQL tools (supported by most tools, editors & IDEs).
...
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 821 | 🐛 39 | 🌐 Go | 📅 2026-06-10 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
* [graphql-armor](https://github.com/Escape-Technologies/graphql-armor) ⭐ 585 | 🐛 33 | 🌐 TypeScript | 📅 2026-06-10 - An instant security layer for production GraphQL Endpoints.
...
* [graphql-live-query](https://github.com/n1ru4l/graphql-live-query) ⭐ 439 | 🐛 51 | 🌐 TypeScript | 📅 2026-06-08 - Realtime GraphQL Live Queries with JavaScript.
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 139,917 | 🐛 4,023 | 🌐 JavaScript | 📅 2026-06-10 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
* [React Starter Kit](https://github.com/kriasoft/react-starter-kit) ⭐ 23,598 | 🐛 9 | 🌐 TypeScript | 📅 2026-03-02 - front-end starter kit using React, Relay, GraphQL, and JAM stack architecture.
...
* [NAPERG](https://github.com/alan345/naperg) ⭐ 1,401 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-06 - Fullstack Boilerplate GraphQL. Made with React & Prisma + authentication & roles.
* [SWAPI GraphQL Wrapper](https://github.com/graphql/swapi-graphql) ⭐ 1,063 | 🐛 26 | 🌐 JavaScript | 📅 2026-05-25 - A GraphQL schema and server wrapping SWAPI.
* [Relay TodoMVC](https://github.com/taion/relay-todomvc) ⭐ 157 | 🐛 40 | 🌐 JavaScript | 📅 2026-06-01 - Relay TodoMVC with routing.
...
* [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,448 | 🐛 60 | 🌐 Ruby | 📅 2026-05-28 - Ruby implementation of Facebook's GraphQL.
...
* [graphql-php](https://github.com/webonyx/graphql-php) ⭐ 4,716 | 🐛 58 | 🌐 PHP | 📅 2026-06-09 - A PHP port of GraphQL reference implementation.
* [wp-graphql](https://github.com/wp-graphql/wp-graphql) ⭐ 3,780 | 🐛 113 | 🌐 PHP | 📅 2026-06-09 - GraphQL API for WordPress.
* [lighthouse](https://github.com/nuwave/lighthouse) ⭐ 3,494 | 🐛 132 | 🌐 PHP | 📅 2026-06-07 - A PHP package that allows to serve a GraphQL endpoint from your Laravel application.
* [graphql-laravel](https://github.com/rebing/graphql-laravel) ⭐ 2,211 | 🐛 0 | 🌐 PHP | 📅 2026-06-08 - Laravel wrapper for Facebook's GraphQL.
...
* [graphqlite](https://github.com/thecodingmachine/graphqlite) ⭐ 572 | 🐛 32 | 🌐 MDX | 📅 2026-06-08 - Framework agnostic library that allows you to write GraphQL server by annotating your PHP classes.
...
* [jerowork/graphql-schema-builder](https://github.com/jerowork/graphql-attribute-schema) ⭐ 16 | 🐛 2 | 🌐 PHP | 📅 2026-06-09 - Easily build your GraphQL schema for webonyx/graphql-php using PHP attributes instead of large configuration arrays.
...
* [graphene](https://github.com/graphql-python/graphene) ⭐ 8,240 | 🐛 114 | 🌐 Python | 📅 2025-09-04 - A package for creating GraphQL schemas/types in a Pythonic easy way.
* [strawberry](https://github.com/strawberry-graphql/strawberry) ⭐ 4,670 | 🐛 450 | 🌐 Python | 📅 2026-06-09 - A new GraphQL library for Python.
* [graphene-django](https://github.com/graphql-python/graphene-django) ⭐ 4,390 | 🐛 165 | 🌐 Python | 📅 2026-02-03 - A Django integration for Graphene.
* [Ariadne](https://github.com/mirumee/ariadne) ⭐ 2,342 | 🐛 33 | 🌐 Python | 📅 2026-06-08 - library for implementing GraphQL servers using schema-first approach. Asynchronous query execution, batteries included for ASGI, WSGI and popular webframeworks, [fully documented](https://ariadnegraphql.org).
...
* [graphql-core](https://github.com/graphql-python/graphql-core) ⭐ 528 | 🐛 29 | 🌐 Python | 📅 2026-06-07 - GraphQL implementation for Python based on GraphQL.js v16.3.0 reference implementation
...
* [DGS Framework](https://github.com/Netflix/dgs-framework) ⭐ 3,370 | 🐛 47 | 🌐 Kotlin | 📅 2026-06-08 - A GraphQL server framework for Spring Boot, developed by Netflix.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,746 | 🐛 110 | 🌐 Java | 📅 2026-05-24 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [federation-jvm](https://github.com/apollographql/federation-jvm) ⭐ 273 | 🐛 24 | 🌐 Java | 📅 2026-06-08 - Apollo Federation on the JVM.
* [graphql-java-servlet](https://github.com/graphql-java-kickstart/graphql-java-servlet) ⭐ 227 | 🐛 23 | 🌐 Java | 📅 2026-06-08 - A framework-agnostic java servlet for exposing graphql-java query endpoints with GET, POST, and multipart uploads.
...
* [graphql-java-codegen-maven-plugin](https://github.com/kobylynskyi/graphql-java-codegen-maven-plugin) ⭐ 17 | 🐛 0 | 📅 2020-04-09 - Schema-first maven plugin for generating Java types and Resolver interfaces. Works perfectly in conjunction with graphql-java-tools. Inspired by [swagger-codegen-maven-plugin](https://github.com/swagger-api/swagger-codegen/tree/master/modules/swagger-codegen-maven-plugin) ⭐ 17,757 | 🐛 3,451 | 🌐 Mustache | 📅 2026-05-19.
...
* [graphql-java-kickstart\_samples](https://github.com/graphql-java-kickstart/samples) ⭐ 121 | 🐛 16 | 🌐 Java | 📅 2026-05-12 - Samples for using the GraphQL Java Kickstart projects.
...
* [graphql-kotlin](https://github.com/ExpediaGroup/graphql-kotlin) ⭐ 1,804 | 🐛 85 | 🌐 Kotlin | 📅 2026-06-01 - GraphQL Kotlin implementation.
...
* [Kobby](https://github.com/ermadmi78/kobby) ⭐ 87 | 🐛 1 | 🌐 Kotlin | 📅 2026-01-17 - Codegen plugin of Kotlin DSL Client by GraphQL schema. The generated DSL supports execution of complex GraphQL queries, mutation and subscriptions in Kotlin with syntax similar to native GraphQL syntax.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,724 | 🐛 387 | 🌐 Go | 📅 2026-06-08 - Go generate based graphql server library.
...
* [graphjin](https://github.com/dosco/graphjin) ⭐ 3,081 | 🐛 21 | 🌐 Go | 📅 2026-06-09: Build APIs in 5 minutes with GraphQL. An instant GraphQL to SQL compiler.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 821 | 🐛 39 | 🌐 Go | 📅 2026-06-10 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
* [sangria](https://github.com/sangria-graphql/sangria) ⭐ 1,963 | 🐛 64 | 🌐 Scala | 📅 2026-05-17 - Scala GraphQL server implementation.
* [caliban](https://github.com/ghostdogpr/caliban) ⭐ 996 | 🐛 25 | 🌐 Scala | 📅 2026-06-07 - Caliban is a purely functional library for creating GraphQL backends in Scala.
...
* [graphql-dotnet](https://github.com/graphql-dotnet/graphql-dotnet) ⭐ 5,986 | 🐛 131 | 🌐 C# | 📅 2026-06-08 - GraphQL for .NET.
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,707 | 🐛 407 | 🌐 C# | 📅 2026-06-10 - GraphQL server for .Net Core and .NET Framework.
* [graphql-net](https://github.com/ckimes89/graphql-net) ⭐ 884 | 🐛 43 | 🌐 C# | 📅 2022-06-22 - GraphQL to IQueryable for .NET.
* [EntityGraphQL](https://github.com/EntityGraphQL/EntityGraphQL) ⭐ 454 | 🐛 17 | 🌐 C# | 📅 2026-06-09 - library to build a GraphQL API on top of data model with the extensibility to bring multiple data sources together in the single GraphQL schema.
* [ZeroQL](https://github.com/byme8/ZeroQL) ⭐ 320 | 🐛 12 | 🌐 C# | 📅 2025-12-28 - type-safe GraphQL client with Linq-like interface for C#
* [Snowflaqe](https://github.com/Zaid-Ajaj/Snowflaqe) ⭐ 161 | 🐛 22 | 🌐 F# | 📅 2024-10-10 - Type-safe GraphQL code generator for F# and [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,088 | 🐛 210 | 🌐 F# | 📅 2026-06-09
...
* [absinthe-graphql](https://github.com/absinthe-graphql/absinthe) ⭐ 4,400 | 🐛 72 | 🌐 Elixir | 📅 2026-06-09 - Fully Featured Elixir GraphQL Library.
...
* [Hasura](https://github.com/hasura/graphql-engine) ⭐ 32,043 | 🐛 2,375 | 🌐 TypeScript | 📅 2026-06-08 - Hasura gives Instant Realtime GraphQL APIs over PostgreSQL. Works with an existing database too.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,924 | 🐛 155 | 🌐 TypeScript | 📅 2026-06-08 - Lightning-fast GraphQL APIs for PostgreSQL: highly customisable; extensible via plugins; realtime.
...
* [apollo-android](https://github.com/apollographql/apollo-android) ⭐ 3,951 | 🐛 115 | 🌐 Kotlin | 📅 2026-06-10 - 📟 A strongly-typed, caching GraphQL client for Android, written in Java.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,746 | 🐛 110 | 🌐 Java | 📅 2026-05-24 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [apollo-ios](https://github.com/apollographql/apollo-ios) ⭐ 4,032 | 🐛 92 | 🌐 Swift | 📅 2026-06-02 - 📱 A strongly-typed, caching GraphQL client for iOS, written in Swift.
...
* [graphql-flutter](https://github.com/zino-app/graphql-flutter) ⭐ 3,272 | 🐛 161 | 🌐 Dart | 📅 2026-03-30 - A GraphQL client for Flutter.
...
* [juniper](https://github.com/graphql-rust/juniper) ⭐ 5,964 | 🐛 104 | 🌐 Rust | 📅 2026-06-07 - GraphQL server library for Rust.
* [async-graphql](https://github.com/async-graphql/async-graphql) ⭐ 3,667 | 🐛 246 | 🌐 Rust | 📅 2026-04-21 - High-performance server-side library that supports all GraphQL specifications.
* [tailcall](https://github.com/tailcallhq/tailcall) ⭐ 1,440 | 🐛 19 | 🌐 Rust | 📅 2026-06-09 - A platform for building high-performance GraphQL backends.
...
* [graphql-crystal](https://github.com/ziprandom/graphql-crystal) ⭐ 213 | 🐛 9 | 🌐 Crystal | 📅 2020-07-01 - library inspired by [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,448 | 🐛 60 | 🌐 Ruby | 📅 2026-05-28 & [go-graphql](https://github.com/playlyfe/go-graphql) ⭐ 246 | 🐛 18 | 🌐 Go | 📅 2020-01-22 & [graphql-parser](https://github.com/graphql-dotnet/parser) ⭐ 218 | 🐛 9 | 🌐 C# | 📅 2026-04-10.
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 44,795 | 🐛 1,695 | 🌐 JavaScript | 📅 2026-06-09 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,841 | 🐛 387 | 🌐 TypeScript | 📅 2026-06-08 - An in-browser IDE for exploring GraphQL.
* [GraphQL Voyager](https://github.com/APIs-guru/graphql-voyager) ⭐ 8,140 | 🐛 106 | 🌐 TypeScript | 📅 2026-05-12 - Represent any GraphQL API as an interactive graph.
* [GraphQL Editor](https://github.com/graphql-editor/graphql-editor) ⭐ 6,067 | 🐛 20 | 🌐 TypeScript | 📅 2025-09-10 - Visual Editor & GraphQL IDE.
* [Altair GraphQL Client](https://github.com/altair-graphql/altair) ⭐ 5,410 | 🐛 159 | 🌐 TypeScript | 📅 2026-06-09 - A beautiful feature-rich GraphQL Client for all platforms.
...
* [mockd](https://github.com/getmockd/mockd) ⭐ 124 | 🐛 18 | 🌐 Go | 📅 2026-06-03 - Multi-protocol mock server with GraphQL schema mocking, resolver configuration, and query validation. Also supports HTTP, gRPC, WebSocket, MQTT, and SOAP.
* [graphql-to-karate](https://github.com/wbaldoumas/graphql-to-karate) ⭐ 16 | 🐛 1 | 🌐 C# | 📅 2026-06-02 - **Generate Karate API tests** from your GraphQL schemas
...
* [InQL Scanner](https://github.com/doyensec/inql) ⭐ 1,782 | 🐛 37 | 🌐 Kotlin | 📅 2026-06-08 - A Burp Extension for GraphQL Security Testing
...
* [Apollo Client Developer Tools](https://github.com/apollographql/apollo-client-devtools) ⭐ 1,524 | 🐛 56 | 🌐 TypeScript | 📅 2026-06-09 - GraphQL debugging tools for Apollo Client in the Chrome developer console
...
* [js-graphql-intellij-plugin](https://github.com/jimkyndemeyer/js-graphql-intellij-plugin/) ⭐ 898 | 🐛 157 | 🌐 Java | 📅 2026-06-09 - GraphQL language support for IntelliJ IDEA and WebStorm, including Relay.QL tagged templates in JavaScript and TypeScript.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 46,252 | 🐛 2,616 | 🌐 TypeScript | 📅 2026-06-08 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.
* [Bit](https://github.com/teambit/bit) ⭐ 18,405 | 🐛 83 | 🌐 TypeScript | 📅 2026-06-09 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).
* [amplication](https://github.com/amplication/amplication) ⭐ 16,009 | 🐛 653 | 🌐 TypeScript | 📅 2026-06-09: Amplication is an open‑source low code development tool. It builds database applications with REST API and GraphQL for CRUD with relations, sorting, filtering, pagination.
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,252 | 🐛 563 | 🌐 TypeScript | 📅 2026-06-03 - GraphQL code generator based on schema and documents.
...
* [raphql-inspector](https://github.com/kamilkisiela/graphql-inspector) ⭐ 1,750 | 🐛 135 | 🌐 TypeScript | 📅 2026-04-30: alidate schema, get schema change notifications, validate operations, find breaking changes, look for similar types, schema coverage.
...
* [ts-graphql-plugin](https://github.com/Quramy/ts-graphql-plugin) ⭐ 755 | 🐛 30 | 🌐 TypeScript | 📅 2026-06-09 - A language service plugin complete and validate GraphQL query in TypeScript template strings.
...
* [Typetta](https://github.com/twinlogix/typetta) ⭐ 116 | 🐛 59 | 🌐 TypeScript | 📅 2026-05-28 - Node.js ORM written in TypeScript for type lovers. Typetta is the perfect ORM for the GraphQL + NodeJS + Typescript stack.
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 20,124 | 🐛 1,014 | 🌐 Rust | 📅 2026-06-10
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 16,305 | 🐛 517 | 🌐 Go | 📅 2026-06-10 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 22,963 | 🐛 247 | 🌐 Python | 📅 2026-06-09 - GraphQL-first headless e-commerce platform.
