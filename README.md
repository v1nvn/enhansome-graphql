...
* [graphql-js](https://github.com/graphql/graphql-js) ⭐ 20,333 | 🐛 133 | 🌐 TypeScript | 📅 2026-03-17 - A reference implementation of GraphQL for JavaScript.
...
* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,723 | 🐛 419 | 🌐 TypeScript | 📅 2026-03-17 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
* [aws-amplify](https://github.com/aws-amplify/amplify-js) ⭐ 9,592 | 🐛 476 | 🌐 TypeScript | 📅 2026-03-18 - A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.
...
* [vue-apollo](https://github.com/vuejs/vue-apollo) ⭐ 6,054 | 🐛 277 | 🌐 TypeScript | 📅 2026-03-04 - Apollo/GraphQL integration for VueJS.
...
* [sveltekit-kitql](https://github.com/jycouet/kitql) ⭐ 453 | 🐛 13 | 🌐 TypeScript | 📅 2026-03-18 - A set of tools, helping you building efficient apps in a fast way with SvelteKit and GraphQL.
...
* [relay](https://github.com/facebook/relay) ⭐ 18,936 | 🐛 819 | 🌐 Rust | 📅 2026-03-18 - Relay is a JavaScript framework for building data-driven React applications.
* [urql](https://github.com/FormidableLabs/urql) ⭐ 8,941 | 🐛 37 | 🌐 TypeScript | 📅 2026-02-26 - A simple caching GraphQL client for React.
...
* [apollo-server](https://github.com/apollographql/apollo-server) ⭐ 13,953 | 🐛 80 | 🌐 TypeScript | 📅 2026-03-16 - Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
* [graphql-yoga](https://github.com/prisma-labs/graphql-yoga) ⭐ 8,500 | 🐛 127 | 🌐 TypeScript | 📅 2026-03-18 - Fully-featured GraphQL Server with focus on easy setup, performance and great developer experience.
...
* [pylon](https://github.com/getcronit/pylon) ⭐ 367 | 🐛 27 | 🌐 TypeScript | 📅 2026-03-17 - Write full-feature APIs with just functions. No more boilerplate code, no more setup. Just write functions and deploy.
...
* [join-monster](https://github.com/acarl005/join-monster) ⭐ 2,699 | 🐛 31 | 🌐 JavaScript | 📅 2025-08-06 - A GraphQL-to-SQL query execution layer for batch data fetching.
...
* [graphql-scalars](https://github.com/Urigo/graphql-scalars) ⭐ 1,935 | 🐛 42 | 🌐 TypeScript | 📅 2026-03-18 - A library of custom GraphQL Scalars for creating precise type-safe GraphQL schemas.

#### Type

* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,224 | 🐛 617 | 🌐 TypeScript | 📅 2026-03-17: GraphQL code generator with flexible support for custom plugins and templates like TypeScript (frontend and backend), React Hooks, resolvers signatures and more.
...
* [gql.tada](https://github.com/0no-co/gql.tada) ⭐ 2,922 | 🐛 25 | 🌐 TypeScript | 📅 2025-11-12 - GraphQL document authoring library, inferring the result and variables types of GraphQL queries and fragments in the TypeScript type system.
...
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 94 | 🐛 9 | 🌐 TypeScript | 📅 2026-03-16 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,500 | 🐛 125 | 🌐 TypeScript | 📅 2026-03-17, [Zod](https://github.com/colinhacks/zod) ⭐ 42,152 | 🐛 286 | 🌐 TypeScript | 📅 2026-02-15, or [Yup](https://github.com/jquense/yup) ⭐ 23,694 | 🐛 240 | 🌐 TypeScript | 📅 2026-03-15.
...
* [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,423 | 🐛 153 | 🌐 TypeScript | 📅 2026-03-18 - Tool library for building and maintaining GraphQL-JS servers.
* [graphql-shield](https://github.com/maticzav/graphql-shield) ⭐ 3,574 | 🐛 108 | 🌐 TypeScript | 📅 2026-03-17 - A library that helps creating a permission layer for a graphql api.
* [graphql-mesh](https://github.com/urigo/graphql-mesh) ⭐ 3,490 | 🐛 214 | 🌐 TypeScript | 📅 2026-03-18 - use GraphQL query language to access data in remote APIs that don't run GraphQL (and also ones that do run GraphQL).
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,115 | 🐛 39 | 🌐 Python | 📅 2026-03-16 - Runs arbitrary queries matching a GraphQL schema to find server errors.
* [graphql-tag](https://github.com/apollographql/graphql-tag) ⭐ 2,336 | 🐛 100 | 🌐 TypeScript | 📅 2024-01-25 - A JavaScript template literal tag that parses GraphQL queries.
...
* [graphql-ws](https://github.com/enisdenjo/graphql-ws) ⭐ 1,859 | 🐛 11 | 🌐 TypeScript | 📅 2026-03-17 - Coherent, zero-dependency, lazy, simple, GraphQL over WebSocket Protocol compliant server and client.
...
* [graphql-modules](https://github.com/Urigo/graphql-modules) ⭐ 1,328 | 🐛 51 | 🌐 TypeScript | 📅 2026-03-18 - Separate GraphQL server into smaller, reusable parts by modules or features.
...
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,177 | 🐛 151 | 🌐 TypeScript | 📅 2026-03-17 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
...
* [sofa](https://github.com/Urigo/sofa) ⭐ 1,115 | 🐛 38 | 🌐 TypeScript | 📅 2026-03-18 - Generate REST API from your GraphQL API.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 817 | 🐛 42 | 🌐 Go | 📅 2026-03-17 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
* [graphql-armor](https://github.com/Escape-Technologies/graphql-armor) ⭐ 578 | 🐛 30 | 🌐 TypeScript | 📅 2026-03-17 - An instant security layer for production GraphQL Endpoints.
...
* [supertest-graphql](https://github.com/alexstrat/supertest-graphql) ⭐ 34 | 🐛 12 | 🌐 TypeScript | 📅 2023-01-24 - Extends [supertest](https://github.com/visionmedia/supertest) ⭐ 14,332 | 🐛 181 | 🌐 JavaScript | 📅 2026-02-28 to easily test a GraphQL endpoint
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 138,341 | 🐛 3,470 | 🌐 JavaScript | 📅 2026-03-18 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
...
* [NAPERG](https://github.com/alan345/naperg) ⭐ 1,374 | 🐛 0 | 🌐 TypeScript | 📅 2026-03-17 - Fullstack Boilerplate GraphQL. Made with React & Prisma + authentication & roles.
...
* [Node.js API Starter](https://github.com/kriasoft/nodejs-api-starter) ⭐ 3,977 | 🐛 9 | 🌐 TypeScript | 📅 2024-11-10 - Yarn v2 based monorepo template (code-first GraphQL API, PostgreSQL, PnP, Zero-install, serverless).
...
* [graphql-php](https://github.com/webonyx/graphql-php) ⭐ 4,709 | 🐛 59 | 🌐 PHP | 📅 2026-03-17 - A PHP port of GraphQL reference implementation.
* [wp-graphql](https://github.com/wp-graphql/wp-graphql) ⭐ 3,772 | 🐛 106 | 🌐 PHP | 📅 2026-03-16 - GraphQL API for WordPress.
* [lighthouse](https://github.com/nuwave/lighthouse) ⭐ 3,483 | 🐛 133 | 🌐 PHP | 📅 2026-03-17 - A PHP package that allows to serve a GraphQL endpoint from your Laravel application.
...
* [overblog/graphql-bundle](https://github.com/overblog/GraphQLBundle) ⭐ 797 | 🐛 132 | 🌐 PHP | 📅 2026-03-12 - This bundle provides tools to build a complete GraphQL server in your Symfony App. Supports react-relay.
...
* [strawberry](https://github.com/strawberry-graphql/strawberry) ⭐ 4,631 | 🐛 448 | 🌐 Python | 📅 2026-03-17 - A new GraphQL library for Python.
* [graphene-django](https://github.com/graphql-python/graphene-django) ⭐ 4,384 | 🐛 164 | 🌐 Python | 📅 2026-02-03 - A Django integration for Graphene.
* [Ariadne](https://github.com/mirumee/ariadne) ⭐ 2,326 | 🐛 27 | 🌐 Python | 📅 2026-03-17 - library for implementing GraphQL servers using schema-first approach. Asynchronous query execution, batteries included for ASGI, WSGI and popular webframeworks, [fully documented](https://ariadnegraphql.org).
...
* [graphql-java](https://github.com/graphql-java/graphql-java) ⭐ 6,234 | 🐛 69 | 🌐 Java | 📅 2026-03-18 - GraphQL Java implementation.
...
* [dgs-extended-formatters](https://github.com/setchy/dgs-extended-formatters) ⭐ 6 | 🐛 4 | 🌐 Java | 📅 2026-03-17 - An experimental set of DGS Directives for common formatting use-cases.
...
* [light-java-graphql examples](https://github.com/networknt/light-example-4j/tree/master/graphql) ⭐ 149 | 🐛 12 | 🌐 Java | 📅 2026-03-10 - Examples of Light Java GraphQL and tutorials.
...
* [graphql-kotlin](https://github.com/ExpediaGroup/graphql-kotlin) ⭐ 1,800 | 🐛 90 | 🌐 Kotlin | 📅 2026-03-17 - GraphQL Kotlin implementation.
...
* [cppgraphqlgen](https://github.com/Microsoft/cppgraphqlgen) ⭐ 347 | 🐛 16 | 🌐 C++ | 📅 2025-10-05 - C++ GraphQL schema service generator.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,688 | 🐛 388 | 🌐 Go | 📅 2026-03-17 - Go generate based graphql server library.
...
* [caliban](https://github.com/ghostdogpr/caliban) ⭐ 989 | 🐛 28 | 🌐 Scala | 📅 2026-03-16 - Caliban is a purely functional library for creating GraphQL backends in Scala.
...
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,671 | 🐛 356 | 🌐 C# | 📅 2026-03-17 - GraphQL server for .Net Core and .NET Framework.
...
* [Snowflaqe](https://github.com/Zaid-Ajaj/Snowflaqe) ⭐ 160 | 🐛 22 | 🌐 F# | 📅 2024-10-10 - Type-safe GraphQL code generator for F# and [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,066 | 🐛 234 | 🌐 F# | 📅 2026-03-18
...
* [absinthe-graphql](https://github.com/absinthe-graphql/absinthe) ⭐ 4,398 | 🐛 75 | 🌐 Elixir | 📅 2026-03-17 - Fully Featured Elixir GraphQL Library.
...
* [Hasura](https://github.com/hasura/graphql-engine) ⭐ 31,924 | 🐛 2,376 | 🌐 TypeScript | 📅 2026-03-17 - Hasura gives Instant Realtime GraphQL APIs over PostgreSQL. Works with an existing database too.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,910 | 🐛 156 | 🌐 TypeScript | 📅 2026-03-17 - Lightning-fast GraphQL APIs for PostgreSQL: highly customisable; extensible via plugins; realtime.
...
* [apollo-android](https://github.com/apollographql/apollo-android) ⭐ 3,952 | 🐛 110 | 🌐 Kotlin | 📅 2026-03-17 - 📟 A strongly-typed, caching GraphQL client for Android, written in Java.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,726 | 🐛 108 | 🌐 Java | 📅 2026-03-08 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [juniper](https://github.com/graphql-rust/juniper) ⭐ 5,948 | 🐛 102 | 🌐 Rust | 📅 2026-03-14 - GraphQL server library for Rust.
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 41,905 | 🐛 1,804 | 🌐 JavaScript | 📅 2026-03-16 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
...
* [Altair GraphQL Client](https://github.com/altair-graphql/altair) ⭐ 5,397 | 🐛 54 | 🌐 TypeScript | 📅 2026-03-15 - A beautiful feature-rich GraphQL Client for all platforms.
...
* [graphql-to-karate](https://github.com/wbaldoumas/graphql-to-karate) ⭐ 16 | 🐛 3 | 🌐 C# | 📅 2026-03-17 - **Generate Karate API tests** from your GraphQL schemas
* [mockd](https://github.com/getmockd/mockd) ⭐ 4 | 🐛 0 | 🌐 Go | 📅 2026-03-17 - Multi-protocol mock server with GraphQL schema mocking, resolver configuration, and query validation. Also supports HTTP, gRPC, WebSocket, MQTT, and SOAP.
...
* [GraphQLer](https://github.com/omar2535/GraphQLer) ⭐ 162 | 🐛 15 | 🌐 Python | 📅 2026-03-18 - Dependency-aware dynamic GraphQL testing tool
...
* [Apollo Client Developer Tools](https://github.com/apollographql/apollo-client-devtools) ⭐ 1,524 | 🐛 52 | 🌐 TypeScript | 📅 2026-03-17 - GraphQL debugging tools for Apollo Client in the Chrome developer console
...
* [js-graphql-intellij-plugin](https://github.com/jimkyndemeyer/js-graphql-intellij-plugin/) ⭐ 898 | 🐛 156 | 🌐 Java | 📅 2026-03-17 - GraphQL language support for IntelliJ IDEA and WebStorm, including Relay.QL tagged templates in JavaScript and TypeScript.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 45,551 | 🐛 2,511 | 🌐 TypeScript | 📅 2026-03-17 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.
...
* [amplication](https://github.com/amplication/amplication) ⭐ 16,002 | 🐛 620 | 🌐 TypeScript | 📅 2026-03-13: Amplication is an open‑source low code development tool. It builds database applications with REST API and GraphQL for CRUD with relations, sorting, filtering, pagination.
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,224 | 🐛 617 | 🌐 TypeScript | 📅 2026-03-17 - GraphQL code generator based on schema and documents.
...
* [raphql-inspector](https://github.com/kamilkisiela/graphql-inspector) ⭐ 1,741 | 🐛 132 | 🌐 TypeScript | 📅 2026-03-17: alidate schema, get schema change notifications, validate operations, find breaking changes, look for similar types, schema coverage.
...
* [ts-graphql-plugin](https://github.com/Quramy/ts-graphql-plugin) ⭐ 760 | 🐛 27 | 🌐 TypeScript | 📅 2026-03-17 - A language service plugin complete and validate GraphQL query in TypeScript template strings.
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 19,650 | 🐛 895 | 🌐 Rust | 📅 2026-03-17
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 15,820 | 🐛 580 | 🌐 Go | 📅 2026-03-18 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 22,709 | 🐛 255 | 🌐 Python | 📅 2026-03-18 - GraphQL-first headless e-commerce platform.
