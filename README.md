...
* [GraphQL](https://github.com/graphql/graphql-spec) ⭐ 14,779 | 🐛 208 | 🌐 JavaScript | 📅 2026-02-05 - Working draft of the specification for GraphQL.
...
* [graphql-js](https://github.com/graphql/graphql-js) ⭐ 20,330 | 🐛 164 | 🌐 TypeScript | 📅 2026-02-06 - A reference implementation of GraphQL for JavaScript.
...
* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,725 | 🐛 430 | 🌐 TypeScript | 📅 2026-02-09 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
* [aws-amplify](https://github.com/aws-amplify/amplify-js) ⭐ 9,588 | 🐛 475 | 🌐 TypeScript | 📅 2026-02-09 - A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.
...
* [relay](https://github.com/facebook/relay) ⭐ 18,933 | 🐛 806 | 🌐 Rust | 📅 2026-02-10 - Relay is a JavaScript framework for building data-driven React applications.
...
* [apollo-server](https://github.com/apollographql/apollo-server) ⭐ 13,948 | 🐛 77 | 🌐 TypeScript | 📅 2026-02-09 - Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
...
* [mercurius](https://github.com/mercurius-js/mercurius) ⭐ 2,470 | 🐛 64 | 🌐 JavaScript | 📅 2026-02-09 - GraphQL plugin for Fastify.
...
* [graphql-scalars](https://github.com/Urigo/graphql-scalars) ⭐ 1,937 | 🐛 47 | 🌐 TypeScript | 📅 2026-02-09 - A library of custom GraphQL Scalars for creating precise type-safe GraphQL schemas.

#### Type

* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,216 | 🐛 621 | 🌐 TypeScript | 📅 2026-02-08: GraphQL code generator with flexible support for custom plugins and templates like TypeScript (frontend and backend), React Hooks, resolvers signatures and more.
* [type-graphql](https://github.com/19majkel94/type-graphql) ⭐ 8,094 | 🐛 112 | 🌐 TypeScript | 📅 2026-02-08 - Create GraphQL schema and resolvers with TypeScript, using classes and decorators!
...
* [pothos](https://github.com/hayes/pothos) ⭐ 2,572 | 🐛 62 | 🌐 TypeScript | 📅 2026-02-06 - Pothos is a plugin based GraphQL schema builder for typescript. It makes building graphql schemas in typescript easy, fast and enjoyable.
...
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 85 | 🐛 8 | 🌐 TypeScript | 📅 2026-02-09 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,415 | 🐛 136 | 🌐 TypeScript | 📅 2026-02-05, [Zod](https://github.com/colinhacks/zod) ⭐ 41,781 | 🐛 232 | 🌐 TypeScript | 📅 2026-02-08, or [Yup](https://github.com/jquense/yup) ⭐ 23,688 | 🐛 239 | 🌐 TypeScript | 📅 2026-02-08.
...
* [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,423 | 🐛 159 | 🌐 TypeScript | 📅 2026-02-10 - Tool library for building and maintaining GraphQL-JS servers.
...
* [graphql-mesh](https://github.com/urigo/graphql-mesh) ⭐ 3,483 | 🐛 224 | 🌐 TypeScript | 📅 2026-02-10 - use GraphQL query language to access data in remote APIs that don't run GraphQL (and also ones that do run GraphQL).
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,033 | 🐛 40 | 🌐 Python | 📅 2026-02-10 - Runs arbitrary queries matching a GraphQL schema to find server errors.
...
* [graphql-modules](https://github.com/Urigo/graphql-modules) ⭐ 1,329 | 🐛 53 | 🌐 TypeScript | 📅 2026-02-09 - Separate GraphQL server into smaller, reusable parts by modules or features.
...
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,161 | 🐛 123 | 🌐 TypeScript | 📅 2026-02-09 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
...
* [sofa](https://github.com/Urigo/sofa) ⭐ 1,113 | 🐛 41 | 🌐 TypeScript | 📅 2026-02-09 - Generate REST API from your GraphQL API.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 815 | 🐛 36 | 🌐 Go | 📅 2026-02-09 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
* [graphql-armor](https://github.com/Escape-Technologies/graphql-armor) ⭐ 567 | 🐛 28 | 🌐 TypeScript | 📅 2026-02-10 - An instant security layer for production GraphQL Endpoints.
...
* [supertest-graphql](https://github.com/alexstrat/supertest-graphql) ⭐ 34 | 🐛 12 | 🌐 TypeScript | 📅 2023-01-24 - Extends [supertest](https://github.com/visionmedia/supertest) ⭐ 14,304 | 🐛 178 | 🌐 JavaScript | 📅 2026-01-21 to easily test a GraphQL endpoint
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 137,581 | 🐛 3,292 | 🌐 JavaScript | 📅 2026-02-10 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
...
* [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,432 | 🐛 71 | 🌐 Ruby | 📅 2026-02-09 - Ruby implementation of Facebook's GraphQL.
* [graphql-batch](https://github.com/Shopify/graphql-batch) ⭐ 1,436 | 🐛 15 | 🌐 Ruby | 📅 2026-02-09 - A query batching executor for the graphql gem.
...
* [graphql-php](https://github.com/webonyx/graphql-php) ⭐ 4,709 | 🐛 53 | 🌐 PHP | 📅 2026-02-09 - A PHP port of GraphQL reference implementation.
* [wp-graphql](https://github.com/wp-graphql/wp-graphql) ⭐ 3,771 | 🐛 130 | 🌐 PHP | 📅 2026-02-09 - GraphQL API for WordPress.
* [lighthouse](https://github.com/nuwave/lighthouse) ⭐ 3,480 | 🐛 134 | 🌐 PHP | 📅 2026-02-09 - A PHP package that allows to serve a GraphQL endpoint from your Laravel application.
...
* [strawberry](https://github.com/strawberry-graphql/strawberry) ⭐ 4,608 | 🐛 449 | 🌐 Python | 📅 2026-02-09 - A new GraphQL library for Python.
...
* [Ariadne](https://github.com/mirumee/ariadne) ⭐ 2,318 | 🐛 39 | 🌐 Python | 📅 2026-02-09 - library for implementing GraphQL servers using schema-first approach. Asynchronous query execution, batteries included for ASGI, WSGI and popular webframeworks, [fully documented](https://ariadnegraphql.org).
...
* [graphql-java](https://github.com/graphql-java/graphql-java) ⭐ 6,233 | 🐛 67 | 🌐 Java | 📅 2026-02-09 - GraphQL Java implementation.
* [DGS Framework](https://github.com/Netflix/dgs-framework) ⭐ 3,300 | 🐛 44 | 🌐 Kotlin | 📅 2026-02-09 - A GraphQL server framework for Spring Boot, developed by Netflix.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,703 | 🐛 109 | 🌐 Java | 📅 2026-02-09 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [graphql-java-codegen-maven-plugin](https://github.com/kobylynskyi/graphql-java-codegen-maven-plugin) ⭐ 17 | 🐛 0 | 📅 2020-04-09 - Schema-first maven plugin for generating Java types and Resolver interfaces. Works perfectly in conjunction with graphql-java-tools. Inspired by [swagger-codegen-maven-plugin](https://github.com/swagger-api/swagger-codegen/tree/master/modules/swagger-codegen-maven-plugin) ⭐ 17,698 | 🐛 3,440 | 🌐 Mustache | 📅 2026-02-05.
...
* [graphql-java-extended-scalars](https://github.com/graphql-java/graphql-java-extended-scalars) ⭐ 280 | 🐛 5 | 🌐 Java | 📅 2026-02-09 - Extended scalars for graphql-java.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,660 | 🐛 393 | 🌐 Go | 📅 2026-02-09 - Go generate based graphql server library.
...
* [graphql-go](https://github.com/graph-gophers/graphql-go) ⭐ 4,740 | 🐛 21 | 🌐 Go | 📅 2026-02-04 - GraphQL server with a focus on ease of use.
* [graphjin](https://github.com/dosco/graphjin) ⭐ 3,017 | 🐛 23 | 🌐 Go | 📅 2026-02-09: Build APIs in 5 minutes with GraphQL. An instant GraphQL to SQL compiler.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 815 | 🐛 36 | 🌐 Go | 📅 2026-02-09 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
* [go-graphql-subscription-example](https://github.com/ccamel/go-graphql-subscription-example) ⭐ 46 | 🐛 3 | 🌐 Go | 📅 2026-02-09 - A GraphQL schema and server that demonstrates GraphQL [subscriptions](https://github.com/apollographql/subscriptions-transport-ws/blob/v0.9.4/PROTOCOL.md) ⚠️ Archived (over Websocket) to consume [Apache Kafka](https://kafka.apache.org/) messages.
...
* [graphql-dotnet](https://github.com/graphql-dotnet/graphql-dotnet) ⭐ 5,984 | 🐛 116 | 🌐 C# | 📅 2026-02-10 - GraphQL for .NET.
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,676 | 🐛 483 | 🌐 C# | 📅 2026-02-09 - GraphQL server for .Net Core and .NET Framework.
...
* [Snowflaqe](https://github.com/Zaid-Ajaj/Snowflaqe) ⭐ 161 | 🐛 22 | 🌐 F# | 📅 2024-10-10 - Type-safe GraphQL code generator for F# and [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,060 | 🐛 233 | 🌐 F# | 📅 2026-02-09
...
* [absinthe-graphql](https://github.com/absinthe-graphql/absinthe) ⭐ 4,394 | 🐛 73 | 🌐 Elixir | 📅 2026-02-09 - Fully Featured Elixir GraphQL Library.
...
* [Hasura](https://github.com/hasura/graphql-engine) ⭐ 31,896 | 🐛 2,375 | 🌐 TypeScript | 📅 2026-02-09 - Hasura gives Instant Realtime GraphQL APIs over PostgreSQL. Works with an existing database too.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,903 | 🐛 142 | 🌐 TypeScript | 📅 2026-02-09 - Lightning-fast GraphQL APIs for PostgreSQL: highly customisable; extensible via plugins; realtime.
...
* [apollo-android](https://github.com/apollographql/apollo-android) ⭐ 3,946 | 🐛 113 | 🌐 Kotlin | 📅 2026-02-08 - 📟 A strongly-typed, caching GraphQL client for Android, written in Java.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,703 | 🐛 109 | 🌐 Java | 📅 2026-02-09 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [graphql-flutter](https://github.com/zino-app/graphql-flutter) ⭐ 3,273 | 🐛 164 | 🌐 Dart | 📅 2026-01-13 - A GraphQL client for Flutter.
...
* [juniper](https://github.com/graphql-rust/juniper) ⭐ 5,941 | 🐛 103 | 🌐 Rust | 📅 2026-02-09 - GraphQL server library for Rust.
* [async-graphql](https://github.com/async-graphql/async-graphql) ⭐ 3,625 | 🐛 239 | 🌐 Rust | 📅 2026-02-06 - High-performance server-side library that supports all GraphQL specifications.
...
* [graphql-client](https://github.com/tomhoule/graphql-client) ⭐ 1,245 | 🐛 113 | 🌐 Rust | 📅 2026-02-09 - GraphQL client library for Rust with WebAssembly (wasm) support.
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 40,764 | 🐛 1,703 | 🌐 JavaScript | 📅 2026-02-09 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,790 | 🐛 403 | 🌐 TypeScript | 📅 2026-02-07 - An in-browser IDE for exploring GraphQL.
...
* [GraphQL Editor](https://github.com/graphql-editor/graphql-editor) ⭐ 6,072 | 🐛 20 | 🌐 TypeScript | 📅 2025-09-10 - Visual Editor & GraphQL IDE.
* [Altair GraphQL Client](https://github.com/altair-graphql/altair) ⭐ 5,393 | 🐛 63 | 🌐 TypeScript | 📅 2026-02-09 - A beautiful feature-rich GraphQL Client for all platforms.
...
* [InQL Scanner](https://github.com/doyensec/inql) ⭐ 1,727 | 🐛 33 | 🌐 Kotlin | 📅 2026-02-05 - A Burp Extension for GraphQL Security Testing
* [GraphQL Cop](https://github.com/dolevf/graphql-cop) ⭐ 599 | 🐛 1 | 🌐 Python | 📅 2025-11-20 - Security Audit Utility for GraphQL
...
* [GraphQLer](https://github.com/omar2535/GraphQLer) ⭐ 157 | 🐛 17 | 🌐 Python | 📅 2026-02-04 - Dependency-aware dynamic GraphQL testing tool
...
* [spectaql](https://github.com/anvilco/spectaql) ⭐ 1,219 | 🐛 87 | 🌐 JavaScript | 📅 2026-01-22 - Autogenerate static GraphQL API documentation.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 45,256 | 🐛 2,473 | 🌐 TypeScript | 📅 2026-02-09 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.
* [Bit](https://github.com/teambit/bit) ⭐ 18,350 | 🐛 64 | 🌐 TypeScript | 📅 2026-02-09 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).
...
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,216 | 🐛 621 | 🌐 TypeScript | 📅 2026-02-08 - GraphQL code generator based on schema and documents.
...
* [raphql-inspector](https://github.com/kamilkisiela/graphql-inspector) ⭐ 1,736 | 🐛 133 | 🌐 TypeScript | 📅 2026-02-09: alidate schema, get schema change notifications, validate operations, find breaking changes, look for similar types, schema coverage.
...
* [ts-graphql-plugin](https://github.com/Quramy/ts-graphql-plugin) ⭐ 757 | 🐛 31 | 🌐 TypeScript | 📅 2026-02-09 - A language service plugin complete and validate GraphQL query in TypeScript template strings.
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 19,440 | 🐛 882 | 🌐 Rust | 📅 2026-02-10
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 15,558 | 🐛 583 | 🌐 Go | 📅 2026-02-09 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 22,588 | 🐛 246 | 🌐 Python | 📅 2026-02-09 - GraphQL-first headless e-commerce platform.
