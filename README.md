...
* [GraphQL](https://github.com/graphql/graphql-spec) ⭐ 14,750 | 🐛 193 | 🌐 JavaScript | 📅 2026-03-23 - Working draft of the specification for GraphQL.
* [GraphQL over HTTP](https://github.com/graphql/graphql-over-http) ⭐ 420 | 🐛 34 | 🌐 JavaScript | 📅 2026-03-29 - Working draft of "GraphQL over HTTP" specification.
...
* [graphql-js](https://github.com/graphql/graphql-js) ⭐ 20,329 | 🐛 130 | 🌐 TypeScript | 📅 2026-03-30 - A reference implementation of GraphQL for JavaScript.
...
* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,717 | 🐛 419 | 🌐 TypeScript | 📅 2026-03-28 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
* [aws-amplify](https://github.com/aws-amplify/amplify-js) ⭐ 9,593 | 🐛 476 | 🌐 TypeScript | 📅 2026-03-27 - A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.
* [graphql-request](https://github.com/prisma-labs/graphql-request) ⭐ 6,117 | 🐛 52 | 🌐 TypeScript | 📅 2026-03-20 - A minimal GraphQL client for Node and browsers.
...
* [gqty](https://github.com/gqty-dev/gqty) ⭐ 1,032 | 🐛 50 | 🌐 TypeScript | 📅 2026-03-27 - A No GraphQL client for TypeScript
...
* [vue-apollo](https://github.com/vuejs/vue-apollo) ⭐ 6,048 | 🐛 277 | 🌐 TypeScript | 📅 2026-03-04 - Apollo/GraphQL integration for VueJS.
...
* [sveltekit-kitql](https://github.com/jycouet/kitql) ⭐ 453 | 🐛 7 | 🌐 TypeScript | 📅 2026-03-28 - A set of tools, helping you building efficient apps in a fast way with SvelteKit and GraphQL.
* [apollo-elements](https://github.com/apollo-elements/apollo-elements) ⭐ 421 | 🐛 7 | 🌐 TypeScript | 📅 2026-03-27 - GraphQL web components that work in any frontend framework.
...
* [relay](https://github.com/facebook/relay) ⭐ 18,932 | 🐛 829 | 🌐 Rust | 📅 2026-03-29 - Relay is a JavaScript framework for building data-driven React applications.
* [urql](https://github.com/FormidableLabs/urql) ⭐ 8,948 | 🐛 37 | 🌐 TypeScript | 📅 2026-02-26 - A simple caching GraphQL client for React.
...
* [@gqty/react](https://github.com/gqty-dev/gqty) ⭐ 1,032 | 🐛 50 | 🌐 TypeScript | 📅 2026-03-27 - A No GraphQL client for TypeScript
...
* [apollo-server](https://github.com/apollographql/apollo-server) ⭐ 13,943 | 🐛 80 | 🌐 TypeScript | 📅 2026-03-28 - Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
* [graphql-yoga](https://github.com/prisma-labs/graphql-yoga) ⭐ 8,506 | 🐛 133 | 🌐 TypeScript | 📅 2026-03-27 - Fully-featured GraphQL Server with focus on easy setup, performance and great developer experience.
* [mercurius](https://github.com/mercurius-js/mercurius) ⭐ 2,478 | 🐛 69 | 🌐 JavaScript | 📅 2026-03-23 - GraphQL plugin for Fastify.
...
* [pylon](https://github.com/getcronit/pylon) ⭐ 369 | 🐛 27 | 🌐 TypeScript | 📅 2026-03-28 - Write full-feature APIs with just functions. No more boilerplate code, no more setup. Just write functions and deploy.
* [gql](https://github.com/deno-libs/gql) ⭐ 202 | 🐛 0 | 🌐 TypeScript | 📅 2026-01-20 - Universal GraphQL HTTP middleware for Deno.
* [graphitejs](https://github.com/graphitejs/server) ⭐ 122 | 🐛 16 | 🌐 JavaScript | 📅 2026-03-27 - Framework NodeJS for GraphQL.
...
* [graphql-sequelize](https://github.com/mickhansen/graphql-sequelize) ⭐ 1,889 | 🐛 1 | 🌐 JavaScript | 📅 2022-11-16 - Sequelize helpers for GraphQL.
...
* [graphql-scalars](https://github.com/Urigo/graphql-scalars) ⭐ 1,935 | 🐛 43 | 🌐 TypeScript | 📅 2026-03-27 - A library of custom GraphQL Scalars for creating precise type-safe GraphQL schemas.

#### Type

* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,230 | 🐛 602 | 🌐 TypeScript | 📅 2026-03-27: GraphQL code generator with flexible support for custom plugins and templates like TypeScript (frontend and backend), React Hooks, resolvers signatures and more.
* [type-graphql](https://github.com/19majkel94/type-graphql) ⭐ 8,093 | 🐛 113 | 🌐 TypeScript | 📅 2026-03-23 - Create GraphQL schema and resolvers with TypeScript, using classes and decorators!
...
* [gql.tada](https://github.com/0no-co/gql.tada) ⭐ 2,921 | 🐛 24 | 🌐 TypeScript | 📅 2026-03-24 - GraphQL document authoring library, inferring the result and variables types of GraphQL queries and fragments in the TypeScript type system.
...
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 94 | 🐛 9 | 🌐 TypeScript | 📅 2026-03-30 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,524 | 🐛 115 | 🌐 TypeScript | 📅 2026-03-30, [Zod](https://github.com/colinhacks/zod) ⭐ 42,242 | 🐛 299 | 🌐 TypeScript | 📅 2026-02-15, or [Yup](https://github.com/jquense/yup) ⭐ 23,688 | 🐛 240 | 🌐 TypeScript | 📅 2026-03-27.
...
* [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,422 | 🐛 159 | 🌐 TypeScript | 📅 2026-03-30 - Tool library for building and maintaining GraphQL-JS servers.
* [graphql-shield](https://github.com/maticzav/graphql-shield) ⭐ 3,574 | 🐛 107 | 🌐 TypeScript | 📅 2026-03-27 - A library that helps creating a permission layer for a graphql api.
* [graphql-mesh](https://github.com/urigo/graphql-mesh) ⭐ 3,497 | 🐛 220 | 🌐 TypeScript | 📅 2026-03-28 - use GraphQL query language to access data in remote APIs that don't run GraphQL (and also ones that do run GraphQL).
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,168 | 🐛 29 | 🌐 Python | 📅 2026-03-29 - Runs arbitrary queries matching a GraphQL schema to find server errors.
* [graphql-tag](https://github.com/apollographql/graphql-tag) ⭐ 2,333 | 🐛 100 | 🌐 TypeScript | 📅 2024-01-25 - A JavaScript template literal tag that parses GraphQL queries.
* [graphql-cli](https://github.com/urigo/graphql-cli) ⭐ 2,020 | 🐛 48 | 🌐 TypeScript | 📅 2026-03-27 - A command line tool for common GraphQL development workflows.
* [graphql-ws](https://github.com/enisdenjo/graphql-ws) ⭐ 1,859 | 🐛 11 | 🌐 TypeScript | 📅 2026-03-26 - Coherent, zero-dependency, lazy, simple, GraphQL over WebSocket Protocol compliant server and client.
...
* [graphql-modules](https://github.com/Urigo/graphql-modules) ⭐ 1,327 | 🐛 52 | 🌐 TypeScript | 📅 2026-03-26 - Separate GraphQL server into smaller, reusable parts by modules or features.
* [eslint-plugin-graphql](https://github.com/apollographql/eslint-plugin-graphql) ⭐ 1,216 | 🐛 100 | 🌐 JavaScript | 📅 2026-03-27 - An ESLint plugin that checks your GraphQL strings against a schema.
...
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,189 | 🐛 155 | 🌐 TypeScript | 📅 2026-03-29 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
* [graphql-middleware](https://github.com/maticzav/graphql-middleware) ⭐ 1,149 | 🐛 42 | 🌐 TypeScript | 📅 2026-03-27 - Split up your GraphQL resolvers in middleware functions.
* [sofa](https://github.com/Urigo/sofa) ⭐ 1,115 | 🐛 38 | 🌐 TypeScript | 📅 2026-03-27 - Generate REST API from your GraphQL API.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 818 | 🐛 44 | 🌐 Go | 📅 2026-03-27 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
* [graphql-armor](https://github.com/Escape-Technologies/graphql-armor) ⭐ 581 | 🐛 32 | 🌐 TypeScript | 📅 2026-03-29 - An instant security layer for production GraphQL Endpoints.
* [GraphQL Constraint Directive](https://github.com/confuser/graphql-constraint-directive) ⭐ 577 | 🐛 43 | 🌐 JavaScript | 📅 2026-03-27 - Allows using @constraint as a directive to validate input data. Inspired by Constraints Directives RFC and OpenAPI
* [graphql-let](https://github.com/piglovesyou/graphql-let) ⭐ 452 | 🐛 64 | 🌐 TypeScript | 📅 2026-03-27 - A webpack loader to import type-protected codegen results directly from GraphQL documents
* [graphql-live-query](https://github.com/n1ru4l/graphql-live-query) ⭐ 440 | 🐛 52 | 🌐 TypeScript | 📅 2026-03-27 - Realtime GraphQL Live Queries with JavaScript.
...
* [supertest-graphql](https://github.com/alexstrat/supertest-graphql) ⭐ 34 | 🐛 12 | 🌐 TypeScript | 📅 2023-01-24 - Extends [supertest](https://github.com/visionmedia/supertest) ⭐ 14,335 | 🐛 184 | 🌐 JavaScript | 📅 2026-03-25 to easily test a GraphQL endpoint
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 138,526 | 🐛 3,626 | 🌐 JavaScript | 📅 2026-03-30 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
...
* [NAPERG](https://github.com/alan345/naperg) ⭐ 1,382 | 🐛 0 | 🌐 TypeScript | 📅 2026-03-27 - Fullstack Boilerplate GraphQL. Made with React & Prisma + authentication & roles.
...
* [Relay TodoMVC](https://github.com/taion/relay-todomvc) ⭐ 158 | 🐛 39 | 🌐 JavaScript | 📅 2026-03-27 - Relay TodoMVC with routing.
...
* [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,429 | 🐛 77 | 🌐 Ruby | 📅 2026-03-28 - Ruby implementation of Facebook's GraphQL.
* [graphql-batch](https://github.com/Shopify/graphql-batch) ⭐ 1,436 | 🐛 17 | 🌐 Ruby | 📅 2026-03-23 - A query batching executor for the graphql gem.
...
* [graphql-php](https://github.com/webonyx/graphql-php) ⭐ 4,706 | 🐛 56 | 🌐 PHP | 📅 2026-03-29 - A PHP port of GraphQL reference implementation.
* [wp-graphql](https://github.com/wp-graphql/wp-graphql) ⭐ 3,776 | 🐛 111 | 🌐 PHP | 📅 2026-03-30 - GraphQL API for WordPress.
* [lighthouse](https://github.com/nuwave/lighthouse) ⭐ 3,481 | 🐛 136 | 🌐 PHP | 📅 2026-03-29 - A PHP package that allows to serve a GraphQL endpoint from your Laravel application.
* [graphql-laravel](https://github.com/rebing/graphql-laravel) ⭐ 2,212 | 🐛 3 | 🌐 PHP | 📅 2026-03-29 - Laravel wrapper for Facebook's GraphQL.
...
* [strawberry](https://github.com/strawberry-graphql/strawberry) ⭐ 4,632 | 🐛 453 | 🌐 Python | 📅 2026-03-29 - A new GraphQL library for Python.
...
* [Ariadne](https://github.com/mirumee/ariadne) ⭐ 2,331 | 🐛 28 | 🌐 Python | 📅 2026-03-27 - library for implementing GraphQL servers using schema-first approach. Asynchronous query execution, batteries included for ASGI, WSGI and popular webframeworks, [fully documented](https://ariadnegraphql.org).
...
* [sgqlc](https://github.com/profusion/sgqlc) ⭐ 551 | 🐛 38 | 🌐 Python | 📅 2026-03-27 - Simple GraphQL Client makes working with GraphQL API responses easier in Python.
...
* [graphql-java](https://github.com/graphql-java/graphql-java) ⭐ 6,232 | 🐛 53 | 🌐 Java | 📅 2026-03-29 - GraphQL Java implementation.
...
* [graphql-java-servlet](https://github.com/graphql-java-kickstart/graphql-java-servlet) ⭐ 225 | 🐛 23 | 🌐 Java | 📅 2026-03-24 - A framework-agnostic java servlet for exposing graphql-java query endpoints with GET, POST, and multipart uploads.
...
* [graphql-java-codegen-maven-plugin](https://github.com/kobylynskyi/graphql-java-codegen-maven-plugin) ⭐ 17 | 🐛 0 | 📅 2020-04-09 - Schema-first maven plugin for generating Java types and Resolver interfaces. Works perfectly in conjunction with graphql-java-tools. Inspired by [swagger-codegen-maven-plugin](https://github.com/swagger-api/swagger-codegen/tree/master/modules/swagger-codegen-maven-plugin) ⭐ 17,722 | 🐛 3,445 | 🌐 Mustache | 📅 2026-03-14.
* [dgs-extended-formatters](https://github.com/setchy/dgs-extended-formatters) ⭐ 6 | 🐛 4 | 🌐 Java | 📅 2026-03-26 - An experimental set of DGS Directives for common formatting use-cases.
...
* [graphql-java-datetime](https://github.com/donbeave/graphql-java-datetime) ⭐ 153 | 🐛 5 | 🌐 Java | 📅 2026-03-26 - GraphQL ISO Date is a set of RFC 3339 compliant date/time scalar types to be used with graphql-java.

<a name="java-example" />

#### Java Examples

* [light-java-graphql examples](https://github.com/networknt/light-example-4j/tree/master/graphql) ⭐ 149 | 🐛 14 | 🌐 Java | 📅 2026-03-26 - Examples of Light Java GraphQL and tutorials.
* [graphql-java-kickstart\_samples](https://github.com/graphql-java-kickstart/samples) ⭐ 120 | 🐛 16 | 🌐 Java | 📅 2026-03-26 - Samples for using the GraphQL Java Kickstart projects.
...
* [graphql-kotlin](https://github.com/ExpediaGroup/graphql-kotlin) ⭐ 1,799 | 🐛 92 | 🌐 Kotlin | 📅 2026-03-19 - GraphQL Kotlin implementation.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,696 | 🐛 389 | 🌐 Go | 📅 2026-03-29 - Go generate based graphql server library.
...
* [graphql-go](https://github.com/graph-gophers/graphql-go) ⭐ 4,747 | 🐛 13 | 🌐 Go | 📅 2026-03-29 - GraphQL server with a focus on ease of use.
* [graphjin](https://github.com/dosco/graphjin) ⭐ 3,035 | 🐛 17 | 🌐 Go | 📅 2026-03-30: Build APIs in 5 minutes with GraphQL. An instant GraphQL to SQL compiler.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 818 | 🐛 44 | 🌐 Go | 📅 2026-03-27 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
* [grpc-graphql-gateway](https://github.com/ysugimoto/grpc-graphql-gateway) ⭐ 423 | 🐛 16 | 🌐 Go | 📅 2025-06-04 - A protoc plugin that generates graphql execution code from Protocol Buffers.
  <a name="go-example" />
* [Thunder](https://github.com/Raezil/Thunder) ⭐ 118 | 🐛 7 | 🌐 Go | 📅 2025-12-05 - A scalable microservices framework powered by Go, gRPC-Gateway, Prisma, and Kubernetes. It exposes REST, gRPC and Graphql
...
* [sangria](https://github.com/sangria-graphql/sangria) ⭐ 1,963 | 🐛 62 | 🌐 Scala | 📅 2026-03-28 - Scala GraphQL server implementation.
* [caliban](https://github.com/ghostdogpr/caliban) ⭐ 990 | 🐛 28 | 🌐 Scala | 📅 2026-03-29 - Caliban is a purely functional library for creating GraphQL backends in Scala.
* [sangria-relay](https://github.com/sangria-graphql/sangria-relay) ⭐ 90 | 🐛 12 | 🌐 Scala | 📅 2026-03-14 - Sangria Relay Support.
...
* [graphql-dotnet](https://github.com/graphql-dotnet/graphql-dotnet) ⭐ 5,982 | 🐛 115 | 🌐 C# | 📅 2026-03-27 - GraphQL for .NET.
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,679 | 🐛 362 | 🌐 C# | 📅 2026-03-30 - GraphQL server for .Net Core and .NET Framework.
* [graphql-net](https://github.com/ckimes89/graphql-net) ⭐ 887 | 🐛 43 | 🌐 C# | 📅 2022-06-22 - GraphQL to IQueryable for .NET.
* [EntityGraphQL](https://github.com/EntityGraphQL/EntityGraphQL) ⭐ 452 | 🐛 19 | 🌐 C# | 📅 2026-03-29 - library to build a GraphQL API on top of data model with the extensibility to bring multiple data sources together in the single GraphQL schema.
* [ZeroQL](https://github.com/byme8/ZeroQL) ⭐ 318 | 🐛 11 | 🌐 C# | 📅 2025-12-28 - type-safe GraphQL client with Linq-like interface for C#
* [Snowflaqe](https://github.com/Zaid-Ajaj/Snowflaqe) ⭐ 160 | 🐛 22 | 🌐 F# | 📅 2024-10-10 - Type-safe GraphQL code generator for F# and [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,068 | 🐛 223 | 🌐 F# | 📅 2026-03-30
...
* [absinthe-graphql](https://github.com/absinthe-graphql/absinthe) ⭐ 4,403 | 🐛 76 | 🌐 Elixir | 📅 2026-03-17 - Fully Featured Elixir GraphQL Library.
...
* [Hasura](https://github.com/hasura/graphql-engine) ⭐ 31,925 | 🐛 2,375 | 🌐 TypeScript | 📅 2026-03-27 - Hasura gives Instant Realtime GraphQL APIs over PostgreSQL. Works with an existing database too.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,916 | 🐛 149 | 🌐 TypeScript | 📅 2026-03-29 - Lightning-fast GraphQL APIs for PostgreSQL: highly customisable; extensible via plugins; realtime.
* [GraphpostgresQL](https://github.com/solidsnack/GraphpostgresQL) ⭐ 1,087 | 🐛 2 | 🌐 PLpgSQL | 📅 2017-03-30 - GraphQL for Postgres.
...
* [apollo-android](https://github.com/apollographql/apollo-android) ⭐ 3,949 | 🐛 114 | 🌐 Kotlin | 📅 2026-03-27 - 📟 A strongly-typed, caching GraphQL client for Android, written in Java.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,726 | 🐛 108 | 🌐 Java | 📅 2026-03-08 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [apollo-ios](https://github.com/apollographql/apollo-ios) ⭐ 4,035 | 🐛 95 | 🌐 Swift | 📅 2026-03-27 - 📱 A strongly-typed, caching GraphQL client for iOS, written in Swift.
...
* [async-graphql](https://github.com/async-graphql/async-graphql) ⭐ 3,642 | 🐛 237 | 🌐 Rust | 📅 2026-03-27 - High-performance server-side library that supports all GraphQL specifications.
* [tailcall](https://github.com/tailcallhq/tailcall) ⭐ 1,434 | 🐛 14 | 🌐 Rust | 📅 2026-03-27 - A platform for building high-performance GraphQL backends.
...
* [graphql-crystal](https://github.com/ziprandom/graphql-crystal) ⭐ 213 | 🐛 9 | 🌐 Crystal | 📅 2020-07-01 - library inspired by [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,429 | 🐛 77 | 🌐 Ruby | 📅 2026-03-28 & [go-graphql](https://github.com/playlyfe/go-graphql) ⭐ 246 | 🐛 18 | 🌐 Go | 📅 2020-01-22 & [graphql-parser](https://github.com/graphql-dotnet/parser) ⭐ 220 | 🐛 8 | 🌐 C# | 📅 2026-03-27.
...
* [graphql](https://github.com/ballerina-platform/module-ballerina-graphql) ⭐ 138 | 🐛 2 | 🌐 Ballerina | 📅 2026-02-25 - Ballerina standard library for GraphQL. This library provides a GraphQL client and server implementations including builtin support for GraphQL subscriptions.
...
* [Ballerina GraphQL Examples](https://github.com/ballerina-platform/module-ballerina-graphql/tree/master/examples) ⭐ 138 | 🐛 2 | 🌐 Ballerina | 📅 2026-02-25
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 42,373 | 🐛 1,706 | 🌐 JavaScript | 📅 2026-03-28 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,816 | 🐛 413 | 🌐 TypeScript | 📅 2026-03-05 - An in-browser IDE for exploring GraphQL.
* [GraphQL Voyager](https://github.com/APIs-guru/graphql-voyager) ⭐ 8,097 | 🐛 105 | 🌐 TypeScript | 📅 2026-02-22 - Represent any GraphQL API as an interactive graph.
* [GraphQL Editor](https://github.com/graphql-editor/graphql-editor) ⭐ 6,072 | 🐛 20 | 🌐 TypeScript | 📅 2025-09-10 - Visual Editor & GraphQL IDE.
* [Altair GraphQL Client](https://github.com/altair-graphql/altair) ⭐ 5,398 | 🐛 64 | 🌐 TypeScript | 📅 2026-03-29 - A beautiful feature-rich GraphQL Client for all platforms.
...
* [GraphQL Faker](https://github.com/APIs-guru/graphql-faker) ⭐ 2,710 | 🐛 79 | 🌐 TypeScript | 📅 2023-11-24 - 🎲 Mock or extend your GraphQL API with faked data. No coding required.
* [mockd](https://github.com/getmockd/mockd) ⭐ 90 | 🐛 0 | 🌐 Go | 📅 2026-03-28 - Multi-protocol mock server with GraphQL schema mocking, resolver configuration, and query validation. Also supports HTTP, gRPC, WebSocket, MQTT, and SOAP.
* [graphql-to-karate](https://github.com/wbaldoumas/graphql-to-karate) ⭐ 16 | 🐛 3 | 🌐 C# | 📅 2026-03-28 - **Generate Karate API tests** from your GraphQL schemas
...
* [InQL Scanner](https://github.com/doyensec/inql) ⭐ 1,747 | 🐛 35 | 🌐 Kotlin | 📅 2026-02-16 - A Burp Extension for GraphQL Security Testing
* [GraphQL Cop](https://github.com/dolevf/graphql-cop) ⭐ 632 | 🐛 1 | 🌐 Python | 📅 2025-11-20 - Security Audit Utility for GraphQL
...
* [GraphQLer](https://github.com/omar2535/GraphQLer) ⭐ 162 | 🐛 11 | 🌐 Python | 📅 2026-03-28 - Dependency-aware dynamic GraphQL testing tool
...
* [Apollo Client Developer Tools](https://github.com/apollographql/apollo-client-devtools) ⭐ 1,524 | 🐛 53 | 🌐 TypeScript | 📅 2026-03-28 - GraphQL debugging tools for Apollo Client in the Chrome developer console
...
* [spectaql](https://github.com/anvilco/spectaql) ⭐ 1,224 | 🐛 87 | 🌐 JavaScript | 📅 2026-03-27 - Autogenerate static GraphQL API documentation.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 45,608 | 🐛 2,541 | 🌐 TypeScript | 📅 2026-03-27 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.
* [Bit](https://github.com/teambit/bit) ⭐ 18,368 | 🐛 67 | 🌐 TypeScript | 📅 2026-03-27 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).
* [amplication](https://github.com/amplication/amplication) ⭐ 15,999 | 🐛 594 | 🌐 TypeScript | 📅 2026-03-13: Amplication is an open‑source low code development tool. It builds database applications with REST API and GraphQL for CRUD with relations, sorting, filtering, pagination.
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,230 | 🐛 602 | 🌐 TypeScript | 📅 2026-03-27 - GraphQL code generator based on schema and documents.
...
* [raphql-inspector](https://github.com/kamilkisiela/graphql-inspector) ⭐ 1,740 | 🐛 136 | 🌐 TypeScript | 📅 2026-03-28: alidate schema, get schema change notifications, validate operations, find breaking changes, look for similar types, schema coverage.
...
* [ts-graphql-plugin](https://github.com/Quramy/ts-graphql-plugin) ⭐ 760 | 🐛 25 | 🌐 TypeScript | 📅 2026-03-29 - A language service plugin complete and validate GraphQL query in TypeScript template strings.
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 19,730 | 🐛 908 | 🌐 Rust | 📅 2026-03-30
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 15,920 | 🐛 562 | 🌐 Go | 📅 2026-03-30 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 22,749 | 🐛 247 | 🌐 Python | 📅 2026-03-27 - GraphQL-first headless e-commerce platform.
