...
* [GraphQL](https://github.com/graphql/graphql-spec) ⭐ 14,566 | 🐛 196 | 🌐 JavaScript | 📅 2026-05-25 - Working draft of the specification for GraphQL.
* [GraphQL over HTTP](https://github.com/graphql/graphql-over-http) ⭐ 423 | 🐛 31 | 🌐 JavaScript | 📅 2026-05-28 - Working draft of "GraphQL over HTTP" specification.
...
* [GraphQL APIs](https://github.com/APIs-guru/graphql-apis) ⭐ 4,675 | 🐛 1 | 📅 2024-09-26 - A collective list of public GraphQL APIs.
...
* [graphql-js](https://github.com/graphql/graphql-js) ⭐ 20,314 | 🐛 134 | 🌐 TypeScript | 📅 2026-06-02 - A reference implementation of GraphQL for JavaScript.
...
* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,716 | 🐛 414 | 🌐 TypeScript | 📅 2026-06-02 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
* [aws-amplify](https://github.com/aws-amplify/amplify-js) ⭐ 9,574 | 🐛 493 | 🌐 TypeScript | 📅 2026-05-28 - A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.
...
* [graphqurl](https://github.com/hasura/graphqurl) ⭐ 3,383 | 🐛 44 | 🌐 JavaScript | 📅 2025-02-13 - curl for GraphQL with autocomplete, subscriptions and GraphiQL. Also a dead-simple universal javascript GraphQL client.
...
* [gqty](https://github.com/gqty-dev/gqty) ⭐ 1,034 | 🐛 56 | 🌐 TypeScript | 📅 2026-06-02 - A No GraphQL client for TypeScript
...
* [vue-apollo](https://github.com/vuejs/vue-apollo) ⭐ 6,040 | 🐛 278 | 🌐 TypeScript | 📅 2026-05-13 - Apollo/GraphQL integration for VueJS.
* [apollo-angular](https://github.com/kamilkisiela/apollo-angular) ⭐ 1,516 | 🐛 21 | 🌐 TypeScript | 📅 2026-05-22 - A fully-featured, production ready caching GraphQL client for Angular and every GraphQL server.
* [svelte-apollo](https://github.com/timhall/svelte-apollo) ⭐ 948 | 🐛 33 | 🌐 TypeScript | 📅 2023-08-03 - Svelte integration for Apollo GraphQL.
* [sveltekit-kitql](https://github.com/jycouet/kitql) ⭐ 455 | 🐛 12 | 🌐 TypeScript | 📅 2026-06-02 - A set of tools, helping you building efficient apps in a fast way with SvelteKit and GraphQL.
...
* [relay](https://github.com/facebook/relay) ⭐ 18,946 | 🐛 838 | 🌐 Rust | 📅 2026-06-02 - Relay is a JavaScript framework for building data-driven React applications.
* [urql](https://github.com/FormidableLabs/urql) ⭐ 8,949 | 🐛 39 | 🌐 TypeScript | 📅 2026-06-01 - A simple caching GraphQL client for React.
...
* [@gqty/react](https://github.com/gqty-dev/gqty) ⭐ 1,034 | 🐛 56 | 🌐 TypeScript | 📅 2026-06-02 - A No GraphQL client for TypeScript
...
* [apollo-server](https://github.com/apollographql/apollo-server) ⭐ 13,939 | 🐛 82 | 🌐 TypeScript | 📅 2026-06-02 - Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
* [graphql-yoga](https://github.com/prisma-labs/graphql-yoga) ⭐ 8,522 | 🐛 137 | 🌐 TypeScript | 📅 2026-05-28 - Fully-featured GraphQL Server with focus on easy setup, performance and great developer experience.
* [mercurius](https://github.com/mercurius-js/mercurius) ⭐ 2,480 | 🐛 64 | 🌐 JavaScript | 📅 2026-05-28 - GraphQL plugin for Fastify.
...
* [pylon](https://github.com/getcronit/pylon) ⭐ 370 | 🐛 27 | 🌐 TypeScript | 📅 2026-05-18 - Write full-feature APIs with just functions. No more boilerplate code, no more setup. Just write functions and deploy.
...
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,251 | 🐛 563 | 🌐 TypeScript | 📅 2026-06-01: GraphQL code generator with flexible support for custom plugins and templates like TypeScript (frontend and backend), React Hooks, resolvers signatures and more.
* [type-graphql](https://github.com/19majkel94/type-graphql) ⭐ 8,087 | 🐛 116 | 🌐 TypeScript | 📅 2026-05-11 - Create GraphQL schema and resolvers with TypeScript, using classes and decorators!
* [graphql-nexus](https://github.com/graphql-nexus/nexus) ⭐ 3,435 | 🐛 254 | 🌐 TypeScript | 📅 2023-11-19 - Code-First, Type-Safe, GraphQL Schema Construction.
* [gql.tada](https://github.com/0no-co/gql.tada) ⭐ 2,935 | 🐛 29 | 🌐 TypeScript | 📅 2026-06-01 - GraphQL document authoring library, inferring the result and variables types of GraphQL queries and fragments in the TypeScript type system.
* [pothos](https://github.com/hayes/pothos) ⭐ 2,593 | 🐛 65 | 🌐 TypeScript | 📅 2026-05-21 - Pothos is a plugin based GraphQL schema builder for typescript. It makes building graphql schemas in typescript easy, fast and enjoyable.
* [garph](https://github.com/stepci/garph) ⭐ 1,315 | 🐛 27 | 🌐 TypeScript | 📅 2024-03-01 - Garph is full-stack framework for building type-safe GraphQL APIs in TypeScript.
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 98 | 🐛 7 | 🌐 TypeScript | 📅 2026-06-01 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,735 | 🐛 122 | 🌐 TypeScript | 📅 2026-05-31, [Zod](https://github.com/colinhacks/zod) ⭐ 42,836 | 🐛 167 | 🌐 TypeScript | 📅 2026-05-31, or [Yup](https://github.com/jquense/yup) ⭐ 23,678 | 🐛 240 | 🌐 TypeScript | 📅 2026-06-01.
...
* [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,426 | 🐛 158 | 🌐 TypeScript | 📅 2026-06-01 - Tool library for building and maintaining GraphQL-JS servers.
...
* [graphql-mesh](https://github.com/urigo/graphql-mesh) ⭐ 3,504 | 🐛 227 | 🌐 TypeScript | 📅 2026-06-01 - use GraphQL query language to access data in remote APIs that don't run GraphQL (and also ones that do run GraphQL).
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,333 | 🐛 17 | 🌐 Python | 📅 2026-05-31 - Runs arbitrary queries matching a GraphQL schema to find server errors.
...
* [graphql-cli](https://github.com/urigo/graphql-cli) ⭐ 2,022 | 🐛 48 | 🌐 TypeScript | 📅 2026-06-02 - A command line tool for common GraphQL development workflows.
* [graphql-ws](https://github.com/enisdenjo/graphql-ws) ⭐ 1,863 | 🐛 11 | 🌐 TypeScript | 📅 2026-03-26 - Coherent, zero-dependency, lazy, simple, GraphQL over WebSocket Protocol compliant server and client.
...
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,221 | 🐛 159 | 🌐 TypeScript | 📅 2026-06-02 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
...
* [graphql-middleware](https://github.com/maticzav/graphql-middleware) ⭐ 1,146 | 🐛 43 | 🌐 TypeScript | 📅 2026-05-12 - Split up your GraphQL resolvers in middleware functions.
* [sofa](https://github.com/Urigo/sofa) ⭐ 1,116 | 🐛 38 | 🌐 TypeScript | 📅 2026-05-28 - Generate REST API from your GraphQL API.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 819 | 🐛 43 | 🌐 Go | 📅 2026-05-29 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
* [graphql-armor](https://github.com/Escape-Technologies/graphql-armor) ⭐ 584 | 🐛 32 | 🌐 TypeScript | 📅 2026-06-02 - An instant security layer for production GraphQL Endpoints.
...
* [supertest-graphql](https://github.com/alexstrat/supertest-graphql) ⭐ 34 | 🐛 12 | 🌐 TypeScript | 📅 2023-01-24 - Extends [supertest](https://github.com/visionmedia/supertest) ⭐ 14,366 | 🐛 186 | 🌐 JavaScript | 📅 2026-04-02 to easily test a GraphQL endpoint
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 139,640 | 🐛 4,002 | 🌐 JavaScript | 📅 2026-06-02 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
...
* [NAPERG](https://github.com/alan345/naperg) ⭐ 1,400 | 🐛 0 | 🌐 TypeScript | 📅 2026-05-31 - Fullstack Boilerplate GraphQL. Made with React & Prisma + authentication & roles.
...
* [Relay TodoMVC](https://github.com/taion/relay-todomvc) ⭐ 158 | 🐛 40 | 🌐 JavaScript | 📅 2026-06-01 - Relay TodoMVC with routing.
...
* [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,445 | 🐛 62 | 🌐 Ruby | 📅 2026-05-28 - Ruby implementation of Facebook's GraphQL.
* [graphql-batch](https://github.com/Shopify/graphql-batch) ⭐ 1,440 | 🐛 15 | 🌐 Ruby | 📅 2026-05-26 - A query batching executor for the graphql gem.
* [agoo](https://github.com/ohler55/agoo) ⭐ 929 | 🐛 3 | 🌐 C | 📅 2026-05-09 - Ruby web server that implements Facebook's GraphQL.
...
* [agoo-demo](https://github.com/ohler55/agoo/tree/develop/example/graphql) ⭐ 929 | 🐛 3 | 🌐 C | 📅 2026-05-09 - Use of the Agoo server to demonstrate a simple GraphQL application.
...
* [graphql-php](https://github.com/webonyx/graphql-php) ⭐ 4,715 | 🐛 58 | 🌐 PHP | 📅 2026-05-29 - A PHP port of GraphQL reference implementation.
* [wp-graphql](https://github.com/wp-graphql/wp-graphql) ⭐ 3,780 | 🐛 126 | 🌐 PHP | 📅 2026-06-01 - GraphQL API for WordPress.
* [lighthouse](https://github.com/nuwave/lighthouse) ⭐ 3,493 | 🐛 133 | 🌐 PHP | 📅 2026-05-03 - A PHP package that allows to serve a GraphQL endpoint from your Laravel application.
* [graphql-laravel](https://github.com/rebing/graphql-laravel) ⭐ 2,212 | 🐛 0 | 🌐 PHP | 📅 2026-06-01 - Laravel wrapper for Facebook's GraphQL.
...
* [graphqlite](https://github.com/thecodingmachine/graphqlite) ⭐ 572 | 🐛 28 | 🌐 MDX | 📅 2026-05-20 - Framework agnostic library that allows you to write GraphQL server by annotating your PHP classes.
...
* [graphene](https://github.com/graphql-python/graphene) ⭐ 8,241 | 🐛 114 | 🌐 Python | 📅 2025-09-04 - A package for creating GraphQL schemas/types in a Pythonic easy way.
* [strawberry](https://github.com/strawberry-graphql/strawberry) ⭐ 4,662 | 🐛 454 | 🌐 Python | 📅 2026-06-01 - A new GraphQL library for Python.
* [graphene-django](https://github.com/graphql-python/graphene-django) ⭐ 4,385 | 🐛 165 | 🌐 Python | 📅 2026-02-03 - A Django integration for Graphene.
* [Ariadne](https://github.com/mirumee/ariadne) ⭐ 2,341 | 🐛 31 | 🌐 Python | 📅 2026-05-30 - library for implementing GraphQL servers using schema-first approach. Asynchronous query execution, batteries included for ASGI, WSGI and popular webframeworks, [fully documented](https://ariadnegraphql.org).
...
* [graphql-core](https://github.com/graphql-python/graphql-core) ⭐ 528 | 🐛 31 | 🌐 Python | 📅 2026-05-23 - GraphQL implementation for Python based on GraphQL.js v16.3.0 reference implementation
...
* [graphql-java](https://github.com/graphql-java/graphql-java) ⭐ 6,233 | 🐛 38 | 🌐 Java | 📅 2026-05-29 - GraphQL Java implementation.
* [DGS Framework](https://github.com/Netflix/dgs-framework) ⭐ 3,366 | 🐛 47 | 🌐 Kotlin | 📅 2026-06-01 - A GraphQL server framework for Spring Boot, developed by Netflix.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,742 | 🐛 110 | 🌐 Java | 📅 2026-05-24 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [graphql-spqr](https://github.com/leangen/GraphQL-SPQR) ⭐ 1,104 | 🐛 89 | 🌐 Java | 📅 2026-01-27 - Java 8+ API for rapid development of GraphQL services.
* [graphql-java-tools](https://github.com/graphql-java-kickstart/graphql-java-tools) ⭐ 822 | 🐛 88 | 🌐 Kotlin | 📅 2026-06-01 - Schema-first graphql-java convenience library that makes it easy to bring your own implementations as data resolvers. Inspired by [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,426 | 🐛 158 | 🌐 TypeScript | 📅 2026-06-01 for JS.
...
* [federation-jvm](https://github.com/apollographql/federation-jvm) ⭐ 273 | 🐛 23 | 🌐 Java | 📅 2026-05-27 - Apollo Federation on the JVM.
* [graphql-java-servlet](https://github.com/graphql-java-kickstart/graphql-java-servlet) ⭐ 227 | 🐛 23 | 🌐 Java | 📅 2026-06-02 - A framework-agnostic java servlet for exposing graphql-java query endpoints with GET, POST, and multipart uploads.
...
* [Light Java GraphQL](https://github.com/networknt/light-graphql-4j) ⭐ 34 | 🐛 10 | 🌐 Java | 📅 2026-06-01: A lightweight, fast microservices framework with all cross-cutting concerns addressed and ready to plug in GraphQL schema.
...
* [graphql-java-codegen-maven-plugin](https://github.com/kobylynskyi/graphql-java-codegen-maven-plugin) ⭐ 17 | 🐛 0 | 📅 2020-04-09 - Schema-first maven plugin for generating Java types and Resolver interfaces. Works perfectly in conjunction with graphql-java-tools. Inspired by [swagger-codegen-maven-plugin](https://github.com/swagger-api/swagger-codegen/tree/master/modules/swagger-codegen-maven-plugin) ⭐ 17,749 | 🐛 3,449 | 🌐 Mustache | 📅 2026-05-19.
* [dgs-extended-formatters](https://github.com/setchy/dgs-extended-formatters) ⭐ 6 | 🐛 3 | 🌐 Java | 📅 2026-05-27 - An experimental set of DGS Directives for common formatting use-cases.
...
* [graphql-java-datetime](https://github.com/donbeave/graphql-java-datetime) ⭐ 152 | 🐛 8 | 🌐 Java | 📅 2026-05-26 - GraphQL ISO Date is a set of RFC 3339 compliant date/time scalar types to be used with graphql-java.
...
* [graphql-kotlin](https://github.com/ExpediaGroup/graphql-kotlin) ⭐ 1,803 | 🐛 83 | 🌐 Kotlin | 📅 2026-06-01 - GraphQL Kotlin implementation.
...
* [libgraphqlparser](https://github.com/graphql/libgraphqlparser) ⭐ 1,104 | 🐛 40 | 🌐 C++ | 📅 2025-10-02 - A GraphQL query parser in C++ with C and C++ APIs.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,723 | 🐛 387 | 🌐 Go | 📅 2026-06-02 - Go generate based graphql server library.
* [graphql](https://github.com/graphql-go/graphql) ⭐ 10,152 | 🐛 243 | 🌐 Go | 📅 2025-12-27 - An implementation of GraphQL for Go follows graphql-js
* [graphql-go](https://github.com/graph-gophers/graphql-go) ⭐ 4,752 | 🐛 9 | 🌐 Go | 📅 2026-05-31 - GraphQL server with a focus on ease of use.
* [graphjin](https://github.com/dosco/graphjin) ⭐ 3,076 | 🐛 21 | 🌐 Go | 📅 2026-06-01: Build APIs in 5 minutes with GraphQL. An instant GraphQL to SQL compiler.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 819 | 🐛 43 | 🌐 Go | 📅 2026-05-29 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
* [go-graphql-subscription-example](https://github.com/ccamel/go-graphql-subscription-example) ⭐ 46 | 🐛 11 | 🌐 Go | 📅 2026-05-20 - A GraphQL schema and server that demonstrates GraphQL [subscriptions](https://github.com/apollographql/subscriptions-transport-ws/blob/v0.9.4/PROTOCOL.md) ⚠️ Archived (over Websocket) to consume [Apache Kafka](https://kafka.apache.org/) messages.
...
* [caliban](https://github.com/ghostdogpr/caliban) ⭐ 995 | 🐛 25 | 🌐 Scala | 📅 2026-05-31 - Caliban is a purely functional library for creating GraphQL backends in Scala.
...
* [graphql-dotnet](https://github.com/graphql-dotnet/graphql-dotnet) ⭐ 5,985 | 🐛 130 | 🌐 C# | 📅 2026-05-24 - GraphQL for .NET.
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,702 | 🐛 392 | 🌐 C# | 📅 2026-06-01 - GraphQL server for .Net Core and .NET Framework.
* [graphql-net](https://github.com/ckimes89/graphql-net) ⭐ 885 | 🐛 43 | 🌐 C# | 📅 2022-06-22 - GraphQL to IQueryable for .NET.
...
* [Snowflaqe](https://github.com/Zaid-Ajaj/Snowflaqe) ⭐ 161 | 🐛 22 | 🌐 F# | 📅 2024-10-10 - Type-safe GraphQL code generator for F# and [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,083 | 🐛 211 | 🌐 F# | 📅 2026-05-31
...
* [absinthe-graphql](https://github.com/absinthe-graphql/absinthe) ⭐ 4,400 | 🐛 76 | 🌐 Elixir | 📅 2026-05-08 - Fully Featured Elixir GraphQL Library.
...
* [graphql\_parser](https://github.com/graphql-elixir/graphql_parser) ⭐ 24 | 🐛 3 | 🌐 Elixir | 📅 2023-07-02 - Elixir bindings for [libgraphqlparser](https://github.com/graphql/libgraphqlparser) ⭐ 1,104 | 🐛 40 | 🌐 C++ | 📅 2025-10-02
...
* [Hasura](https://github.com/hasura/graphql-engine) ⭐ 31,974 | 🐛 2,372 | 🌐 TypeScript | 📅 2026-05-29 - Hasura gives Instant Realtime GraphQL APIs over PostgreSQL. Works with an existing database too.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,921 | 🐛 152 | 🌐 TypeScript | 📅 2026-05-15 - Lightning-fast GraphQL APIs for PostgreSQL: highly customisable; extensible via plugins; realtime.
...
* [Lacinia](https://github.com/walmartlabs/lacinia) ⭐ 1,856 | 🐛 11 | 🌐 Clojure | 📅 2026-06-02 - GraphQL implementation in pure Clojure.
...
* [apollo-android](https://github.com/apollographql/apollo-android) ⭐ 3,953 | 🐛 113 | 🌐 Kotlin | 📅 2026-06-02 - 📟 A strongly-typed, caching GraphQL client for Android, written in Java.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,742 | 🐛 110 | 🌐 Java | 📅 2026-05-24 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [apollo-ios](https://github.com/apollographql/apollo-ios) ⭐ 4,030 | 🐛 89 | 🌐 Swift | 📅 2026-05-21 - 📱 A strongly-typed, caching GraphQL client for iOS, written in Swift.
...
* [graphql-flutter](https://github.com/zino-app/graphql-flutter) ⭐ 3,274 | 🐛 161 | 🌐 Dart | 📅 2026-03-30 - A GraphQL client for Flutter.
...
* [juniper](https://github.com/graphql-rust/juniper) ⭐ 5,961 | 🐛 103 | 🌐 Rust | 📅 2026-05-17 - GraphQL server library for Rust.
* [async-graphql](https://github.com/async-graphql/async-graphql) ⭐ 3,660 | 🐛 246 | 🌐 Rust | 📅 2026-04-21 - High-performance server-side library that supports all GraphQL specifications.
* [tailcall](https://github.com/tailcallhq/tailcall) ⭐ 1,440 | 🐛 20 | 🌐 Rust | 📅 2026-06-01 - A platform for building high-performance GraphQL backends.
...
* [graphql-crystal](https://github.com/ziprandom/graphql-crystal) ⭐ 213 | 🐛 9 | 🌐 Crystal | 📅 2020-07-01 - library inspired by [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,445 | 🐛 62 | 🌐 Ruby | 📅 2026-05-28 & [go-graphql](https://github.com/playlyfe/go-graphql) ⭐ 246 | 🐛 18 | 🌐 Go | 📅 2020-01-22 & [graphql-parser](https://github.com/graphql-dotnet/parser) ⭐ 218 | 🐛 9 | 🌐 C# | 📅 2026-04-10.
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 44,618 | 🐛 1,689 | 🌐 JavaScript | 📅 2026-06-01 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,832 | 🐛 391 | 🌐 TypeScript | 📅 2026-05-28 - An in-browser IDE for exploring GraphQL.
* [GraphQL Voyager](https://github.com/APIs-guru/graphql-voyager) ⭐ 8,136 | 🐛 106 | 🌐 TypeScript | 📅 2026-05-12 - Represent any GraphQL API as an interactive graph.
* [GraphQL Editor](https://github.com/graphql-editor/graphql-editor) ⭐ 6,067 | 🐛 20 | 🌐 TypeScript | 📅 2025-09-10 - Visual Editor & GraphQL IDE.
* [Altair GraphQL Client](https://github.com/altair-graphql/altair) ⭐ 5,407 | 🐛 158 | 🌐 TypeScript | 📅 2026-06-02 - A beautiful feature-rich GraphQL Client for all platforms.
...
* [mockd](https://github.com/getmockd/mockd) ⭐ 123 | 🐛 17 | 🌐 Go | 📅 2026-05-18 - Multi-protocol mock server with GraphQL schema mocking, resolver configuration, and query validation. Also supports HTTP, gRPC, WebSocket, MQTT, and SOAP.
* [graphql-to-karate](https://github.com/wbaldoumas/graphql-to-karate) ⭐ 16 | 🐛 3 | 🌐 C# | 📅 2026-06-01 - **Generate Karate API tests** from your GraphQL schemas
...
* [InQL Scanner](https://github.com/doyensec/inql) ⭐ 1,780 | 🐛 37 | 🌐 Kotlin | 📅 2026-04-22 - A Burp Extension for GraphQL Security Testing
* [GraphQL Cop](https://github.com/dolevf/graphql-cop) ⭐ 649 | 🐛 1 | 🌐 Python | 📅 2025-11-20 - Security Audit Utility for GraphQL
...
* [GraphQLer](https://github.com/omar2535/GraphQLer) ⭐ 163 | 🐛 33 | 🌐 Python | 📅 2026-05-29 - Dependency-aware dynamic GraphQL testing tool
...
* [Apollo Client Developer Tools](https://github.com/apollographql/apollo-client-devtools) ⭐ 1,524 | 🐛 56 | 🌐 TypeScript | 📅 2026-06-02 - GraphQL debugging tools for Apollo Client in the Chrome developer console
...
* [graphdoc](https://github.com/2fd/graphdoc) ⭐ 1,567 | 🐛 100 | 🌐 TypeScript | 📅 2023-01-31 - Static page generator for documenting GraphQL Schema.
...
* [js-graphql-intellij-plugin](https://github.com/jimkyndemeyer/js-graphql-intellij-plugin/) ⭐ 899 | 🐛 157 | 🌐 Java | 📅 2026-06-02 - GraphQL language support for IntelliJ IDEA and WebStorm, including Relay.QL tagged templates in JavaScript and TypeScript.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 46,043 | 🐛 2,624 | 🌐 TypeScript | 📅 2026-06-01 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.

* [Bit](https://github.com/teambit/bit) ⭐ 18,402 | 🐛 85 | 🌐 TypeScript | 📅 2026-06-01 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).

* [amplication](https://github.com/amplication/amplication) ⭐ 16,007 | 🐛 648 | 🌐 TypeScript | 📅 2026-06-01: Amplication is an open‑source low code development tool. It builds database applications with REST API and GraphQL for CRUD with relations, sorting, filtering, pagination.

* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,251 | 🐛 563 | 🌐 TypeScript | 📅 2026-06-01 - GraphQL code generator based on schema and documents.

* [json-graphql-server](https://github.com/marmelab/json-graphql-server) ⭐ 1,950 | 🐛 12 | 🌐 JavaScript | 📅 2026-06-01 - Get a full fake GraphQL API with zero coding in less than 30 seconds, based on a JSON data file.

* [raphql-inspector](https://github.com/kamilkisiela/graphql-inspector) ⭐ 1,749 | 🐛 134 | 🌐 TypeScript | 📅 2026-04-30: alidate schema, get schema change notifications, validate operations, find breaking changes, look for similar types, schema coverage.
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 20,086 | 🐛 996 | 🌐 Rust | 📅 2026-06-02
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 16,263 | 🐛 536 | 🌐 Go | 📅 2026-06-02 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 22,947 | 🐛 256 | 🌐 Python | 📅 2026-06-02 - GraphQL-first headless e-commerce platform.
