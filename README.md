...
* [GraphQL](https://github.com/graphql/graphql-spec) ⭐ 14,725 | 🐛 193 | 🌐 JavaScript | 📅 2026-03-23 - Working draft of the specification for GraphQL.
...
* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,718 | 🐛 419 | 🌐 TypeScript | 📅 2026-03-30 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
* [aws-amplify](https://github.com/aws-amplify/amplify-js) ⭐ 9,590 | 🐛 476 | 🌐 TypeScript | 📅 2026-03-27 - A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.
* [graphql-request](https://github.com/prisma-labs/graphql-request) ⭐ 6,116 | 🐛 52 | 🌐 TypeScript | 📅 2026-03-20 - A minimal GraphQL client for Node and browsers.
...
* [gqty](https://github.com/gqty-dev/gqty) ⭐ 1,032 | 🐛 51 | 🌐 TypeScript | 📅 2026-03-30 - A No GraphQL client for TypeScript
...
* [sveltekit-kitql](https://github.com/jycouet/kitql) ⭐ 453 | 🐛 8 | 🌐 TypeScript | 📅 2026-03-30 - A set of tools, helping you building efficient apps in a fast way with SvelteKit and GraphQL.
...
* [relay](https://github.com/facebook/relay) ⭐ 18,933 | 🐛 829 | 🌐 Rust | 📅 2026-03-31 - Relay is a JavaScript framework for building data-driven React applications.
...
* [@gqty/react](https://github.com/gqty-dev/gqty) ⭐ 1,032 | 🐛 51 | 🌐 TypeScript | 📅 2026-03-30 - A No GraphQL client for TypeScript
* [mst-gql](https://github.com/mobxjs/mst-gql) ⭐ 688 | 🐛 89 | 🌐 JavaScript | 📅 2024-09-03 - Bindings for mobx-state-tree and GraphQL.
* [micro-graphql-react](https://github.com/arackaf/micro-graphql-react) ⭐ 531 | 🐛 22 | 🌐 JavaScript | 📅 2024-06-22 - A lightweight utility for adding GraphQL to React. components. Includes simple caching and uses GET requests that could additionally be cached through a service-worker.
...
* [apollo-server](https://github.com/apollographql/apollo-server) ⭐ 13,943 | 🐛 82 | 🌐 TypeScript | 📅 2026-03-30 - Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
* [graphql-yoga](https://github.com/prisma-labs/graphql-yoga) ⭐ 8,507 | 🐛 135 | 🌐 TypeScript | 📅 2026-03-30 - Fully-featured GraphQL Server with focus on easy setup, performance and great developer experience.
* [mercurius](https://github.com/mercurius-js/mercurius) ⭐ 2,478 | 🐛 71 | 🌐 JavaScript | 📅 2026-03-30 - GraphQL plugin for Fastify.
...
* [graphitejs](https://github.com/graphitejs/server) ⭐ 122 | 🐛 18 | 🌐 JavaScript | 📅 2026-03-30 - Framework NodeJS for GraphQL.
...
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,228 | 🐛 602 | 🌐 TypeScript | 📅 2026-03-30: GraphQL code generator with flexible support for custom plugins and templates like TypeScript (frontend and backend), React Hooks, resolvers signatures and more.
...
* [pothos](https://github.com/hayes/pothos) ⭐ 2,584 | 🐛 62 | 🌐 TypeScript | 📅 2026-02-25 - Pothos is a plugin based GraphQL schema builder for typescript. It makes building graphql schemas in typescript easy, fast and enjoyable.
...
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 94 | 🐛 8 | 🌐 TypeScript | 📅 2026-03-30 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,524 | 🐛 117 | 🌐 TypeScript | 📅 2026-03-30, [Zod](https://github.com/colinhacks/zod) ⭐ 42,250 | 🐛 302 | 🌐 TypeScript | 📅 2026-02-15, or [Yup](https://github.com/jquense/yup) ⭐ 23,689 | 🐛 240 | 🌐 TypeScript | 📅 2026-03-27.
...
* [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,422 | 🐛 160 | 🌐 TypeScript | 📅 2026-03-30 - Tool library for building and maintaining GraphQL-JS servers.
* [graphql-shield](https://github.com/maticzav/graphql-shield) ⭐ 3,574 | 🐛 108 | 🌐 TypeScript | 📅 2026-03-30 - A library that helps creating a permission layer for a graphql api.
* [graphql-mesh](https://github.com/urigo/graphql-mesh) ⭐ 3,496 | 🐛 219 | 🌐 TypeScript | 📅 2026-03-30 - use GraphQL query language to access data in remote APIs that don't run GraphQL (and also ones that do run GraphQL).
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,181 | 🐛 29 | 🌐 Python | 📅 2026-03-29 - Runs arbitrary queries matching a GraphQL schema to find server errors.
...
* [graphql-cli](https://github.com/urigo/graphql-cli) ⭐ 2,020 | 🐛 48 | 🌐 TypeScript | 📅 2026-03-30 - A command line tool for common GraphQL development workflows.
...
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,189 | 🐛 157 | 🌐 TypeScript | 📅 2026-03-30 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
* [graphql-middleware](https://github.com/maticzav/graphql-middleware) ⭐ 1,149 | 🐛 43 | 🌐 TypeScript | 📅 2026-03-30 - Split up your GraphQL resolvers in middleware functions.
* [sofa](https://github.com/Urigo/sofa) ⭐ 1,115 | 🐛 37 | 🌐 TypeScript | 📅 2026-03-30 - Generate REST API from your GraphQL API.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 818 | 🐛 44 | 🌐 Go | 📅 2026-03-30 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
* [graphql-armor](https://github.com/Escape-Technologies/graphql-armor) ⭐ 581 | 🐛 33 | 🌐 TypeScript | 📅 2026-03-30 - An instant security layer for production GraphQL Endpoints.
* [GraphQL Constraint Directive](https://github.com/confuser/graphql-constraint-directive) ⭐ 577 | 🐛 43 | 🌐 JavaScript | 📅 2026-03-30 - Allows using @constraint as a directive to validate input data. Inspired by Constraints Directives RFC and OpenAPI
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 138,554 | 🐛 3,628 | 🌐 JavaScript | 📅 2026-03-31 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
...
* [Relay TodoMVC](https://github.com/taion/relay-todomvc) ⭐ 158 | 🐛 40 | 🌐 JavaScript | 📅 2026-03-30 - Relay TodoMVC with routing.
...
* [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,429 | 🐛 77 | 🌐 Ruby | 📅 2026-03-30 - Ruby implementation of Facebook's GraphQL.
* [graphql-batch](https://github.com/Shopify/graphql-batch) ⭐ 1,436 | 🐛 18 | 🌐 Ruby | 📅 2026-03-30 - A query batching executor for the graphql gem.
...
* [graphql-php](https://github.com/webonyx/graphql-php) ⭐ 4,706 | 🐛 56 | 🌐 PHP | 📅 2026-03-30 - A PHP port of GraphQL reference implementation.
* [wp-graphql](https://github.com/wp-graphql/wp-graphql) ⭐ 3,777 | 🐛 111 | 🌐 PHP | 📅 2026-03-30 - GraphQL API for WordPress.
* [lighthouse](https://github.com/nuwave/lighthouse) ⭐ 3,481 | 🐛 132 | 🌐 PHP | 📅 2026-03-30 - A PHP package that allows to serve a GraphQL endpoint from your Laravel application.
...
* [graphqlite](https://github.com/thecodingmachine/graphqlite) ⭐ 572 | 🐛 39 | 🌐 MDX | 📅 2026-03-30 - Framework agnostic library that allows you to write GraphQL server by annotating your PHP classes.
...
* [strawberry](https://github.com/strawberry-graphql/strawberry) ⭐ 4,633 | 🐛 448 | 🌐 Python | 📅 2026-03-30 - A new GraphQL library for Python.
...
* [Ariadne](https://github.com/mirumee/ariadne) ⭐ 2,333 | 🐛 28 | 🌐 Python | 📅 2026-03-27 - library for implementing GraphQL servers using schema-first approach. Asynchronous query execution, batteries included for ASGI, WSGI and popular webframeworks, [fully documented](https://ariadnegraphql.org).
...
* [graphql-core](https://github.com/graphql-python/graphql-core) ⭐ 531 | 🐛 29 | 🌐 Python | 📅 2026-03-07 - GraphQL implementation for Python based on GraphQL.js v16.3.0 reference implementation
...
* [graphql-java](https://github.com/graphql-java/graphql-java) ⭐ 6,231 | 🐛 54 | 🌐 Java | 📅 2026-03-29 - GraphQL Java implementation.
...
* [graphql-java-codegen-maven-plugin](https://github.com/kobylynskyi/graphql-java-codegen-maven-plugin) ⭐ 17 | 🐛 0 | 📅 2020-04-09 - Schema-first maven plugin for generating Java types and Resolver interfaces. Works perfectly in conjunction with graphql-java-tools. Inspired by [swagger-codegen-maven-plugin](https://github.com/swagger-api/swagger-codegen/tree/master/modules/swagger-codegen-maven-plugin) ⭐ 17,720 | 🐛 3,445 | 🌐 Mustache | 📅 2026-03-14.
...
* [graphql-java-datetime](https://github.com/donbeave/graphql-java-datetime) ⭐ 153 | 🐛 6 | 🌐 Java | 📅 2026-03-30 - GraphQL ISO Date is a set of RFC 3339 compliant date/time scalar types to be used with graphql-java.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,697 | 🐛 398 | 🌐 Go | 📅 2026-03-30 - Go generate based graphql server library.
...
* [graphjin](https://github.com/dosco/graphjin) ⭐ 3,037 | 🐛 18 | 🌐 Go | 📅 2026-03-30: Build APIs in 5 minutes with GraphQL. An instant GraphQL to SQL compiler.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 818 | 🐛 44 | 🌐 Go | 📅 2026-03-30 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
* [go-graphql-subscription-example](https://github.com/ccamel/go-graphql-subscription-example) ⭐ 46 | 🐛 3 | 🌐 Go | 📅 2026-03-30 - A GraphQL schema and server that demonstrates GraphQL [subscriptions](https://github.com/apollographql/subscriptions-transport-ws/blob/v0.9.4/PROTOCOL.md) ⚠️ Archived (over Websocket) to consume [Apache Kafka](https://kafka.apache.org/) messages.
...
* [caliban](https://github.com/ghostdogpr/caliban) ⭐ 990 | 🐛 28 | 🌐 Scala | 📅 2026-03-30 - Caliban is a purely functional library for creating GraphQL backends in Scala.
...
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,679 | 🐛 362 | 🌐 C# | 📅 2026-03-31 - GraphQL server for .Net Core and .NET Framework.
* [graphql-net](https://github.com/ckimes89/graphql-net) ⭐ 887 | 🐛 43 | 🌐 C# | 📅 2022-06-22 - GraphQL to IQueryable for .NET.
* [EntityGraphQL](https://github.com/EntityGraphQL/EntityGraphQL) ⭐ 452 | 🐛 20 | 🌐 C# | 📅 2026-03-30 - library to build a GraphQL API on top of data model with the extensibility to bring multiple data sources together in the single GraphQL schema.
* [ZeroQL](https://github.com/byme8/ZeroQL) ⭐ 318 | 🐛 11 | 🌐 C# | 📅 2025-12-28 - type-safe GraphQL client with Linq-like interface for C#
* [Snowflaqe](https://github.com/Zaid-Ajaj/Snowflaqe) ⭐ 160 | 🐛 22 | 🌐 F# | 📅 2024-10-10 - Type-safe GraphQL code generator for F# and [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,068 | 🐛 223 | 🌐 F# | 📅 2026-03-31
...
* [Hasura](https://github.com/hasura/graphql-engine) ⭐ 31,924 | 🐛 2,375 | 🌐 TypeScript | 📅 2026-03-30 - Hasura gives Instant Realtime GraphQL APIs over PostgreSQL. Works with an existing database too.
...
* [apollo-android](https://github.com/apollographql/apollo-android) ⭐ 3,950 | 🐛 114 | 🌐 Kotlin | 📅 2026-03-27 - 📟 A strongly-typed, caching GraphQL client for Android, written in Java.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,726 | 🐛 108 | 🌐 Java | 📅 2026-03-08 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [apollo-ios](https://github.com/apollographql/apollo-ios) ⭐ 4,035 | 🐛 95 | 🌐 Swift | 📅 2026-03-30 - 📱 A strongly-typed, caching GraphQL client for iOS, written in Swift.
...
* [graphql-flutter](https://github.com/zino-app/graphql-flutter) ⭐ 3,272 | 🐛 160 | 🌐 Dart | 📅 2026-03-30 - A GraphQL client for Flutter.
...
* [tailcall](https://github.com/tailcallhq/tailcall) ⭐ 1,433 | 🐛 15 | 🌐 Rust | 📅 2026-03-30 - A platform for building high-performance GraphQL backends.
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 42,412 | 🐛 1,629 | 🌐 JavaScript | 📅 2026-03-30 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,817 | 🐛 413 | 🌐 TypeScript | 📅 2026-03-05 - An in-browser IDE for exploring GraphQL.
* [GraphQL Voyager](https://github.com/APIs-guru/graphql-voyager) ⭐ 8,098 | 🐛 105 | 🌐 TypeScript | 📅 2026-03-30 - Represent any GraphQL API as an interactive graph.
* [GraphQL Editor](https://github.com/graphql-editor/graphql-editor) ⭐ 6,072 | 🐛 20 | 🌐 TypeScript | 📅 2025-09-10 - Visual Editor & GraphQL IDE.
* [Altair GraphQL Client](https://github.com/altair-graphql/altair) ⭐ 5,399 | 🐛 66 | 🌐 TypeScript | 📅 2026-03-30 - A beautiful feature-rich GraphQL Client for all platforms.
...
* [mockd](https://github.com/getmockd/mockd) ⭐ 94 | 🐛 0 | 🌐 Go | 📅 2026-03-28 - Multi-protocol mock server with GraphQL schema mocking, resolver configuration, and query validation. Also supports HTTP, gRPC, WebSocket, MQTT, and SOAP.
* [graphql-to-karate](https://github.com/wbaldoumas/graphql-to-karate) ⭐ 16 | 🐛 3 | 🌐 C# | 📅 2026-03-31 - **Generate Karate API tests** from your GraphQL schemas
...
* [GraphQL Cop](https://github.com/dolevf/graphql-cop) ⭐ 633 | 🐛 1 | 🌐 Python | 📅 2025-11-20 - Security Audit Utility for GraphQL
...
* [GraphQLer](https://github.com/omar2535/GraphQLer) ⭐ 162 | 🐛 12 | 🌐 Python | 📅 2026-03-30 - Dependency-aware dynamic GraphQL testing tool
...
* [Apollo Client Developer Tools](https://github.com/apollographql/apollo-client-devtools) ⭐ 1,524 | 🐛 54 | 🌐 TypeScript | 📅 2026-03-30 - GraphQL debugging tools for Apollo Client in the Chrome developer console
...
* [js-graphql-intellij-plugin](https://github.com/jimkyndemeyer/js-graphql-intellij-plugin/) ⭐ 899 | 🐛 157 | 🌐 Java | 📅 2026-03-30 - GraphQL language support for IntelliJ IDEA and WebStorm, including Relay.QL tagged templates in JavaScript and TypeScript.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 45,627 | 🐛 2,539 | 🌐 TypeScript | 📅 2026-03-30 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.
* [Bit](https://github.com/teambit/bit) ⭐ 18,367 | 🐛 68 | 🌐 TypeScript | 📅 2026-03-31 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).
* [amplication](https://github.com/amplication/amplication) ⭐ 15,998 | 🐛 620 | 🌐 TypeScript | 📅 2026-03-13: Amplication is an open‑source low code development tool. It builds database applications with REST API and GraphQL for CRUD with relations, sorting, filtering, pagination.
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,228 | 🐛 602 | 🌐 TypeScript | 📅 2026-03-30 - GraphQL code generator based on schema and documents.
...
* [openapi-to-graphql](https://github.com/ibm/openapi-to-graphql) ⭐ 1,646 | 🐛 141 | 🌐 TypeScript | 📅 2025-09-17 - Take any OpenAPI Specification (OAS) or swagger and create a GraphQL interface - Two minute video and resources [here](https://developer.ibm.com/open/projects/openapi-to-graphql/)
...
* [ts-graphql-plugin](https://github.com/Quramy/ts-graphql-plugin) ⭐ 758 | 🐛 24 | 🌐 TypeScript | 📅 2026-03-30 - A language service plugin complete and validate GraphQL query in TypeScript template strings.
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 19,733 | 🐛 912 | 🌐 Rust | 📅 2026-03-30
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 15,924 | 🐛 560 | 🌐 Go | 📅 2026-03-31 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 22,749 | 🐛 240 | 🌐 Python | 📅 2026-03-30 - GraphQL-first headless e-commerce platform.
