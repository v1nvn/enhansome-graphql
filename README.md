...
* [GraphQL](https://github.com/graphql/graphql-spec) ⭐ 14,722 | 🐛 192 | 🌐 JavaScript | 📅 2026-04-02 - Working draft of the specification for GraphQL.
* [GraphQL over HTTP](https://github.com/graphql/graphql-over-http) ⭐ 420 | 🐛 35 | 🌐 JavaScript | 📅 2026-04-02 - Working draft of "GraphQL over HTTP" specification.
...
* [GraphQL APIs](https://github.com/APIs-guru/graphql-apis) ⭐ 4,649 | 🐛 1 | 📅 2024-09-26 - A collective list of public GraphQL APIs.
...
* [graphql-js](https://github.com/graphql/graphql-js) ⭐ 20,326 | 🐛 132 | 🌐 TypeScript | 📅 2026-03-31 - A reference implementation of GraphQL for JavaScript.
...
* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,722 | 🐛 420 | 🌐 TypeScript | 📅 2026-03-30 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
* [aws-amplify](https://github.com/aws-amplify/amplify-js) ⭐ 9,589 | 🐛 476 | 🌐 TypeScript | 📅 2026-04-03 - A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.
...
* [relay](https://github.com/facebook/relay) ⭐ 18,934 | 🐛 831 | 🌐 Rust | 📅 2026-04-03 - Relay is a JavaScript framework for building data-driven React applications.
* [urql](https://github.com/FormidableLabs/urql) ⭐ 8,951 | 🐛 34 | 🌐 TypeScript | 📅 2026-04-02 - A simple caching GraphQL client for React.
...
* [apollo-server](https://github.com/apollographql/apollo-server) ⭐ 13,945 | 🐛 82 | 🌐 TypeScript | 📅 2026-04-01 - Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
* [graphql-yoga](https://github.com/prisma-labs/graphql-yoga) ⭐ 8,507 | 🐛 133 | 🌐 TypeScript | 📅 2026-04-02 - Fully-featured GraphQL Server with focus on easy setup, performance and great developer experience.
* [mercurius](https://github.com/mercurius-js/mercurius) ⭐ 2,478 | 🐛 71 | 🌐 JavaScript | 📅 2026-04-02 - GraphQL plugin for Fastify.
...
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,231 | 🐛 604 | 🌐 TypeScript | 📅 2026-04-03: GraphQL code generator with flexible support for custom plugins and templates like TypeScript (frontend and backend), React Hooks, resolvers signatures and more.
* [type-graphql](https://github.com/19majkel94/type-graphql) ⭐ 8,093 | 🐛 114 | 🌐 TypeScript | 📅 2026-03-23 - Create GraphQL schema and resolvers with TypeScript, using classes and decorators!
...
* [gql.tada](https://github.com/0no-co/gql.tada) ⭐ 2,922 | 🐛 26 | 🌐 TypeScript | 📅 2026-04-01 - GraphQL document authoring library, inferring the result and variables types of GraphQL queries and fragments in the TypeScript type system.
* [pothos](https://github.com/hayes/pothos) ⭐ 2,586 | 🐛 63 | 🌐 TypeScript | 📅 2026-04-01 - Pothos is a plugin based GraphQL schema builder for typescript. It makes building graphql schemas in typescript easy, fast and enjoyable.
...
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 95 | 🐛 6 | 🌐 TypeScript | 📅 2026-04-02 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,540 | 🐛 118 | 🌐 TypeScript | 📅 2026-04-03, [Zod](https://github.com/colinhacks/zod) ⭐ 42,285 | 🐛 309 | 🌐 TypeScript | 📅 2026-02-15, or [Yup](https://github.com/jquense/yup) ⭐ 23,687 | 🐛 240 | 🌐 TypeScript | 📅 2026-04-01.
...
* [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,423 | 🐛 155 | 🌐 TypeScript | 📅 2026-04-02 - Tool library for building and maintaining GraphQL-JS servers.
...
* [graphql-mesh](https://github.com/urigo/graphql-mesh) ⭐ 3,497 | 🐛 221 | 🌐 TypeScript | 📅 2026-04-02 - use GraphQL query language to access data in remote APIs that don't run GraphQL (and also ones that do run GraphQL).
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,195 | 🐛 30 | 🌐 Python | 📅 2026-04-03 - Runs arbitrary queries matching a GraphQL schema to find server errors.
...
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,192 | 🐛 162 | 🌐 TypeScript | 📅 2026-04-02 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
...
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 818 | 🐛 45 | 🌐 Go | 📅 2026-04-02 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
* [graphql-armor](https://github.com/Escape-Technologies/graphql-armor) ⭐ 581 | 🐛 34 | 🌐 TypeScript | 📅 2026-04-02 - An instant security layer for production GraphQL Endpoints.
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 138,589 | 🐛 3,658 | 🌐 JavaScript | 📅 2026-04-03 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
* [React Starter Kit](https://github.com/kriasoft/react-starter-kit) ⭐ 23,550 | 🐛 9 | 🌐 TypeScript | 📅 2026-03-02 - front-end starter kit using React, Relay, GraphQL, and JAM stack architecture.
...
* [graphql-php](https://github.com/webonyx/graphql-php) ⭐ 4,706 | 🐛 57 | 🌐 PHP | 📅 2026-04-02 - A PHP port of GraphQL reference implementation.
* [wp-graphql](https://github.com/wp-graphql/wp-graphql) ⭐ 3,779 | 🐛 113 | 🌐 PHP | 📅 2026-04-02 - GraphQL API for WordPress.
* [lighthouse](https://github.com/nuwave/lighthouse) ⭐ 3,483 | 🐛 132 | 🌐 PHP | 📅 2026-03-30 - A PHP package that allows to serve a GraphQL endpoint from your Laravel application.
...
* [strawberry](https://github.com/strawberry-graphql/strawberry) ⭐ 4,637 | 🐛 447 | 🌐 Python | 📅 2026-04-02 - A new GraphQL library for Python.
...
* [Ariadne](https://github.com/mirumee/ariadne) ⭐ 2,334 | 🐛 27 | 🌐 Python | 📅 2026-03-27 - library for implementing GraphQL servers using schema-first approach. Asynchronous query execution, batteries included for ASGI, WSGI and popular webframeworks, [fully documented](https://ariadnegraphql.org).
...
* [turms](https://github.com/jhnnsrs/turms) ⭐ 75 | 🐛 21 | 🌐 Python | 📅 2026-04-02 - A pythonic graphql codegenerator built around graphql-core and pydantic
...
* [rath](https://github.com/jhnnsrs/rath) ⭐ 10 | 🐛 4 | 🌐 Python | 📅 2026-04-02 - An apollo like graphql client with async and sync interface
...
* [graphql-java](https://github.com/graphql-java/graphql-java) ⭐ 6,234 | 🐛 54 | 🌐 Java | 📅 2026-04-03 - GraphQL Java implementation.
* [DGS Framework](https://github.com/Netflix/dgs-framework) ⭐ 3,311 | 🐛 44 | 🌐 Kotlin | 📅 2026-04-02 - A GraphQL server framework for Spring Boot, developed by Netflix.
...
* [graphql-java-servlet](https://github.com/graphql-java-kickstart/graphql-java-servlet) ⭐ 226 | 🐛 23 | 🌐 Java | 📅 2026-04-02 - A framework-agnostic java servlet for exposing graphql-java query endpoints with GET, POST, and multipart uploads.
...
* [graphql-java-codegen-maven-plugin](https://github.com/kobylynskyi/graphql-java-codegen-maven-plugin) ⭐ 17 | 🐛 0 | 📅 2020-04-09 - Schema-first maven plugin for generating Java types and Resolver interfaces. Works perfectly in conjunction with graphql-java-tools. Inspired by [swagger-codegen-maven-plugin](https://github.com/swagger-api/swagger-codegen/tree/master/modules/swagger-codegen-maven-plugin) ⭐ 17,721 | 🐛 3,446 | 🌐 Mustache | 📅 2026-03-14.
...
* [light-java-graphql examples](https://github.com/networknt/light-example-4j/tree/master/graphql) ⭐ 150 | 🐛 14 | 🌐 Java | 📅 2026-03-26 - Examples of Light Java GraphQL and tutorials.
...
* [graphql-kotlin](https://github.com/ExpediaGroup/graphql-kotlin) ⭐ 1,801 | 🐛 92 | 🌐 Kotlin | 📅 2026-03-19 - GraphQL Kotlin implementation.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,700 | 🐛 388 | 🌐 Go | 📅 2026-04-02 - Go generate based graphql server library.
...
* [graphjin](https://github.com/dosco/graphjin) ⭐ 3,043 | 🐛 18 | 🌐 Go | 📅 2026-04-02: Build APIs in 5 minutes with GraphQL. An instant GraphQL to SQL compiler.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 818 | 🐛 45 | 🌐 Go | 📅 2026-04-02 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,682 | 🐛 363 | 🌐 C# | 📅 2026-04-02 - GraphQL server for .Net Core and .NET Framework.
...
* [Snowflaqe](https://github.com/Zaid-Ajaj/Snowflaqe) ⭐ 160 | 🐛 22 | 🌐 F# | 📅 2024-10-10 - Type-safe GraphQL code generator for F# and [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,070 | 🐛 225 | 🌐 F# | 📅 2026-04-03
...
* [absinthe-graphql](https://github.com/absinthe-graphql/absinthe) ⭐ 4,403 | 🐛 78 | 🌐 Elixir | 📅 2026-03-17 - Fully Featured Elixir GraphQL Library.
...
* [Hasura](https://github.com/hasura/graphql-engine) ⭐ 31,931 | 🐛 2,375 | 🌐 TypeScript | 📅 2026-04-02 - Hasura gives Instant Realtime GraphQL APIs over PostgreSQL. Works with an existing database too.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,919 | 🐛 150 | 🌐 TypeScript | 📅 2026-04-02 - Lightning-fast GraphQL APIs for PostgreSQL: highly customisable; extensible via plugins; realtime.
...
* [apollo-android](https://github.com/apollographql/apollo-android) ⭐ 3,951 | 🐛 115 | 🌐 Kotlin | 📅 2026-04-02 - 📟 A strongly-typed, caching GraphQL client for Android, written in Java.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,726 | 🐛 108 | 🌐 Java | 📅 2026-03-08 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [apollo-ios](https://github.com/apollographql/apollo-ios) ⭐ 4,035 | 🐛 92 | 🌐 Swift | 📅 2026-04-02 - 📱 A strongly-typed, caching GraphQL client for iOS, written in Swift.
...
* [graphql-flutter](https://github.com/zino-app/graphql-flutter) ⭐ 3,274 | 🐛 160 | 🌐 Dart | 📅 2026-03-30 - A GraphQL client for Flutter.
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 42,521 | 🐛 1,605 | 🌐 JavaScript | 📅 2026-04-02 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,817 | 🐛 413 | 🌐 TypeScript | 📅 2026-03-05 - An in-browser IDE for exploring GraphQL.
* [GraphQL Voyager](https://github.com/APIs-guru/graphql-voyager) ⭐ 8,103 | 🐛 105 | 🌐 TypeScript | 📅 2026-03-30 - Represent any GraphQL API as an interactive graph.
* [GraphQL Editor](https://github.com/graphql-editor/graphql-editor) ⭐ 6,073 | 🐛 20 | 🌐 TypeScript | 📅 2025-09-10 - Visual Editor & GraphQL IDE.
* [Altair GraphQL Client](https://github.com/altair-graphql/altair) ⭐ 5,400 | 🐛 70 | 🌐 TypeScript | 📅 2026-04-02 - A beautiful feature-rich GraphQL Client for all platforms.
...
* [mockd](https://github.com/getmockd/mockd) ⭐ 95 | 🐛 0 | 🌐 Go | 📅 2026-04-03 - Multi-protocol mock server with GraphQL schema mocking, resolver configuration, and query validation. Also supports HTTP, gRPC, WebSocket, MQTT, and SOAP.
* [graphql-to-karate](https://github.com/wbaldoumas/graphql-to-karate) ⭐ 16 | 🐛 3 | 🌐 C# | 📅 2026-04-02 - **Generate Karate API tests** from your GraphQL schemas
...
* [Escape Graphinder - GraphQL Subdomain Enumeration](https://github.com/Escape-Technologies/graphinder) ⭐ 229 | 🐛 6 | 🌐 Python | 📅 2023-05-22 – Blazing fast GraphQL endpoints finder using subdomain enumeration, scripts analysis and bruteforce.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 45,647 | 🐛 2,542 | 🌐 TypeScript | 📅 2026-04-02 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.
* [Bit](https://github.com/teambit/bit) ⭐ 18,366 | 🐛 69 | 🌐 TypeScript | 📅 2026-04-02 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).
* [amplication](https://github.com/amplication/amplication) ⭐ 15,997 | 🐛 616 | 🌐 TypeScript | 📅 2026-04-03: Amplication is an open‑source low code development tool. It builds database applications with REST API and GraphQL for CRUD with relations, sorting, filtering, pagination.
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,231 | 🐛 604 | 🌐 TypeScript | 📅 2026-04-03 - GraphQL code generator based on schema and documents.
...
* [ts-graphql-plugin](https://github.com/Quramy/ts-graphql-plugin) ⭐ 758 | 🐛 23 | 🌐 TypeScript | 📅 2026-04-02 - A language service plugin complete and validate GraphQL query in TypeScript template strings.
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 19,751 | 🐛 922 | 🌐 Rust | 📅 2026-04-03
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 15,940 | 🐛 541 | 🌐 Go | 📅 2026-04-03 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 22,766 | 🐛 240 | 🌐 Python | 📅 2026-04-02 - GraphQL-first headless e-commerce platform.
