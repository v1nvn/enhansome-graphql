...
* [GraphQL](https://github.com/graphql/graphql-spec) ⭐ 14,721 | 🐛 195 | 🌐 JavaScript | 📅 2026-04-02 - Working draft of the specification for GraphQL.
...
* [graphql-js](https://github.com/graphql/graphql-js) ⭐ 20,328 | 🐛 133 | 🌐 TypeScript | 📅 2026-04-05 - A reference implementation of GraphQL for JavaScript.
...
* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,722 | 🐛 422 | 🌐 TypeScript | 📅 2026-04-04 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
* [aws-amplify](https://github.com/aws-amplify/amplify-js) ⭐ 9,587 | 🐛 477 | 🌐 TypeScript | 📅 2026-04-07 - A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.
...
* [gqty](https://github.com/gqty-dev/gqty) ⭐ 1,033 | 🐛 52 | 🌐 TypeScript | 📅 2026-04-07 - A No GraphQL client for TypeScript
...
* [sveltekit-kitql](https://github.com/jycouet/kitql) ⭐ 453 | 🐛 12 | 🌐 TypeScript | 📅 2026-04-07 - A set of tools, helping you building efficient apps in a fast way with SvelteKit and GraphQL.
* [apollo-elements](https://github.com/apollo-elements/apollo-elements) ⭐ 422 | 🐛 7 | 🌐 TypeScript | 📅 2026-03-27 - GraphQL web components that work in any frontend framework.
...
* [relay](https://github.com/facebook/relay) ⭐ 18,935 | 🐛 830 | 🌐 Rust | 📅 2026-04-08 - Relay is a JavaScript framework for building data-driven React applications.
...
* [@gqty/react](https://github.com/gqty-dev/gqty) ⭐ 1,033 | 🐛 52 | 🌐 TypeScript | 📅 2026-04-07 - A No GraphQL client for TypeScript
...
* [graphql-yoga](https://github.com/prisma-labs/graphql-yoga) ⭐ 8,508 | 🐛 135 | 🌐 TypeScript | 📅 2026-04-07 - Fully-featured GraphQL Server with focus on easy setup, performance and great developer experience.
...
* [join-monster](https://github.com/acarl005/join-monster) ⭐ 2,702 | 🐛 31 | 🌐 JavaScript | 📅 2025-08-06 - A GraphQL-to-SQL query execution layer for batch data fetching.
...
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 95 | 🐛 7 | 🌐 TypeScript | 📅 2026-04-07 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,548 | 🐛 119 | 🌐 TypeScript | 📅 2026-04-04, [Zod](https://github.com/colinhacks/zod) ⭐ 42,327 | 🐛 311 | 🌐 TypeScript | 📅 2026-02-15, or [Yup](https://github.com/jquense/yup) ⭐ 23,687 | 🐛 240 | 🌐 TypeScript | 📅 2026-04-03.
...
* [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,423 | 🐛 156 | 🌐 TypeScript | 📅 2026-04-07 - Tool library for building and maintaining GraphQL-JS servers.
...
* [graphql-mesh](https://github.com/urigo/graphql-mesh) ⭐ 3,496 | 🐛 220 | 🌐 TypeScript | 📅 2026-04-07 - use GraphQL query language to access data in remote APIs that don't run GraphQL (and also ones that do run GraphQL).
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,203 | 🐛 22 | 🌐 Python | 📅 2026-04-06 - Runs arbitrary queries matching a GraphQL schema to find server errors.
...
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,191 | 🐛 164 | 🌐 TypeScript | 📅 2026-04-07 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
...
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 819 | 🐛 44 | 🌐 Go | 📅 2026-04-07 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
* [graphql-armor](https://github.com/Escape-Technologies/graphql-armor) ⭐ 581 | 🐛 32 | 🌐 TypeScript | 📅 2026-04-07 - An instant security layer for production GraphQL Endpoints.
...
* [supertest-graphql](https://github.com/alexstrat/supertest-graphql) ⭐ 34 | 🐛 12 | 🌐 TypeScript | 📅 2023-01-24 - Extends [supertest](https://github.com/visionmedia/supertest) ⭐ 14,345 | 🐛 184 | 🌐 JavaScript | 📅 2026-04-02 to easily test a GraphQL endpoint
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 138,728 | 🐛 3,706 | 🌐 JavaScript | 📅 2026-04-08 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
* [React Starter Kit](https://github.com/kriasoft/react-starter-kit) ⭐ 23,552 | 🐛 9 | 🌐 TypeScript | 📅 2026-03-02 - front-end starter kit using React, Relay, GraphQL, and JAM stack architecture.
...
* [NAPERG](https://github.com/alan345/naperg) ⭐ 1,384 | 🐛 1 | 🌐 TypeScript | 📅 2026-04-06 - Fullstack Boilerplate GraphQL. Made with React & Prisma + authentication & roles.
...
* [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,430 | 🐛 77 | 🌐 Ruby | 📅 2026-04-07 - Ruby implementation of Facebook's GraphQL.
* [graphql-batch](https://github.com/Shopify/graphql-batch) ⭐ 1,437 | 🐛 18 | 🌐 Ruby | 📅 2026-04-06 - A query batching executor for the graphql gem.
...
* [wp-graphql](https://github.com/wp-graphql/wp-graphql) ⭐ 3,779 | 🐛 101 | 🌐 PHP | 📅 2026-04-07 - GraphQL API for WordPress.
* [lighthouse](https://github.com/nuwave/lighthouse) ⭐ 3,485 | 🐛 132 | 🌐 PHP | 📅 2026-03-30 - A PHP package that allows to serve a GraphQL endpoint from your Laravel application.
...
* [graphqlite](https://github.com/thecodingmachine/graphqlite) ⭐ 572 | 🐛 38 | 🌐 MDX | 📅 2026-04-07 - Framework agnostic library that allows you to write GraphQL server by annotating your PHP classes.
...
* [strawberry](https://github.com/strawberry-graphql/strawberry) ⭐ 4,640 | 🐛 445 | 🌐 Python | 📅 2026-04-07 - A new GraphQL library for Python.
...
* [Ariadne](https://github.com/mirumee/ariadne) ⭐ 2,334 | 🐛 27 | 🌐 Python | 📅 2026-04-07 - library for implementing GraphQL servers using schema-first approach. Asynchronous query execution, batteries included for ASGI, WSGI and popular webframeworks, [fully documented](https://ariadnegraphql.org).
...
* [django-graphql-auth](https://github.com/PedroBern/django-graphql-auth) ⭐ 330 | 🐛 73 | 🌐 Python | 📅 2024-08-06 - Django registration and authentication with GraphQL.
...
* [graphql-java](https://github.com/graphql-java/graphql-java) ⭐ 6,236 | 🐛 52 | 🌐 Java | 📅 2026-04-05 - GraphQL Java implementation.
...
* [graphql-java-codegen-maven-plugin](https://github.com/kobylynskyi/graphql-java-codegen-maven-plugin) ⭐ 17 | 🐛 0 | 📅 2020-04-09 - Schema-first maven plugin for generating Java types and Resolver interfaces. Works perfectly in conjunction with graphql-java-tools. Inspired by [swagger-codegen-maven-plugin](https://github.com/swagger-api/swagger-codegen/tree/master/modules/swagger-codegen-maven-plugin) ⭐ 17,725 | 🐛 3,445 | 🌐 Mustache | 📅 2026-03-14.
...
* [graphql-java-extended-scalars](https://github.com/graphql-java/graphql-java-extended-scalars) ⭐ 283 | 🐛 3 | 🌐 Java | 📅 2026-03-09 - Extended scalars for graphql-java.
...
* [libgraphqlparser](https://github.com/graphql/libgraphqlparser) ⭐ 1,103 | 🐛 39 | 🌐 C++ | 📅 2025-10-02 - A GraphQL query parser in C++ with C and C++ APIs.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,703 | 🐛 387 | 🌐 Go | 📅 2026-04-07 - Go generate based graphql server library.
...
* [graphjin](https://github.com/dosco/graphjin) ⭐ 3,042 | 🐛 20 | 🌐 Go | 📅 2026-04-05: Build APIs in 5 minutes with GraphQL. An instant GraphQL to SQL compiler.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 819 | 🐛 44 | 🌐 Go | 📅 2026-04-07 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
* [sangria](https://github.com/sangria-graphql/sangria) ⭐ 1,964 | 🐛 63 | 🌐 Scala | 📅 2026-03-28 - Scala GraphQL server implementation.
* [caliban](https://github.com/ghostdogpr/caliban) ⭐ 992 | 🐛 27 | 🌐 Scala | 📅 2026-04-08 - Caliban is a purely functional library for creating GraphQL backends in Scala.
...
* [graphql-dotnet](https://github.com/graphql-dotnet/graphql-dotnet) ⭐ 5,978 | 🐛 113 | 🌐 C# | 📅 2026-03-27 - GraphQL for .NET.
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,683 | 🐛 361 | 🌐 C# | 📅 2026-04-07 - GraphQL server for .Net Core and .NET Framework.
* [graphql-net](https://github.com/ckimes89/graphql-net) ⭐ 887 | 🐛 43 | 🌐 C# | 📅 2022-06-22 - GraphQL to IQueryable for .NET.
* [EntityGraphQL](https://github.com/EntityGraphQL/EntityGraphQL) ⭐ 453 | 🐛 22 | 🌐 C# | 📅 2026-03-30 - library to build a GraphQL API on top of data model with the extensibility to bring multiple data sources together in the single GraphQL schema.
* [ZeroQL](https://github.com/byme8/ZeroQL) ⭐ 319 | 🐛 11 | 🌐 C# | 📅 2025-12-28 - type-safe GraphQL client with Linq-like interface for C#
* [Snowflaqe](https://github.com/Zaid-Ajaj/Snowflaqe) ⭐ 160 | 🐛 22 | 🌐 F# | 📅 2024-10-10 - Type-safe GraphQL code generator for F# and [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,069 | 🐛 220 | 🌐 F# | 📅 2026-04-08
...
* [absinthe-graphql](https://github.com/absinthe-graphql/absinthe) ⭐ 4,404 | 🐛 69 | 🌐 Elixir | 📅 2026-04-03 - Fully Featured Elixir GraphQL Library.
...
* [graphql\_parser](https://github.com/graphql-elixir/graphql_parser) ⭐ 23 | 🐛 3 | 🌐 Elixir | 📅 2023-07-02 - Elixir bindings for [libgraphqlparser](https://github.com/graphql/libgraphqlparser) ⭐ 1,103 | 🐛 39 | 🌐 C++ | 📅 2025-10-02
...
* [Hasura](https://github.com/hasura/graphql-engine) ⭐ 31,932 | 🐛 2,376 | 🌐 TypeScript | 📅 2026-04-07 - Hasura gives Instant Realtime GraphQL APIs over PostgreSQL. Works with an existing database too.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,919 | 🐛 153 | 🌐 TypeScript | 📅 2026-04-08 - Lightning-fast GraphQL APIs for PostgreSQL: highly customisable; extensible via plugins; realtime.
...
* [elm-graphql](https://github.com/dillonkearns/elm-graphql) ⭐ 787 | 🐛 39 | 🌐 Elm | 📅 2026-02-14 - GraphQL for Elm.
...
* [GraphQL](https://github.com/GraphQLSwift/GraphQL) ⭐ 962 | 🐛 7 | 🌐 Swift | 📅 2026-04-06 - The Swift implementation for GraphQL.
...
* [apollo-android](https://github.com/apollographql/apollo-android) ⭐ 3,954 | 🐛 116 | 🌐 Kotlin | 📅 2026-04-08 - 📟 A strongly-typed, caching GraphQL client for Android, written in Java.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,730 | 🐛 108 | 🌐 Java | 📅 2026-03-08 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [juniper](https://github.com/graphql-rust/juniper) ⭐ 5,952 | 🐛 103 | 🌐 Rust | 📅 2026-03-19 - GraphQL server library for Rust.
...
* [graphql-crystal](https://github.com/ziprandom/graphql-crystal) ⭐ 213 | 🐛 9 | 🌐 Crystal | 📅 2020-07-01 - library inspired by [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,430 | 🐛 77 | 🌐 Ruby | 📅 2026-04-07 & [go-graphql](https://github.com/playlyfe/go-graphql) ⭐ 246 | 🐛 18 | 🌐 Go | 📅 2020-01-22 & [graphql-parser](https://github.com/graphql-dotnet/parser) ⭐ 220 | 🐛 8 | 🌐 C# | 📅 2026-03-27.
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 42,720 | 🐛 1,609 | 🌐 JavaScript | 📅 2026-04-07 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
...
* [Altair GraphQL Client](https://github.com/altair-graphql/altair) ⭐ 5,400 | 🐛 56 | 🌐 TypeScript | 📅 2026-04-07 - A beautiful feature-rich GraphQL Client for all platforms.
...
* [mockd](https://github.com/getmockd/mockd) ⭐ 111 | 🐛 5 | 🌐 Go | 📅 2026-04-03 - Multi-protocol mock server with GraphQL schema mocking, resolver configuration, and query validation. Also supports HTTP, gRPC, WebSocket, MQTT, and SOAP.
* [graphql-to-karate](https://github.com/wbaldoumas/graphql-to-karate) ⭐ 16 | 🐛 3 | 🌐 C# | 📅 2026-04-07 - **Generate Karate API tests** from your GraphQL schemas
...
* [InQL Scanner](https://github.com/doyensec/inql) ⭐ 1,757 | 🐛 35 | 🌐 Kotlin | 📅 2026-02-16 - A Burp Extension for GraphQL Security Testing
* [GraphQL Cop](https://github.com/dolevf/graphql-cop) ⭐ 634 | 🐛 1 | 🌐 Python | 📅 2025-11-20 - Security Audit Utility for GraphQL
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 45,706 | 🐛 2,550 | 🌐 TypeScript | 📅 2026-04-07 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.
* [Bit](https://github.com/teambit/bit) ⭐ 18,374 | 🐛 69 | 🌐 TypeScript | 📅 2026-04-08 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).
* [amplication](https://github.com/amplication/amplication) ⭐ 15,995 | 🐛 621 | 🌐 TypeScript | 📅 2026-04-06: Amplication is an open‑source low code development tool. It builds database applications with REST API and GraphQL for CRUD with relations, sorting, filtering, pagination.
...
* [json-graphql-server](https://github.com/marmelab/json-graphql-server) ⭐ 1,956 | 🐛 11 | 🌐 JavaScript | 📅 2026-04-07 - Get a full fake GraphQL API with zero coding in less than 30 seconds, based on a JSON data file.
...
* [ts-graphql-plugin](https://github.com/Quramy/ts-graphql-plugin) ⭐ 757 | 🐛 21 | 🌐 TypeScript | 📅 2026-04-08 - A language service plugin complete and validate GraphQL query in TypeScript template strings.
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 19,770 | 🐛 931 | 🌐 Rust | 📅 2026-04-08
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 15,982 | 🐛 550 | 🌐 Go | 📅 2026-04-08 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 22,775 | 🐛 242 | 🌐 Python | 📅 2026-04-07 - GraphQL-first headless e-commerce platform.
