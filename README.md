...
* [GraphQL](https://github.com/graphql/graphql-spec) ⭐ 14,783 | 🐛 208 | 🌐 JavaScript | 📅 2026-02-11 - Working draft of the specification for GraphQL.
...
* [GraphQL APIs](https://github.com/APIs-guru/graphql-apis) ⭐ 4,645 | 🐛 1 | 📅 2024-09-26 - A collective list of public GraphQL APIs.
...
* [graphql-js](https://github.com/graphql/graphql-js) ⭐ 20,332 | 🐛 160 | 🌐 TypeScript | 📅 2026-02-11 - A reference implementation of GraphQL for JavaScript.
...
* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,726 | 🐛 431 | 🌐 TypeScript | 📅 2026-02-12 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
* [aws-amplify](https://github.com/aws-amplify/amplify-js) ⭐ 9,591 | 🐛 476 | 🌐 TypeScript | 📅 2026-02-12 - A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.
* [graphql-request](https://github.com/prisma-labs/graphql-request) ⭐ 6,120 | 🐛 44 | 🌐 TypeScript | 📅 2025-12-15 - A minimal GraphQL client for Node and browsers.
...
* [gqty](https://github.com/gqty-dev/gqty) ⭐ 1,033 | 🐛 51 | 🌐 TypeScript | 📅 2026-02-12 - A No GraphQL client for TypeScript
* [genql](https://github.com/remorses/genql) ⭐ 963 | 🐛 9 | 🌐 TypeScript | 📅 2026-02-01 - Type safe TypeScript client for any GraphQL API.
...
* [vue-apollo](https://github.com/vuejs/vue-apollo) ⭐ 6,059 | 🐛 275 | 🌐 TypeScript | 📅 2026-02-03 - Apollo/GraphQL integration for VueJS.
...
* [sveltekit-kitql](https://github.com/jycouet/kitql) ⭐ 452 | 🐛 13 | 🌐 TypeScript | 📅 2026-02-12 - A set of tools, helping you building efficient apps in a fast way with SvelteKit and GraphQL.
...
* [relay](https://github.com/facebook/relay) ⭐ 18,934 | 🐛 806 | 🌐 Rust | 📅 2026-02-13 - Relay is a JavaScript framework for building data-driven React applications.
...
* [@gqty/react](https://github.com/gqty-dev/gqty) ⭐ 1,033 | 🐛 51 | 🌐 TypeScript | 📅 2026-02-12 - A No GraphQL client for TypeScript
...
* [apollo-server](https://github.com/apollographql/apollo-server) ⭐ 13,948 | 🐛 78 | 🌐 TypeScript | 📅 2026-02-10 - Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
* [graphql-yoga](https://github.com/prisma-labs/graphql-yoga) ⭐ 8,478 | 🐛 133 | 🌐 TypeScript | 📅 2026-02-11 - Fully-featured GraphQL Server with focus on easy setup, performance and great developer experience.
* [mercurius](https://github.com/mercurius-js/mercurius) ⭐ 2,469 | 🐛 64 | 🌐 JavaScript | 📅 2026-02-09 - GraphQL plugin for Fastify.
...
* [pylon](https://github.com/getcronit/pylon) ⭐ 362 | 🐛 28 | 🌐 TypeScript | 📅 2026-02-06 - Write full-feature APIs with just functions. No more boilerplate code, no more setup. Just write functions and deploy.
...
* [graphql-scalars](https://github.com/Urigo/graphql-scalars) ⭐ 1,937 | 🐛 47 | 🌐 TypeScript | 📅 2026-02-12 - A library of custom GraphQL Scalars for creating precise type-safe GraphQL schemas.

#### Type

* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,217 | 🐛 624 | 🌐 TypeScript | 📅 2026-02-12: GraphQL code generator with flexible support for custom plugins and templates like TypeScript (frontend and backend), React Hooks, resolvers signatures and more.
* [type-graphql](https://github.com/19majkel94/type-graphql) ⭐ 8,094 | 🐛 113 | 🌐 TypeScript | 📅 2026-02-08 - Create GraphQL schema and resolvers with TypeScript, using classes and decorators!
* [graphql-nexus](https://github.com/graphql-nexus/nexus) ⭐ 3,427 | 🐛 255 | 🌐 TypeScript | 📅 2023-11-19 - Code-First, Type-Safe, GraphQL Schema Construction.
* [gql.tada](https://github.com/0no-co/gql.tada) ⭐ 2,912 | 🐛 26 | 🌐 TypeScript | 📅 2025-11-12 - GraphQL document authoring library, inferring the result and variables types of GraphQL queries and fragments in the TypeScript type system.
* [pothos](https://github.com/hayes/pothos) ⭐ 2,573 | 🐛 61 | 🌐 TypeScript | 📅 2026-02-11 - Pothos is a plugin based GraphQL schema builder for typescript. It makes building graphql schemas in typescript easy, fast and enjoyable.
...
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 85 | 🐛 8 | 🌐 TypeScript | 📅 2026-02-11 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,421 | 🐛 137 | 🌐 TypeScript | 📅 2026-02-05, [Zod](https://github.com/colinhacks/zod) ⭐ 41,827 | 🐛 239 | 🌐 TypeScript | 📅 2026-02-08, or [Yup](https://github.com/jquense/yup) ⭐ 23,690 | 🐛 240 | 🌐 TypeScript | 📅 2026-02-12.
...
* [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,423 | 🐛 159 | 🌐 TypeScript | 📅 2026-02-13 - Tool library for building and maintaining GraphQL-JS servers.
* [graphql-shield](https://github.com/maticzav/graphql-shield) ⭐ 3,576 | 🐛 107 | 🌐 TypeScript | 📅 2026-02-12 - A library that helps creating a permission layer for a graphql api.
* [graphql-mesh](https://github.com/urigo/graphql-mesh) ⭐ 3,485 | 🐛 221 | 🌐 TypeScript | 📅 2026-02-13 - use GraphQL query language to access data in remote APIs that don't run GraphQL (and also ones that do run GraphQL).
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,045 | 🐛 41 | 🌐 Python | 📅 2026-02-10 - Runs arbitrary queries matching a GraphQL schema to find server errors.
...
* [graphql-modules](https://github.com/Urigo/graphql-modules) ⭐ 1,329 | 🐛 56 | 🌐 TypeScript | 📅 2026-02-12 - Separate GraphQL server into smaller, reusable parts by modules or features.
...
* [graphql-config](https://github.com/kamilkisiela/graphql-config) ⭐ 1,198 | 🐛 31 | 🌐 TypeScript | 📅 2026-02-12 - One configuration for all your GraphQL tools (supported by most tools, editors & IDEs).
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,165 | 🐛 122 | 🌐 TypeScript | 📅 2026-02-12 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
...
* [sofa](https://github.com/Urigo/sofa) ⭐ 1,114 | 🐛 41 | 🌐 TypeScript | 📅 2026-02-12 - Generate REST API from your GraphQL API.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 815 | 🐛 37 | 🌐 Go | 📅 2026-02-12 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
* [GraphQL Constraint Directive](https://github.com/confuser/graphql-constraint-directive) ⭐ 577 | 🐛 44 | 🌐 JavaScript | 📅 2026-02-13 - Allows using @constraint as a directive to validate input data. Inspired by Constraints Directives RFC and OpenAPI
* [graphql-armor](https://github.com/Escape-Technologies/graphql-armor) ⭐ 568 | 🐛 29 | 🌐 TypeScript | 📅 2026-02-12 - An instant security layer for production GraphQL Endpoints.
...
* [supertest-graphql](https://github.com/alexstrat/supertest-graphql) ⭐ 34 | 🐛 12 | 🌐 TypeScript | 📅 2023-01-24 - Extends [supertest](https://github.com/visionmedia/supertest) ⭐ 14,309 | 🐛 178 | 🌐 JavaScript | 📅 2026-01-21 to easily test a GraphQL endpoint
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 137,648 | 🐛 3,332 | 🌐 JavaScript | 📅 2026-02-13 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
* [React Starter Kit](https://github.com/kriasoft/react-starter-kit) ⭐ 23,491 | 🐛 8 | 🌐 TypeScript | 📅 2026-02-09 - front-end starter kit using React, Relay, GraphQL, and JAM stack architecture.
...
* [RAN Toolkit](https://github.com/sly777/ran) ⭐ 2,208 | 🐛 88 | 🌐 JavaScript | 📅 2026-01-24 - Production-ready toolkit/boilerplate with support for GraphQL, SSR, Hot-reload, CSS-in-JS, caching, and more.
* [NAPERG](https://github.com/alan345/naperg) ⭐ 1,324 | 🐛 2 | 🌐 TypeScript | 📅 2026-02-11 - Fullstack Boilerplate GraphQL. Made with React & Prisma + authentication & roles.
...
* [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,433 | 🐛 75 | 🌐 Ruby | 📅 2026-02-09 - Ruby implementation of Facebook's GraphQL.
...
* [graphql-php](https://github.com/webonyx/graphql-php) ⭐ 4,709 | 🐛 53 | 🌐 PHP | 📅 2026-02-11 - A PHP port of GraphQL reference implementation.
* [wp-graphql](https://github.com/wp-graphql/wp-graphql) ⭐ 3,772 | 🐛 123 | 🌐 PHP | 📅 2026-02-12 - GraphQL API for WordPress.
* [lighthouse](https://github.com/nuwave/lighthouse) ⭐ 3,480 | 🐛 133 | 🌐 PHP | 📅 2026-02-11 - A PHP package that allows to serve a GraphQL endpoint from your Laravel application.
* [graphql-laravel](https://github.com/rebing/graphql-laravel) ⭐ 2,211 | 🐛 11 | 🌐 PHP | 📅 2026-02-02 - Laravel wrapper for Facebook's GraphQL.
...
* [strawberry](https://github.com/strawberry-graphql/strawberry) ⭐ 4,610 | 🐛 465 | 🌐 Python | 📅 2026-02-12 - A new GraphQL library for Python.
* [graphene-django](https://github.com/graphql-python/graphene-django) ⭐ 4,387 | 🐛 163 | 🌐 Python | 📅 2026-02-03 - A Django integration for Graphene.
* [Ariadne](https://github.com/mirumee/ariadne) ⭐ 2,317 | 🐛 38 | 🌐 Python | 📅 2026-02-12 - library for implementing GraphQL servers using schema-first approach. Asynchronous query execution, batteries included for ASGI, WSGI and popular webframeworks, [fully documented](https://ariadnegraphql.org).
...
* [federation-jvm](https://github.com/apollographql/federation-jvm) ⭐ 272 | 🐛 22 | 🌐 Java | 📅 2026-02-12 - Apollo Federation on the JVM.
* [graphql-java-servlet](https://github.com/graphql-java-kickstart/graphql-java-servlet) ⭐ 225 | 🐛 23 | 🌐 Java | 📅 2026-02-12 - A framework-agnostic java servlet for exposing graphql-java query endpoints with GET, POST, and multipart uploads.
...
* [graphql-java-codegen-maven-plugin](https://github.com/kobylynskyi/graphql-java-codegen-maven-plugin) ⭐ 17 | 🐛 0 | 📅 2020-04-09 - Schema-first maven plugin for generating Java types and Resolver interfaces. Works perfectly in conjunction with graphql-java-tools. Inspired by [swagger-codegen-maven-plugin](https://github.com/swagger-api/swagger-codegen/tree/master/modules/swagger-codegen-maven-plugin) ⭐ 17,699 | 🐛 3,440 | 🌐 Mustache | 📅 2026-02-05.
* [dgs-extended-formatters](https://github.com/setchy/dgs-extended-formatters) ⭐ 6 | 🐛 4 | 🌐 Java | 📅 2026-02-10 - An experimental set of DGS Directives for common formatting use-cases.
...
* [cppgraphqlgen](https://github.com/Microsoft/cppgraphqlgen) ⭐ 344 | 🐛 14 | 🌐 C++ | 📅 2025-10-05 - C++ GraphQL schema service generator.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,662 | 🐛 381 | 🌐 Go | 📅 2026-02-11 - Go generate based graphql server library.
* [graphql](https://github.com/graphql-go/graphql) ⭐ 10,146 | 🐛 239 | 🌐 Go | 📅 2025-12-27 - An implementation of GraphQL for Go follows graphql-js
* [graphql-go](https://github.com/graph-gophers/graphql-go) ⭐ 4,740 | 🐛 21 | 🌐 Go | 📅 2026-02-04 - GraphQL server with a focus on ease of use.
* [graphjin](https://github.com/dosco/graphjin) ⭐ 3,019 | 🐛 17 | 🌐 Go | 📅 2026-02-12: Build APIs in 5 minutes with GraphQL. An instant GraphQL to SQL compiler.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 815 | 🐛 37 | 🌐 Go | 📅 2026-02-12 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
* [grpc-graphql-gateway](https://github.com/ysugimoto/grpc-graphql-gateway) ⭐ 422 | 🐛 16 | 🌐 Go | 📅 2025-06-04 - A protoc plugin that generates graphql execution code from Protocol Buffers.
  <a name="go-example" />
* [Thunder](https://github.com/Raezil/Thunder) ⭐ 119 | 🐛 6 | 🌐 Go | 📅 2025-12-05 - A scalable microservices framework powered by Go, gRPC-Gateway, Prisma, and Kubernetes. It exposes REST, gRPC and Graphql
...
* [sangria](https://github.com/sangria-graphql/sangria) ⭐ 1,963 | 🐛 64 | 🌐 Scala | 📅 2026-02-12 - Scala GraphQL server implementation.
* [caliban](https://github.com/ghostdogpr/caliban) ⭐ 984 | 🐛 27 | 🌐 Scala | 📅 2026-02-13 - Caliban is a purely functional library for creating GraphQL backends in Scala.
...
* [graphql-dotnet](https://github.com/graphql-dotnet/graphql-dotnet) ⭐ 5,984 | 🐛 112 | 🌐 C# | 📅 2026-02-11 - GraphQL for .NET.
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,676 | 🐛 482 | 🌐 C# | 📅 2026-02-12 - GraphQL server for .Net Core and .NET Framework.
...
* [Snowflaqe](https://github.com/Zaid-Ajaj/Snowflaqe) ⭐ 161 | 🐛 22 | 🌐 F# | 📅 2024-10-10 - Type-safe GraphQL code generator for F# and [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,060 | 🐛 233 | 🌐 F# | 📅 2026-02-12
...
* [absinthe-graphql](https://github.com/absinthe-graphql/absinthe) ⭐ 4,395 | 🐛 74 | 🌐 Elixir | 📅 2026-02-09 - Fully Featured Elixir GraphQL Library.
...
* [morpheus-graphql](https://github.com/morpheusgraphql/morpheus-graphql) ⭐ 416 | 🐛 13 | 🌐 Haskell | 📅 2026-02-08 - Haskell GraphQL Api, Client and Tools.
...
* [Hasura](https://github.com/hasura/graphql-engine) ⭐ 31,899 | 🐛 2,375 | 🌐 TypeScript | 📅 2026-02-12 - Hasura gives Instant Realtime GraphQL APIs over PostgreSQL. Works with an existing database too.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,902 | 🐛 143 | 🌐 TypeScript | 📅 2026-02-11 - Lightning-fast GraphQL APIs for PostgreSQL: highly customisable; extensible via plugins; realtime.
...
* [apollo-android](https://github.com/apollographql/apollo-android) ⭐ 3,947 | 🐛 110 | 🌐 Kotlin | 📅 2026-02-13 - 📟 A strongly-typed, caching GraphQL client for Android, written in Java.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,707 | 🐛 109 | 🌐 Java | 📅 2026-02-11 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [juniper](https://github.com/graphql-rust/juniper) ⭐ 5,941 | 🐛 102 | 🌐 Rust | 📅 2026-02-10 - GraphQL server library for Rust.
* [async-graphql](https://github.com/async-graphql/async-graphql) ⭐ 3,627 | 🐛 240 | 🌐 Rust | 📅 2026-02-06 - High-performance server-side library that supports all GraphQL specifications.
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 40,841 | 🐛 1,702 | 🌐 JavaScript | 📅 2026-02-12 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,791 | 🐛 403 | 🌐 TypeScript | 📅 2026-02-07 - An in-browser IDE for exploring GraphQL.
* [GraphQL Voyager](https://github.com/APIs-guru/graphql-voyager) ⭐ 8,086 | 🐛 103 | 🌐 TypeScript | 📅 2026-02-02 - Represent any GraphQL API as an interactive graph.
* [GraphQL Editor](https://github.com/graphql-editor/graphql-editor) ⭐ 6,074 | 🐛 20 | 🌐 TypeScript | 📅 2025-09-10 - Visual Editor & GraphQL IDE.
* [Altair GraphQL Client](https://github.com/altair-graphql/altair) ⭐ 5,393 | 🐛 65 | 🌐 TypeScript | 📅 2026-02-11 - A beautiful feature-rich GraphQL Client for all platforms.
...
* [GraphQL Faker](https://github.com/APIs-guru/graphql-faker) ⭐ 2,711 | 🐛 79 | 🌐 TypeScript | 📅 2023-11-24 - 🎲 Mock or extend your GraphQL API with faked data. No coding required.
* [graphql-to-karate](https://github.com/wbaldoumas/graphql-to-karate) ⭐ 16 | 🐛 3 | 🌐 C# | 📅 2026-02-10 - **Generate Karate API tests** from your GraphQL schemas
...
* [InQL Scanner](https://github.com/doyensec/inql) ⭐ 1,728 | 🐛 34 | 🌐 Kotlin | 📅 2026-02-12 - A Burp Extension for GraphQL Security Testing
...
* [GraphQLer](https://github.com/omar2535/GraphQLer) ⭐ 157 | 🐛 18 | 🌐 Python | 📅 2026-02-11 - Dependency-aware dynamic GraphQL testing tool
...
* [Apollo Client Developer Tools](https://github.com/apollographql/apollo-client-devtools) ⭐ 1,522 | 🐛 52 | 🌐 TypeScript | 📅 2026-02-11 - GraphQL debugging tools for Apollo Client in the Chrome developer console
...
* [spectaql](https://github.com/anvilco/spectaql) ⭐ 1,219 | 🐛 88 | 🌐 JavaScript | 📅 2026-02-12 - Autogenerate static GraphQL API documentation.
...
* [js-graphql-intellij-plugin](https://github.com/jimkyndemeyer/js-graphql-intellij-plugin/) ⭐ 893 | 🐛 156 | 🌐 Java | 📅 2026-02-11 - GraphQL language support for IntelliJ IDEA and WebStorm, including Relay.QL tagged templates in JavaScript and TypeScript.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 45,296 | 🐛 2,476 | 🌐 TypeScript | 📅 2026-02-11 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.
* [Bit](https://github.com/teambit/bit) ⭐ 18,351 | 🐛 64 | 🌐 TypeScript | 📅 2026-02-12 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).
* [amplication](https://github.com/amplication/amplication) ⭐ 16,007 | 🐛 625 | 🌐 TypeScript | 📅 2026-02-13: Amplication is an open‑source low code development tool. It builds database applications with REST API and GraphQL for CRUD with relations, sorting, filtering, pagination.
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,217 | 🐛 624 | 🌐 TypeScript | 📅 2026-02-12 - GraphQL code generator based on schema and documents.
...
* [raphql-inspector](https://github.com/kamilkisiela/graphql-inspector) ⭐ 1,737 | 🐛 133 | 🌐 TypeScript | 📅 2026-02-12: alidate schema, get schema change notifications, validate operations, find breaking changes, look for similar types, schema coverage.
* [openapi-to-graphql](https://github.com/ibm/openapi-to-graphql) ⭐ 1,644 | 🐛 141 | 🌐 TypeScript | 📅 2025-09-17 - Take any OpenAPI Specification (OAS) or swagger and create a GraphQL interface - Two minute video and resources [here](https://developer.ibm.com/open/projects/openapi-to-graphql/)
...
* [ts-graphql-plugin](https://github.com/Quramy/ts-graphql-plugin) ⭐ 757 | 🐛 31 | 🌐 TypeScript | 📅 2026-02-12 - A language service plugin complete and validate GraphQL query in TypeScript template strings.
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 19,494 | 🐛 885 | 🌐 Rust | 📅 2026-02-12
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 15,581 | 🐛 586 | 🌐 Go | 📅 2026-02-12 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 22,592 | 🐛 241 | 🌐 Python | 📅 2026-02-12 - GraphQL-first headless e-commerce platform.
