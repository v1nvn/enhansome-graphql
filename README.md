...
* [GraphQL](https://github.com/graphql/graphql-spec) ⭐ 14,570 | 🐛 194 | 🌐 JavaScript | 📅 2026-06-04 - Working draft of the specification for GraphQL.
...
* [GraphQL APIs](https://github.com/APIs-guru/graphql-apis) ⭐ 4,677 | 🐛 1 | 📅 2024-09-26 - A collective list of public GraphQL APIs.
...
* [graphql-js](https://github.com/graphql/graphql-js) ⭐ 20,357 | 🐛 91 | 🌐 TypeScript | 📅 2026-06-07 - A reference implementation of GraphQL for JavaScript.
...
* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,765 | 🐛 408 | 🌐 TypeScript | 📅 2026-06-09 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
* [aws-amplify](https://github.com/aws-amplify/amplify-js) ⭐ 9,575 | 🐛 493 | 🌐 TypeScript | 📅 2026-06-04 - A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.
* [graphql-request](https://github.com/prisma-labs/graphql-request) ⭐ 6,110 | 🐛 57 | 🌐 TypeScript | 📅 2026-05-11 - A minimal GraphQL client for Node and browsers.
...
* [gqty](https://github.com/gqty-dev/gqty) ⭐ 1,035 | 🐛 56 | 🌐 TypeScript | 📅 2026-06-05 - A No GraphQL client for TypeScript
* [genql](https://github.com/remorses/genql) ⭐ 967 | 🐛 10 | 🌐 TypeScript | 📅 2026-02-01 - Type safe TypeScript client for any GraphQL API.
...
* [vue-apollo](https://github.com/vuejs/vue-apollo) ⭐ 6,041 | 🐛 278 | 🌐 TypeScript | 📅 2026-05-13 - Apollo/GraphQL integration for VueJS.
...
* [sveltekit-kitql](https://github.com/jycouet/kitql) ⭐ 454 | 🐛 12 | 🌐 TypeScript | 📅 2026-06-08 - A set of tools, helping you building efficient apps in a fast way with SvelteKit and GraphQL.
* [apollo-elements](https://github.com/apollo-elements/apollo-elements) ⭐ 422 | 🐛 9 | 🌐 TypeScript | 📅 2026-05-23 - GraphQL web components that work in any frontend framework.
...
* [relay](https://github.com/facebook/relay) ⭐ 18,941 | 🐛 842 | 🌐 Rust | 📅 2026-06-09 - Relay is a JavaScript framework for building data-driven React applications.
* [urql](https://github.com/FormidableLabs/urql) ⭐ 8,951 | 🐛 43 | 🌐 TypeScript | 📅 2026-06-06 - A simple caching GraphQL client for React.
...
* [@gqty/react](https://github.com/gqty-dev/gqty) ⭐ 1,035 | 🐛 56 | 🌐 TypeScript | 📅 2026-06-05 - A No GraphQL client for TypeScript
...
* [apollo-server](https://github.com/apollographql/apollo-server) ⭐ 13,938 | 🐛 82 | 🌐 TypeScript | 📅 2026-06-09 - Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
* [graphql-yoga](https://github.com/prisma-labs/graphql-yoga) ⭐ 8,522 | 🐛 140 | 🌐 TypeScript | 📅 2026-06-08 - Fully-featured GraphQL Server with focus on easy setup, performance and great developer experience.
...
* [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,426 | 🐛 168 | 🌐 TypeScript | 📅 2026-06-08 - Tool library for building and maintaining GraphQL-JS servers.
* [graphql-shield](https://github.com/maticzav/graphql-shield) ⭐ 3,575 | 🐛 107 | 🌐 TypeScript | 📅 2026-06-01 - A library that helps creating a permission layer for a graphql api.
...
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,352 | 🐛 18 | 🌐 Python | 📅 2026-06-09 - Runs arbitrary queries matching a GraphQL schema to find server errors.
...
* [graphql-relay-js](https://github.com/graphql/graphql-relay-js) ⭐ 1,544 | 🐛 24 | 🌐 TypeScript | 📅 2025-10-02 - A library to help construct a graphql-js server supporting react-relay.
...
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,224 | 🐛 169 | 🌐 TypeScript | 📅 2026-06-08 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
* [eslint-plugin-graphql](https://github.com/apollographql/eslint-plugin-graphql) ⭐ 1,215 | 🐛 100 | 🌐 JavaScript | 📅 2026-06-02 - An ESLint plugin that checks your GraphQL strings against a schema.
...
* [graphql-config](https://github.com/kamilkisiela/graphql-config) ⭐ 1,200 | 🐛 29 | 🌐 TypeScript | 📅 2026-03-25 - One configuration for all your GraphQL tools (supported by most tools, editors & IDEs).
* [graphql-middleware](https://github.com/maticzav/graphql-middleware) ⭐ 1,145 | 🐛 43 | 🌐 TypeScript | 📅 2026-05-12 - Split up your GraphQL resolvers in middleware functions.
* [sofa](https://github.com/Urigo/sofa) ⭐ 1,115 | 🐛 39 | 🌐 TypeScript | 📅 2026-05-28 - Generate REST API from your GraphQL API.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 821 | 🐛 39 | 🌐 Go | 📅 2026-06-08 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
* [graphql-armor](https://github.com/Escape-Technologies/graphql-armor) ⭐ 584 | 🐛 33 | 🌐 TypeScript | 📅 2026-06-08 - An instant security layer for production GraphQL Endpoints.
...
* [supertest-graphql](https://github.com/alexstrat/supertest-graphql) ⭐ 34 | 🐛 12 | 🌐 TypeScript | 📅 2023-01-24 - Extends [supertest](https://github.com/visionmedia/supertest) ⭐ 14,366 | 🐛 187 | 🌐 JavaScript | 📅 2026-04-02 to easily test a GraphQL endpoint
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 139,894 | 🐛 4,016 | 🌐 JavaScript | 📅 2026-06-09 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
* [React Starter Kit](https://github.com/kriasoft/react-starter-kit) ⭐ 23,600 | 🐛 9 | 🌐 TypeScript | 📅 2026-03-02 - front-end starter kit using React, Relay, GraphQL, and JAM stack architecture.
...
* [RAN Toolkit](https://github.com/sly777/ran) ⭐ 2,209 | 🐛 89 | 🌐 JavaScript | 📅 2026-02-14 - Production-ready toolkit/boilerplate with support for GraphQL, SSR, Hot-reload, CSS-in-JS, caching, and more.
...
* [Node.js API Starter](https://github.com/kriasoft/nodejs-api-starter) ⭐ 3,971 | 🐛 9 | 🌐 TypeScript | 📅 2024-11-10 - Yarn v2 based monorepo template (code-first GraphQL API, PostgreSQL, PnP, Zero-install, serverless).
...
* [graphql-batch](https://github.com/Shopify/graphql-batch) ⭐ 1,440 | 🐛 15 | 🌐 Ruby | 📅 2026-06-08 - A query batching executor for the graphql gem.
...
* [graphql-php](https://github.com/webonyx/graphql-php) ⭐ 4,715 | 🐛 58 | 🌐 PHP | 📅 2026-06-07 - A PHP port of GraphQL reference implementation.
* [wp-graphql](https://github.com/wp-graphql/wp-graphql) ⭐ 3,780 | 🐛 125 | 🌐 PHP | 📅 2026-06-08 - GraphQL API for WordPress.
* [lighthouse](https://github.com/nuwave/lighthouse) ⭐ 3,493 | 🐛 132 | 🌐 PHP | 📅 2026-06-07 - A PHP package that allows to serve a GraphQL endpoint from your Laravel application.
...
* [graphqlite](https://github.com/thecodingmachine/graphqlite) ⭐ 572 | 🐛 30 | 🌐 MDX | 📅 2026-06-08 - Framework agnostic library that allows you to write GraphQL server by annotating your PHP classes.
...
* [strawberry](https://github.com/strawberry-graphql/strawberry) ⭐ 4,669 | 🐛 452 | 🌐 Python | 📅 2026-06-08 - A new GraphQL library for Python.
...
* [rath](https://github.com/jhnnsrs/rath) ⭐ 10 | 🐛 4 | 🌐 Python | 📅 2026-06-08 - An apollo like graphql client with async and sync interface
...
* [graphql-java](https://github.com/graphql-java/graphql-java) ⭐ 6,233 | 🐛 40 | 🌐 Java | 📅 2026-06-07 - GraphQL Java implementation.
...
* [graphql-kotlin](https://github.com/ExpediaGroup/graphql-kotlin) ⭐ 1,804 | 🐛 84 | 🌐 Kotlin | 📅 2026-06-01 - GraphQL Kotlin implementation.
...
* [graphjin](https://github.com/dosco/graphjin) ⭐ 3,081 | 🐛 21 | 🌐 Go | 📅 2026-06-08: Build APIs in 5 minutes with GraphQL. An instant GraphQL to SQL compiler.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 821 | 🐛 39 | 🌐 Go | 📅 2026-06-08 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,707 | 🐛 405 | 🌐 C# | 📅 2026-06-08 - GraphQL server for .Net Core and .NET Framework.
* [graphql-net](https://github.com/ckimes89/graphql-net) ⭐ 884 | 🐛 43 | 🌐 C# | 📅 2022-06-22 - GraphQL to IQueryable for .NET.
* [EntityGraphQL](https://github.com/EntityGraphQL/EntityGraphQL) ⭐ 454 | 🐛 16 | 🌐 C# | 📅 2026-05-22 - library to build a GraphQL API on top of data model with the extensibility to bring multiple data sources together in the single GraphQL schema.
* [ZeroQL](https://github.com/byme8/ZeroQL) ⭐ 320 | 🐛 12 | 🌐 C# | 📅 2025-12-28 - type-safe GraphQL client with Linq-like interface for C#
* [Snowflaqe](https://github.com/Zaid-Ajaj/Snowflaqe) ⭐ 161 | 🐛 22 | 🌐 F# | 📅 2024-10-10 - Type-safe GraphQL code generator for F# and [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,088 | 🐛 211 | 🌐 F# | 📅 2026-06-08
...
* [absinthe-graphql](https://github.com/absinthe-graphql/absinthe) ⭐ 4,400 | 🐛 74 | 🌐 Elixir | 📅 2026-06-04 - Fully Featured Elixir GraphQL Library.
...
* [morpheus-graphql](https://github.com/morpheusgraphql/morpheus-graphql) ⭐ 416 | 🐛 18 | 🌐 Haskell | 📅 2026-05-18 - Haskell GraphQL Api, Client and Tools.
...
* [Hasura](https://github.com/hasura/graphql-engine) ⭐ 32,038 | 🐛 2,374 | 🌐 TypeScript | 📅 2026-06-08 - Hasura gives Instant Realtime GraphQL APIs over PostgreSQL. Works with an existing database too.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,927 | 🐛 155 | 🌐 TypeScript | 📅 2026-06-08 - Lightning-fast GraphQL APIs for PostgreSQL: highly customisable; extensible via plugins; realtime.
...
* [apollo-android](https://github.com/apollographql/apollo-android) ⭐ 3,951 | 🐛 116 | 🌐 Kotlin | 📅 2026-06-09 - 📟 A strongly-typed, caching GraphQL client for Android, written in Java.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,746 | 🐛 110 | 🌐 Java | 📅 2026-05-24 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [apollo-ios](https://github.com/apollographql/apollo-ios) ⭐ 4,032 | 🐛 91 | 🌐 Swift | 📅 2026-06-02 - 📱 A strongly-typed, caching GraphQL client for iOS, written in Swift.
...
* [async-graphql](https://github.com/async-graphql/async-graphql) ⭐ 3,666 | 🐛 246 | 🌐 Rust | 📅 2026-04-21 - High-performance server-side library that supports all GraphQL specifications.
* [tailcall](https://github.com/tailcallhq/tailcall) ⭐ 1,440 | 🐛 20 | 🌐 Rust | 📅 2026-06-08 - A platform for building high-performance GraphQL backends.
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 44,768 | 🐛 1,692 | 🌐 JavaScript | 📅 2026-06-09 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,841 | 🐛 387 | 🌐 TypeScript | 📅 2026-06-08 - An in-browser IDE for exploring GraphQL.
* [GraphQL Voyager](https://github.com/APIs-guru/graphql-voyager) ⭐ 8,139 | 🐛 106 | 🌐 TypeScript | 📅 2026-05-12 - Represent any GraphQL API as an interactive graph.
* [GraphQL Editor](https://github.com/graphql-editor/graphql-editor) ⭐ 6,067 | 🐛 20 | 🌐 TypeScript | 📅 2025-09-10 - Visual Editor & GraphQL IDE.
* [Altair GraphQL Client](https://github.com/altair-graphql/altair) ⭐ 5,411 | 🐛 159 | 🌐 TypeScript | 📅 2026-06-06 - A beautiful feature-rich GraphQL Client for all platforms.
...
* [Apollo Client Developer Tools](https://github.com/apollographql/apollo-client-devtools) ⭐ 1,524 | 🐛 56 | 🌐 TypeScript | 📅 2026-06-08 - GraphQL debugging tools for Apollo Client in the Chrome developer console
...
* [spectaql](https://github.com/anvilco/spectaql) ⭐ 1,224 | 🐛 93 | 🌐 JavaScript | 📅 2026-05-28 - Autogenerate static GraphQL API documentation.
...
* [vim-graphql](https://github.com/jparise/vim-graphql) ⭐ 510 | 🐛 0 | 🌐 Vim Script | 📅 2026-04-14 - A Vim plugin that provides GraphQL file detection and syntax highlighting.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 46,240 | 🐛 2,615 | 🌐 TypeScript | 📅 2026-06-08 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.
* [Bit](https://github.com/teambit/bit) ⭐ 18,408 | 🐛 82 | 🌐 TypeScript | 📅 2026-06-08 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).
* [amplication](https://github.com/amplication/amplication) ⭐ 16,010 | 🐛 651 | 🌐 TypeScript | 📅 2026-06-05: Amplication is an open‑source low code development tool. It builds database applications with REST API and GraphQL for CRUD with relations, sorting, filtering, pagination.
...
* [json-graphql-server](https://github.com/marmelab/json-graphql-server) ⭐ 1,950 | 🐛 5 | 🌐 JavaScript | 📅 2026-06-02 - Get a full fake GraphQL API with zero coding in less than 30 seconds, based on a JSON data file.
* [raphql-inspector](https://github.com/kamilkisiela/graphql-inspector) ⭐ 1,751 | 🐛 135 | 🌐 TypeScript | 📅 2026-04-30: alidate schema, get schema change notifications, validate operations, find breaking changes, look for similar types, schema coverage.
...
* [ts-graphql-plugin](https://github.com/Quramy/ts-graphql-plugin) ⭐ 755 | 🐛 30 | 🌐 TypeScript | 📅 2026-06-08 - A language service plugin complete and validate GraphQL query in TypeScript template strings.
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 20,117 | 🐛 1,012 | 🌐 Rust | 📅 2026-06-09
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 16,300 | 🐛 514 | 🌐 Go | 📅 2026-06-08 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 22,962 | 🐛 250 | 🌐 Python | 📅 2026-06-08 - GraphQL-first headless e-commerce platform.
