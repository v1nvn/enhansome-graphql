...
* [GraphQL](https://github.com/graphql/graphql-spec) ⭐ 14,572 | 🐛 196 | 🌐 JavaScript | 📅 2026-06-10 - Working draft of the specification for GraphQL.
* [GraphQL over HTTP](https://github.com/graphql/graphql-over-http) ⭐ 424 | 🐛 31 | 🌐 JavaScript | 📅 2026-06-10 - Working draft of "GraphQL over HTTP" specification.
...
* [GraphQL APIs](https://github.com/APIs-guru/graphql-apis) ⭐ 4,679 | 🐛 2 | 📅 2024-09-26 - A collective list of public GraphQL APIs.
...
* [graphql-js](https://github.com/graphql/graphql-js) ⭐ 20,371 | 🐛 88 | 🌐 TypeScript | 📅 2026-06-12 - A reference implementation of GraphQL for JavaScript.
* [graphql-jit](https://github.com/zalando-incubator/graphql-jit) ⭐ 1,084 | 🐛 31 | 🌐 TypeScript | 📅 2026-05-28 - GraphQL execution using a JIT compiler.
* [Gra*fast*](https://grafast.org) - a cutting edge planning and execution engine for GraphQL.

#### Clients

* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,776 | 🐛 410 | 🌐 TypeScript | 📅 2026-06-11 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
* [aws-amplify](https://github.com/aws-amplify/amplify-js) ⭐ 9,572 | 🐛 492 | 🌐 TypeScript | 📅 2026-06-12 - A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.
* [graphql-request](https://github.com/prisma-labs/graphql-request) ⭐ 6,113 | 🐛 57 | 🌐 TypeScript | 📅 2026-05-11 - A minimal GraphQL client for Node and browsers.
* [graphqurl](https://github.com/hasura/graphqurl) ⭐ 3,382 | 🐛 43 | 🌐 JavaScript | 📅 2025-02-13 - curl for GraphQL with autocomplete, subscriptions and GraphiQL. Also a dead-simple universal javascript GraphQL client.
* [graphql-zeus](https://github.com/graphql-editor/graphql-zeus) ⭐ 1,975 | 🐛 57 | 🌐 TypeScript | 📅 2026-04-07 - GraphQL Zeus creates autocomplete client library for `JavaScript` or `TypeScript` which provides autocompletion for strongly typed queries.
* [gqty](https://github.com/gqty-dev/gqty) ⭐ 1,035 | 🐛 56 | 🌐 TypeScript | 📅 2026-06-12 - A No GraphQL client for TypeScript
* [genql](https://github.com/remorses/genql) ⭐ 967 | 🐛 8 | 🌐 TypeScript | 📅 2026-06-11 - Type safe TypeScript client for any GraphQL API.
...
* [vue-apollo](https://github.com/vuejs/vue-apollo) ⭐ 6,042 | 🐛 278 | 🌐 TypeScript | 📅 2026-05-13 - Apollo/GraphQL integration for VueJS.
* [apollo-angular](https://github.com/kamilkisiela/apollo-angular) ⭐ 1,516 | 🐛 20 | 🌐 TypeScript | 📅 2026-06-09 - A fully-featured, production ready caching GraphQL client for Angular and every GraphQL server.
* [svelte-apollo](https://github.com/timhall/svelte-apollo) ⭐ 948 | 🐛 33 | 🌐 TypeScript | 📅 2023-08-03 - Svelte integration for Apollo GraphQL.
* [sveltekit-kitql](https://github.com/jycouet/kitql) ⭐ 454 | 🐛 12 | 🌐 TypeScript | 📅 2026-06-11 - A set of tools, helping you building efficient apps in a fast way with SvelteKit and GraphQL.
* [apollo-elements](https://github.com/apollo-elements/apollo-elements) ⭐ 422 | 🐛 12 | 🌐 TypeScript | 📅 2026-06-13 - GraphQL web components that work in any frontend framework.
...
* [relay](https://github.com/facebook/relay) ⭐ 18,941 | 🐛 846 | 🌐 Rust | 📅 2026-06-13 - Relay is a JavaScript framework for building data-driven React applications.
* [urql](https://github.com/FormidableLabs/urql) ⭐ 8,953 | 🐛 47 | 🌐 TypeScript | 📅 2026-06-13 - A simple caching GraphQL client for React.
* [graphql-hooks](https://github.com/nearform/graphql-hooks) ⭐ 1,887 | 🐛 9 | 🌐 TypeScript | 📅 2026-01-26 - Minimal hooks-first GraphQL client with caching and server-side rendering support.
* [@gqty/react](https://github.com/gqty-dev/gqty) ⭐ 1,035 | 🐛 56 | 🌐 TypeScript | 📅 2026-06-12 - A No GraphQL client for TypeScript
...
* [apollo-server](https://github.com/apollographql/apollo-server) ⭐ 13,939 | 🐛 84 | 🌐 TypeScript | 📅 2026-06-13 - Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
* [graphql-yoga](https://github.com/prisma-labs/graphql-yoga) ⭐ 8,522 | 🐛 142 | 🌐 TypeScript | 📅 2026-06-12 - Fully-featured GraphQL Server with focus on easy setup, performance and great developer experience.
* [mercurius](https://github.com/mercurius-js/mercurius) ⭐ 2,480 | 🐛 65 | 🌐 JavaScript | 📅 2026-06-02 - GraphQL plugin for Fastify.
* [koa-graphql](https://github.com/chentsulin/koa-graphql) ⭐ 839 | 🐛 6 | 🌐 TypeScript | 📅 2023-01-24 - GraphQL Koa Middleware.
...
* [pylon](https://github.com/getcronit/pylon) ⭐ 371 | 🐛 27 | 🌐 TypeScript | 📅 2026-06-02 - Write full-feature APIs with just functions. No more boilerplate code, no more setup. Just write functions and deploy.
* [gql](https://github.com/deno-libs/gql) ⭐ 203 | 🐛 0 | 🌐 TypeScript | 📅 2026-01-20 - Universal GraphQL HTTP middleware for Deno.
* [graphitejs](https://github.com/graphitejs/server) ⭐ 122 | 🐛 18 | 🌐 JavaScript | 📅 2026-06-12 - Framework NodeJS for GraphQL.
...
* [join-monster](https://github.com/acarl005/join-monster) ⭐ 2,702 | 🐛 32 | 🌐 JavaScript | 📅 2025-08-06 - A GraphQL-to-SQL query execution layer for batch data fetching.
...
* [graphql-scalars](https://github.com/Urigo/graphql-scalars) ⭐ 1,935 | 🐛 44 | 🌐 TypeScript | 📅 2026-06-10 - A library of custom GraphQL Scalars for creating precise type-safe GraphQL schemas.

#### Type

* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,256 | 🐛 563 | 🌐 TypeScript | 📅 2026-06-03: GraphQL code generator with flexible support for custom plugins and templates like TypeScript (frontend and backend), React Hooks, resolvers signatures and more.
* [type-graphql](https://github.com/19majkel94/type-graphql) ⭐ 8,089 | 🐛 117 | 🌐 TypeScript | 📅 2026-05-11 - Create GraphQL schema and resolvers with TypeScript, using classes and decorators!
* [graphql-nexus](https://github.com/graphql-nexus/nexus) ⭐ 3,433 | 🐛 254 | 🌐 TypeScript | 📅 2023-11-19 - Code-First, Type-Safe, GraphQL Schema Construction.
* [gql.tada](https://github.com/0no-co/gql.tada) ⭐ 2,936 | 🐛 19 | 🌐 TypeScript | 📅 2026-06-13 - GraphQL document authoring library, inferring the result and variables types of GraphQL queries and fragments in the TypeScript type system.
* [pothos](https://github.com/hayes/pothos) ⭐ 2,596 | 🐛 65 | 🌐 TypeScript | 📅 2026-05-21 - Pothos is a plugin based GraphQL schema builder for typescript. It makes building graphql schemas in typescript easy, fast and enjoyable.
* [garph](https://github.com/stepci/garph) ⭐ 1,313 | 🐛 27 | 🌐 TypeScript | 📅 2024-03-01 - Garph is full-stack framework for building type-safe GraphQL APIs in TypeScript.
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 99 | 🐛 7 | 🌐 TypeScript | 📅 2026-06-09 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,753 | 🐛 124 | 🌐 TypeScript | 📅 2026-06-08, [Zod](https://github.com/colinhacks/zod) ⭐ 42,954 | 🐛 201 | 🌐 TypeScript | 📅 2026-06-13, or [Yup](https://github.com/jquense/yup) ⭐ 23,675 | 🐛 242 | 🌐 TypeScript | 📅 2026-06-12.
...
* [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,426 | 🐛 172 | 🌐 TypeScript | 📅 2026-06-11 - Tool library for building and maintaining GraphQL-JS servers.
* [graphql-shield](https://github.com/maticzav/graphql-shield) ⭐ 3,574 | 🐛 107 | 🌐 TypeScript | 📅 2026-06-11 - A library that helps creating a permission layer for a graphql api.
* [graphql-mesh](https://github.com/urigo/graphql-mesh) ⭐ 3,503 | 🐛 231 | 🌐 TypeScript | 📅 2026-06-12 - use GraphQL query language to access data in remote APIs that don't run GraphQL (and also ones that do run GraphQL).
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,369 | 🐛 17 | 🌐 Python | 📅 2026-06-11 - Runs arbitrary queries matching a GraphQL schema to find server errors.
* [graphql-tag](https://github.com/apollographql/graphql-tag) ⭐ 2,332 | 🐛 99 | 🌐 TypeScript | 📅 2024-01-25 - A JavaScript template literal tag that parses GraphQL queries.
* [graphql-cli](https://github.com/urigo/graphql-cli) ⭐ 2,020 | 🐛 48 | 🌐 TypeScript | 📅 2026-06-02 - A command line tool for common GraphQL development workflows.
* [graphql-ws](https://github.com/enisdenjo/graphql-ws) ⭐ 1,866 | 🐛 11 | 🌐 TypeScript | 📅 2026-03-26 - Coherent, zero-dependency, lazy, simple, GraphQL over WebSocket Protocol compliant server and client.
...
* [graphql-modules](https://github.com/Urigo/graphql-modules) ⭐ 1,328 | 🐛 51 | 🌐 TypeScript | 📅 2026-05-26 - Separate GraphQL server into smaller, reusable parts by modules or features.
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,225 | 🐛 174 | 🌐 TypeScript | 📅 2026-06-13 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
* [eslint-plugin-graphql](https://github.com/apollographql/eslint-plugin-graphql) ⭐ 1,215 | 🐛 100 | 🌐 JavaScript | 📅 2026-06-12 - An ESLint plugin that checks your GraphQL strings against a schema.
...
* [graphql-config](https://github.com/kamilkisiela/graphql-config) ⭐ 1,199 | 🐛 29 | 🌐 TypeScript | 📅 2026-03-25 - One configuration for all your GraphQL tools (supported by most tools, editors & IDEs).
* [graphql-middleware](https://github.com/maticzav/graphql-middleware) ⭐ 1,144 | 🐛 43 | 🌐 TypeScript | 📅 2026-05-12 - Split up your GraphQL resolvers in middleware functions.
* [sofa](https://github.com/Urigo/sofa) ⭐ 1,115 | 🐛 39 | 🌐 TypeScript | 📅 2026-05-28 - Generate REST API from your GraphQL API.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 821 | 🐛 40 | 🌐 Go | 📅 2026-06-12 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
* [graphql-armor](https://github.com/Escape-Technologies/graphql-armor) ⭐ 585 | 🐛 33 | 🌐 TypeScript | 📅 2026-06-12 - An instant security layer for production GraphQL Endpoints.
* [GraphQL Constraint Directive](https://github.com/confuser/graphql-constraint-directive) ⭐ 576 | 🐛 42 | 🌐 JavaScript | 📅 2026-05-28 - Allows using @constraint as a directive to validate input data. Inspired by Constraints Directives RFC and OpenAPI
* [graphql-let](https://github.com/piglovesyou/graphql-let) ⭐ 451 | 🐛 64 | 🌐 TypeScript | 📅 2026-05-28 - A webpack loader to import type-protected codegen results directly from GraphQL documents
* [graphql-live-query](https://github.com/n1ru4l/graphql-live-query) ⭐ 439 | 🐛 51 | 🌐 TypeScript | 📅 2026-06-11 - Realtime GraphQL Live Queries with JavaScript.
...
* [goctopus](https://github.com/Escape-Technologies/goctopus) ⭐ 131 | 🐛 3 | 🌐 Go | 📅 2023-11-21 - an incredibly fast GraphQL discovery & fingerprinting toolbox.
...
* [supertest-graphql](https://github.com/alexstrat/supertest-graphql) ⭐ 34 | 🐛 12 | 🌐 TypeScript | 📅 2023-01-24 - Extends [supertest](https://github.com/visionmedia/supertest) ⭐ 14,365 | 🐛 186 | 🌐 JavaScript | 📅 2026-04-02 to easily test a GraphQL endpoint
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 139,964 | 🐛 4,071 | 🌐 JavaScript | 📅 2026-06-13 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
* [React Starter Kit](https://github.com/kriasoft/react-starter-kit) ⭐ 23,603 | 🐛 10 | 🌐 TypeScript | 📅 2026-03-02 - front-end starter kit using React, Relay, GraphQL, and JAM stack architecture.
...
* [NAPERG](https://github.com/alan345/naperg) ⭐ 1,402 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-06 - Fullstack Boilerplate GraphQL. Made with React & Prisma + authentication & roles.
...
* [Relay TodoMVC](https://github.com/taion/relay-todomvc) ⭐ 157 | 🐛 40 | 🌐 JavaScript | 📅 2026-06-11 - Relay TodoMVC with routing.
...
* [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,449 | 🐛 60 | 🌐 Ruby | 📅 2026-06-12 - Ruby implementation of Facebook's GraphQL.
* [graphql-batch](https://github.com/Shopify/graphql-batch) ⭐ 1,439 | 🐛 15 | 🌐 Ruby | 📅 2026-06-08 - A query batching executor for the graphql gem.
* [agoo](https://github.com/ohler55/agoo) ⭐ 928 | 🐛 3 | 🌐 C | 📅 2026-05-09 - Ruby web server that implements Facebook's GraphQL.
...
* [agoo-demo](https://github.com/ohler55/agoo/tree/develop/example/graphql) ⭐ 928 | 🐛 3 | 🌐 C | 📅 2026-05-09 - Use of the Agoo server to demonstrate a simple GraphQL application.
...
* [relay-rails-blog](https://github.com/gauravtiwari/relay-rails-blog) ⚠️ Archived - A graphql, relay and standard rails application powered demo weblog.
...
* [graphql-php](https://github.com/webonyx/graphql-php) ⭐ 4,717 | 🐛 59 | 🌐 PHP | 📅 2026-06-09 - A PHP port of GraphQL reference implementation.
* [wp-graphql](https://github.com/wp-graphql/wp-graphql) ⭐ 3,781 | 🐛 108 | 🌐 PHP | 📅 2026-06-12 - GraphQL API for WordPress.
* [lighthouse](https://github.com/nuwave/lighthouse) ⭐ 3,496 | 🐛 134 | 🌐 PHP | 📅 2026-06-07 - A PHP package that allows to serve a GraphQL endpoint from your Laravel application.
* [graphql-laravel](https://github.com/rebing/graphql-laravel) ⭐ 2,213 | 🐛 0 | 🌐 PHP | 📅 2026-06-08 - Laravel wrapper for Facebook's GraphQL.
...
* [overblog/graphql-bundle](https://github.com/overblog/GraphQLBundle) ⭐ 796 | 🐛 136 | 🌐 PHP | 📅 2026-04-13 - This bundle provides tools to build a complete GraphQL server in your Symfony App. Supports react-relay.
* [graphqlite](https://github.com/thecodingmachine/graphqlite) ⭐ 572 | 🐛 28 | 🌐 MDX | 📅 2026-06-12 - Framework agnostic library that allows you to write GraphQL server by annotating your PHP classes.
...
* [jerowork/graphql-schema-builder](https://github.com/jerowork/graphql-attribute-schema) ⭐ 16 | 🐛 0 | 🌐 PHP | 📅 2026-06-10 - Easily build your GraphQL schema for webonyx/graphql-php using PHP attributes instead of large configuration arrays.
...
* [strawberry](https://github.com/strawberry-graphql/strawberry) ⭐ 4,672 | 🐛 451 | 🌐 Python | 📅 2026-06-09 - A new GraphQL library for Python.
* [graphene-django](https://github.com/graphql-python/graphene-django) ⭐ 4,390 | 🐛 166 | 🌐 Python | 📅 2026-06-12 - A Django integration for Graphene.
* [Ariadne](https://github.com/mirumee/ariadne) ⭐ 2,343 | 🐛 32 | 🌐 Python | 📅 2026-06-11 - library for implementing GraphQL servers using schema-first approach. Asynchronous query execution, batteries included for ASGI, WSGI and popular webframeworks, [fully documented](https://ariadnegraphql.org).
* [flask-graphql](https://github.com/graphql-python/flask-graphql) ⭐ 1,339 | 🐛 41 | 🌐 Python | 📅 2023-01-03 - Adds GraphQL support to your Flask application.
* [tartiflette](https://github.com/dailymotion/tartiflette) ⭐ 853 | 🐛 21 | 🌐 Python | 📅 2023-09-11 - GraphQL Implementation, SDL First, for python 3.6+ / asyncio.
...
* [graphql-core](https://github.com/graphql-python/graphql-core) ⭐ 528 | 🐛 29 | 🌐 Python | 📅 2026-06-12 - GraphQL implementation for Python based on GraphQL.js v16.3.0 reference implementation
...
* [python-graphql-client](https://github.com/prisma/python-graphql-client) ⭐ 157 | 🐛 9 | 🌐 Python | 📅 2020-09-30 - Simple GraphQL client for Python 2.7+
...
* [turms](https://github.com/jhnnsrs/turms) ⭐ 73 | 🐛 21 | 🌐 Python | 📅 2026-06-12 - A pythonic graphql codegenerator built around graphql-core and pydantic
...
* [rath](https://github.com/jhnnsrs/rath) ⭐ 10 | 🐛 4 | 🌐 Python | 📅 2026-06-09 - An apollo like graphql client with async and sync interface
...
* [graphql-java](https://github.com/graphql-java/graphql-java) ⭐ 6,234 | 🐛 40 | 🌐 Java | 📅 2026-06-07 - GraphQL Java implementation.
* [DGS Framework](https://github.com/Netflix/dgs-framework) ⭐ 3,371 | 🐛 47 | 🌐 Kotlin | 📅 2026-06-12 - A GraphQL server framework for Spring Boot, developed by Netflix.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,746 | 🐛 110 | 🌐 Java | 📅 2026-06-13 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [graphql-spqr](https://github.com/leangen/GraphQL-SPQR) ⭐ 1,104 | 🐛 90 | 🌐 Java | 📅 2026-01-27 - Java 8+ API for rapid development of GraphQL services.
* [graphql-java-tools](https://github.com/graphql-java-kickstart/graphql-java-tools) ⭐ 822 | 🐛 88 | 🌐 Kotlin | 📅 2026-06-03 - Schema-first graphql-java convenience library that makes it easy to bring your own implementations as data resolvers. Inspired by [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,426 | 🐛 172 | 🌐 TypeScript | 📅 2026-06-11 for JS.
...
* [federation-jvm](https://github.com/apollographql/federation-jvm) ⭐ 273 | 🐛 24 | 🌐 Java | 📅 2026-06-11 - Apollo Federation on the JVM.
* [graphql-java-servlet](https://github.com/graphql-java-kickstart/graphql-java-servlet) ⭐ 227 | 🐛 23 | 🌐 Java | 📅 2026-06-13 - A framework-agnostic java servlet for exposing graphql-java query endpoints with GET, POST, and multipart uploads.
...
* [Light Java GraphQL](https://github.com/networknt/light-graphql-4j) ⭐ 35 | 🐛 10 | 🌐 Java | 📅 2026-06-01: A lightweight, fast microservices framework with all cross-cutting concerns addressed and ready to plug in GraphQL schema.
...
* [graphql-java-codegen-maven-plugin](https://github.com/kobylynskyi/graphql-java-codegen-maven-plugin) ⭐ 17 | 🐛 0 | 📅 2020-04-09 - Schema-first maven plugin for generating Java types and Resolver interfaces. Works perfectly in conjunction with graphql-java-tools. Inspired by [swagger-codegen-maven-plugin](https://github.com/swagger-api/swagger-codegen/tree/master/modules/swagger-codegen-maven-plugin) ⭐ 17,758 | 🐛 3,451 | 🌐 Mustache | 📅 2026-05-19.
* [dgs-extended-formatters](https://github.com/setchy/dgs-extended-formatters) ⭐ 6 | 🐛 3 | 🌐 Java | 📅 2026-06-05 - An experimental set of DGS Directives for common formatting use-cases.
...
* [graphql-java-extended-scalars](https://github.com/graphql-java/graphql-java-extended-scalars) ⭐ 286 | 🐛 4 | 🌐 Java | 📅 2026-06-08 - Extended scalars for graphql-java.
* [graphql-java-datetime](https://github.com/donbeave/graphql-java-datetime) ⭐ 152 | 🐛 3 | 🌐 Java | 📅 2026-06-08 - GraphQL ISO Date is a set of RFC 3339 compliant date/time scalar types to be used with graphql-java.

<a name="java-example" />

#### Java Examples

* [light-java-graphql examples](https://github.com/networknt/light-example-4j/tree/master/graphql) ⭐ 149 | 🐛 8 | 🌐 Java | 📅 2026-06-02 - Examples of Light Java GraphQL and tutorials.
* [graphql-java-kickstart\_samples](https://github.com/graphql-java-kickstart/samples) ⭐ 121 | 🐛 16 | 🌐 Java | 📅 2026-06-10 - Samples for using the GraphQL Java Kickstart projects.
...
* [graphql-kotlin](https://github.com/ExpediaGroup/graphql-kotlin) ⭐ 1,803 | 🐛 85 | 🌐 Kotlin | 📅 2026-06-01 - GraphQL Kotlin implementation.
...
* [Kobby](https://github.com/ermadmi78/kobby) ⭐ 88 | 🐛 1 | 🌐 Kotlin | 📅 2026-01-17 - Codegen plugin of Kotlin DSL Client by GraphQL schema. The generated DSL supports execution of complex GraphQL queries, mutation and subscriptions in Kotlin with syntax similar to native GraphQL syntax.
...
* [libgraphqlparser](https://github.com/graphql/libgraphqlparser) ⭐ 1,106 | 🐛 40 | 🌐 C++ | 📅 2025-10-02 - A GraphQL query parser in C++ with C and C++ APIs.
* [cppgraphqlgen](https://github.com/Microsoft/cppgraphqlgen) ⭐ 349 | 🐛 14 | 🌐 C++ | 📅 2026-05-19 - C++ GraphQL schema service generator.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,725 | 🐛 382 | 🌐 Go | 📅 2026-06-11 - Go generate based graphql server library.
* [graphql](https://github.com/graphql-go/graphql) ⭐ 10,154 | 🐛 241 | 🌐 Go | 📅 2026-06-07 - An implementation of GraphQL for Go follows graphql-js
* [graphql-go](https://github.com/graph-gophers/graphql-go) ⭐ 4,754 | 🐛 9 | 🌐 Go | 📅 2026-05-31 - GraphQL server with a focus on ease of use.
* [graphjin](https://github.com/dosco/graphjin) ⭐ 3,081 | 🐛 23 | 🌐 Go | 📅 2026-06-11: Build APIs in 5 minutes with GraphQL. An instant GraphQL to SQL compiler.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 821 | 🐛 40 | 🌐 Go | 📅 2026-06-12 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
* [sangria](https://github.com/sangria-graphql/sangria) ⭐ 1,963 | 🐛 65 | 🌐 Scala | 📅 2026-05-17 - Scala GraphQL server implementation.
* [caliban](https://github.com/ghostdogpr/caliban) ⭐ 996 | 🐛 26 | 🌐 Scala | 📅 2026-06-12 - Caliban is a purely functional library for creating GraphQL backends in Scala.
* [sangria-relay](https://github.com/sangria-graphql/sangria-relay) ⭐ 90 | 🐛 9 | 🌐 Scala | 📅 2026-06-07 - Sangria Relay Support.
...
* [graphql-dotnet](https://github.com/graphql-dotnet/graphql-dotnet) ⭐ 5,987 | 🐛 132 | 🌐 C# | 📅 2026-06-10 - GraphQL for .NET.
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,709 | 🐛 406 | 🌐 C# | 📅 2026-06-12 - GraphQL server for .Net Core and .NET Framework.
* [graphql-net](https://github.com/ckimes89/graphql-net) ⭐ 884 | 🐛 43 | 🌐 C# | 📅 2022-06-22 - GraphQL to IQueryable for .NET.
* [EntityGraphQL](https://github.com/EntityGraphQL/EntityGraphQL) ⭐ 454 | 🐛 10 | 🌐 C# | 📅 2026-06-12 - library to build a GraphQL API on top of data model with the extensibility to bring multiple data sources together in the single GraphQL schema.
* [ZeroQL](https://github.com/byme8/ZeroQL) ⭐ 320 | 🐛 12 | 🌐 C# | 📅 2025-12-28 - type-safe GraphQL client with Linq-like interface for C#
* [Snowflaqe](https://github.com/Zaid-Ajaj/Snowflaqe) ⭐ 161 | 🐛 22 | 🌐 F# | 📅 2024-10-10 - Type-safe GraphQL code generator for F# and [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,093 | 🐛 213 | 🌐 F# | 📅 2026-06-12
...
* [absinthe-graphql](https://github.com/absinthe-graphql/absinthe) ⭐ 4,400 | 🐛 73 | 🌐 Elixir | 📅 2026-06-09 - Fully Featured Elixir GraphQL Library.
...
* [graphql\_parser](https://github.com/graphql-elixir/graphql_parser) ⭐ 24 | 🐛 3 | 🌐 Elixir | 📅 2023-07-02 - Elixir bindings for [libgraphqlparser](https://github.com/graphql/libgraphqlparser) ⭐ 1,106 | 🐛 40 | 🌐 C++ | 📅 2025-10-02
...
* [morpheus-graphql](https://github.com/morpheusgraphql/morpheus-graphql) ⭐ 415 | 🐛 18 | 🌐 Haskell | 📅 2026-05-18 - Haskell GraphQL Api, Client and Tools.
* [graphql-haskell](https://github.com/jdnavarro/graphql-haskell) ⭐ 168 | 🐛 6 | 🌐 Haskell | 📅 2019-06-11 - GraphQL AST and parser for Haskell.

<a name="sql" />

### SQL

* [Hasura](https://github.com/hasura/graphql-engine) ⭐ 32,055 | 🐛 2,379 | 🌐 TypeScript | 📅 2026-06-12 - Hasura gives Instant Realtime GraphQL APIs over PostgreSQL. Works with an existing database too.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,928 | 🐛 155 | 🌐 TypeScript | 📅 2026-06-08 - Lightning-fast GraphQL APIs for PostgreSQL: highly customisable; extensible via plugins; realtime.
...
* [Lacinia](https://github.com/walmartlabs/lacinia) ⭐ 1,857 | 🐛 10 | 🌐 Clojure | 📅 2026-06-03 - GraphQL implementation in pure Clojure.
* [graphql-clj](https://github.com/tendant/graphql-clj) ⚠️ Archived - A Clojure library designed to provide GraphQL implementation.
* [graphql-query](https://github.com/district0x/graphql-query) ⭐ 75 | 🐛 6 | 🌐 Clojure | 📅 2024-03-14 - Clojure(Script) GraphQL query generation.
...
* [GraphQL](https://github.com/GraphQLSwift/GraphQL) ⭐ 963 | 🐛 7 | 🌐 Swift | 📅 2026-05-14 - The Swift implementation for GraphQL.

<a name="ocaml" />

### OCaml

* [ocaml-graphql-server](https://github.com/andreas/ocaml-graphql-server) ⭐ 620 | 🐛 28 | 🌐 OCaml | 📅 2024-03-03 - GraphQL servers in OCaml.

<a name="android" />

### Android

* [apollo-android](https://github.com/apollographql/apollo-android) ⭐ 3,951 | 🐛 115 | 🌐 Kotlin | 📅 2026-06-13 - 📟 A strongly-typed, caching GraphQL client for Android, written in Java.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,746 | 🐛 110 | 🌐 Java | 📅 2026-06-13 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [apollo-ios](https://github.com/apollographql/apollo-ios) ⭐ 4,034 | 🐛 93 | 🌐 Swift | 📅 2026-06-02 - 📱 A strongly-typed, caching GraphQL client for iOS, written in Swift.
...
* [graphql-flutter](https://github.com/zino-app/graphql-flutter) ⭐ 3,271 | 🐛 162 | 🌐 Dart | 📅 2026-03-30 - A GraphQL client for Flutter.
...
* [juniper](https://github.com/graphql-rust/juniper) ⭐ 5,965 | 🐛 103 | 🌐 Rust | 📅 2026-06-12 - GraphQL server library for Rust.
* [async-graphql](https://github.com/async-graphql/async-graphql) ⭐ 3,670 | 🐛 246 | 🌐 Rust | 📅 2026-04-21 - High-performance server-side library that supports all GraphQL specifications.
* [tailcall](https://github.com/tailcallhq/tailcall) ⭐ 1,440 | 🐛 19 | 🌐 Rust | 📅 2026-06-12 - A platform for building high-performance GraphQL backends.
* [graphql-client](https://github.com/tomhoule/graphql-client) ⭐ 1,256 | 🐛 112 | 🌐 Rust | 📅 2026-02-20 - GraphQL client library for Rust with WebAssembly (wasm) support.
...
* [graphql-crystal](https://github.com/ziprandom/graphql-crystal) ⭐ 213 | 🐛 9 | 🌐 Crystal | 📅 2020-07-01 - library inspired by [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,449 | 🐛 60 | 🌐 Ruby | 📅 2026-06-12 & [go-graphql](https://github.com/playlyfe/go-graphql) ⭐ 246 | 🐛 18 | 🌐 Go | 📅 2020-01-22 & [graphql-parser](https://github.com/graphql-dotnet/parser) ⭐ 218 | 🐛 9 | 🌐 C# | 📅 2026-04-10.
...
* [graphql](https://github.com/ballerina-platform/module-ballerina-graphql) ⭐ 137 | 🐛 2 | 🌐 Ballerina | 📅 2026-05-27 - Ballerina standard library for GraphQL. This library provides a GraphQL client and server implementations including builtin support for GraphQL subscriptions.
* [graphql CLI](https://github.com/ballerina-platform/graphql-tools) ⭐ 107 | 🐛 3 | 🌐 Java | 📅 2026-05-28 - A CLI tool to generate Ballerina code from GraphQL schema and GraphQL schema from Ballerina code. It also provides functionality to generate usage-specific GraphQL clients using GraphQL schemas and documents.

#### Ballerina Samples

* [Ballerina GraphQL Examples](https://github.com/ballerina-platform/module-ballerina-graphql/tree/master/examples) ⭐ 137 | 🐛 2 | 🌐 Ballerina | 📅 2026-05-27
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 44,865 | 🐛 1,709 | 🌐 JavaScript | 📅 2026-06-12 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,845 | 🐛 383 | 🌐 TypeScript | 📅 2026-06-11 - An in-browser IDE for exploring GraphQL.
* [GraphQL Voyager](https://github.com/APIs-guru/graphql-voyager) ⭐ 8,143 | 🐛 106 | 🌐 TypeScript | 📅 2026-05-12 - Represent any GraphQL API as an interactive graph.
* [GraphQL Editor](https://github.com/graphql-editor/graphql-editor) ⭐ 6,067 | 🐛 20 | 🌐 TypeScript | 📅 2025-09-10 - Visual Editor & GraphQL IDE.
* [Altair GraphQL Client](https://github.com/altair-graphql/altair) ⭐ 5,410 | 🐛 161 | 🌐 TypeScript | 📅 2026-06-12 - A beautiful feature-rich GraphQL Client for all platforms.
...
* [Escape GraphMan](https://github.com/Escape-Technologies/graphman) ⭐ 252 | 🐛 7 | 🌐 TypeScript | 📅 2024-08-26 - Generate a complete Postman collection from a GraphQL endpoint.
...
* [mockd](https://github.com/getmockd/mockd) ⭐ 125 | 🐛 19 | 🌐 Go | 📅 2026-06-03 - Multi-protocol mock server with GraphQL schema mocking, resolver configuration, and query validation. Also supports HTTP, gRPC, WebSocket, MQTT, and SOAP.
* [graphql-to-karate](https://github.com/wbaldoumas/graphql-to-karate) ⭐ 16 | 🐛 3 | 🌐 C# | 📅 2026-06-12 - **Generate Karate API tests** from your GraphQL schemas
...
* [InQL Scanner](https://github.com/doyensec/inql) ⭐ 1,781 | 🐛 38 | 🌐 Kotlin | 📅 2026-06-12 - A Burp Extension for GraphQL Security Testing
* [GraphQL Cop](https://github.com/dolevf/graphql-cop) ⭐ 652 | 🐛 1 | 🌐 Python | 📅 2025-11-20 - Security Audit Utility for GraphQL
...
* [GraphQLer](https://github.com/omar2535/GraphQLer) ⭐ 163 | 🐛 24 | 🌐 Python | 📅 2026-06-04 - Dependency-aware dynamic GraphQL testing tool
...
* [Apollo Client Developer Tools](https://github.com/apollographql/apollo-client-devtools) ⭐ 1,524 | 🐛 57 | 🌐 TypeScript | 📅 2026-06-12 - GraphQL debugging tools for Apollo Client in the Chrome developer console
...
* [graphdoc](https://github.com/2fd/graphdoc) ⭐ 1,566 | 🐛 100 | 🌐 TypeScript | 📅 2023-01-31 - Static page generator for documenting GraphQL Schema.
* [spectaql](https://github.com/anvilco/spectaql) ⭐ 1,225 | 🐛 93 | 🌐 JavaScript | 📅 2026-05-28 - Autogenerate static GraphQL API documentation.
...
* [js-graphql-intellij-plugin](https://github.com/jimkyndemeyer/js-graphql-intellij-plugin/) ⭐ 898 | 🐛 157 | 🌐 Java | 📅 2026-06-12 - GraphQL language support for IntelliJ IDEA and WebStorm, including Relay.QL tagged templates in JavaScript and TypeScript.
* [vim-graphql](https://github.com/jparise/vim-graphql) ⭐ 511 | 🐛 0 | 🌐 Vim Script | 📅 2026-04-14 - A Vim plugin that provides GraphQL file detection and syntax highlighting.
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 46,248 | 🐛 2,620 | 🌐 TypeScript | 📅 2026-06-12 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.
* [Bit](https://github.com/teambit/bit) ⭐ 18,409 | 🐛 83 | 🌐 TypeScript | 📅 2026-06-12 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).
* [amplication](https://github.com/amplication/amplication) ⭐ 16,013 | 🐛 656 | 🌐 TypeScript | 📅 2026-06-12: Amplication is an open‑source low code development tool. It builds database applications with REST API and GraphQL for CRUD with relations, sorting, filtering, pagination.
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,256 | 🐛 563 | 🌐 TypeScript | 📅 2026-06-03 - GraphQL code generator based on schema and documents.
* [json-graphql-server](https://github.com/marmelab/json-graphql-server) ⭐ 1,949 | 🐛 5 | 🌐 JavaScript | 📅 2026-06-02 - Get a full fake GraphQL API with zero coding in less than 30 seconds, based on a JSON data file.
* [raphql-inspector](https://github.com/kamilkisiela/graphql-inspector) ⭐ 1,752 | 🐛 136 | 🌐 TypeScript | 📅 2026-06-10: alidate schema, get schema change notifications, validate operations, find breaking changes, look for similar types, schema coverage.
* [openapi-to-graphql](https://github.com/ibm/openapi-to-graphql) ⚠️ Archived - Take any OpenAPI Specification (OAS) or swagger and create a GraphQL interface - Two minute video and resources [here](https://developer.ibm.com/open/projects/openapi-to-graphql/)
* [tuql](https://github.com/bradleyboy/tuql) ⭐ 1,072 | 🐛 15 | 🌐 JavaScript | 📅 2021-06-06 - Automatically create a GraphQL server from any sqlite database.
...
* [ts-graphql-plugin](https://github.com/Quramy/ts-graphql-plugin) ⭐ 755 | 🐛 30 | 🌐 TypeScript | 📅 2026-06-13 - A language service plugin complete and validate GraphQL query in TypeScript template strings.
...
* [Typetta](https://github.com/twinlogix/typetta) ⭐ 115 | 🐛 59 | 🌐 TypeScript | 📅 2026-06-12 - Node.js ORM written in TypeScript for type lovers. Typetta is the perfect ORM for the GraphQL + NodeJS + Typescript stack.
...
* [Apollo APQ Debugger](https://github.com/rookieInTraining/apq-debugger) ⭐ 0 | 🐛 1 | 🌐 HTML | 📅 2026-06-13 - Reveal full GraphQL queries behind Apollo APQ hashes. Inspect fallback flow and debug Automatic Persisted Queries in DevTools. <a name="databases" />
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 20,157 | 🐛 1,000 | 🌐 Rust | 📅 2026-06-13
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 16,322 | 🐛 531 | 🌐 Go | 📅 2026-06-12 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 22,975 | 🐛 245 | 🌐 Python | 📅 2026-06-10 - GraphQL-first headless e-commerce platform.
...
* [Shopify GraphQL Design Tutorial](https://github.com/Shopify/graphql-design-tutorial) ⭐ 2,459 | 🐛 5 | 📅 2025-01-23 - This tutorial was originally created by Shopify for internal purposes. It's based on lessons learned from creating and evolving production schemas at Shopify over almost 3 years.
