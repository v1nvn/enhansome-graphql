...
* [graphql-js](https://github.com/graphql/graphql-js) ⭐ 20,359 | 🐛 89 | 🌐 TypeScript | 📅 2026-06-11 - A reference implementation of GraphQL for JavaScript.
...
* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,766 | 🐛 410 | 🌐 TypeScript | 📅 2026-06-11 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
* [aws-amplify](https://github.com/aws-amplify/amplify-js) ⭐ 9,572 | 🐛 492 | 🌐 TypeScript | 📅 2026-06-10 - A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.
...
* [relay](https://github.com/facebook/relay) ⭐ 18,941 | 🐛 845 | 🌐 Rust | 📅 2026-06-12 - Relay is a JavaScript framework for building data-driven React applications.
* [urql](https://github.com/FormidableLabs/urql) ⭐ 8,952 | 🐛 43 | 🌐 TypeScript | 📅 2026-06-06 - A simple caching GraphQL client for React.
...
* [apollo-server](https://github.com/apollographql/apollo-server) ⭐ 13,938 | 🐛 82 | 🌐 TypeScript | 📅 2026-06-12 - Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
* [graphql-yoga](https://github.com/prisma-labs/graphql-yoga) ⭐ 8,522 | 🐛 141 | 🌐 TypeScript | 📅 2026-06-09 - Fully-featured GraphQL Server with focus on easy setup, performance and great developer experience.
...
* [graphitejs](https://github.com/graphitejs/server) ⭐ 122 | 🐛 18 | 🌐 JavaScript | 📅 2026-06-11 - Framework NodeJS for GraphQL.
...
* [gql.tada](https://github.com/0no-co/gql.tada) ⭐ 2,935 | 🐛 30 | 🌐 TypeScript | 📅 2026-06-12 - GraphQL document authoring library, inferring the result and variables types of GraphQL queries and fragments in the TypeScript type system.
...
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 99 | 🐛 7 | 🌐 TypeScript | 📅 2026-06-09 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,751 | 🐛 122 | 🌐 TypeScript | 📅 2026-06-08, [Zod](https://github.com/colinhacks/zod) ⭐ 42,939 | 🐛 198 | 🌐 TypeScript | 📅 2026-06-12, or [Yup](https://github.com/jquense/yup) ⭐ 23,675 | 🐛 242 | 🌐 TypeScript | 📅 2026-06-11.
...
* [graphql-mesh](https://github.com/urigo/graphql-mesh) ⭐ 3,504 | 🐛 230 | 🌐 TypeScript | 📅 2026-06-11 - use GraphQL query language to access data in remote APIs that don't run GraphQL (and also ones that do run GraphQL).
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,365 | 🐛 17 | 🌐 Python | 📅 2026-06-11 - Runs arbitrary queries matching a GraphQL schema to find server errors.
...
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,225 | 🐛 176 | 🌐 TypeScript | 📅 2026-06-12 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
* [eslint-plugin-graphql](https://github.com/apollographql/eslint-plugin-graphql) ⭐ 1,215 | 🐛 100 | 🌐 JavaScript | 📅 2026-06-11 - An ESLint plugin that checks your GraphQL strings against a schema.
...
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 821 | 🐛 40 | 🌐 Go | 📅 2026-06-11 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 139,934 | 🐛 4,054 | 🌐 JavaScript | 📅 2026-06-12 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
* [React Starter Kit](https://github.com/kriasoft/react-starter-kit) ⭐ 23,604 | 🐛 10 | 🌐 TypeScript | 📅 2026-03-02 - front-end starter kit using React, Relay, GraphQL, and JAM stack architecture.
...
* [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,449 | 🐛 61 | 🌐 Ruby | 📅 2026-05-28 - Ruby implementation of Facebook's GraphQL.
...
* [wp-graphql](https://github.com/wp-graphql/wp-graphql) ⭐ 3,781 | 🐛 109 | 🌐 PHP | 📅 2026-06-11 - GraphQL API for WordPress.
* [lighthouse](https://github.com/nuwave/lighthouse) ⭐ 3,494 | 🐛 134 | 🌐 PHP | 📅 2026-06-07 - A PHP package that allows to serve a GraphQL endpoint from your Laravel application.
* [graphql-laravel](https://github.com/rebing/graphql-laravel) ⭐ 2,212 | 🐛 0 | 🌐 PHP | 📅 2026-06-08 - Laravel wrapper for Facebook's GraphQL.
...
* [graphql-core](https://github.com/graphql-python/graphql-core) ⭐ 528 | 🐛 30 | 🌐 Python | 📅 2026-06-11 - GraphQL implementation for Python based on GraphQL.js v16.3.0 reference implementation
...
* [graphql-java-servlet](https://github.com/graphql-java-kickstart/graphql-java-servlet) ⭐ 227 | 🐛 23 | 🌐 Java | 📅 2026-06-11 - A framework-agnostic java servlet for exposing graphql-java query endpoints with GET, POST, and multipart uploads.
...
* [graphjin](https://github.com/dosco/graphjin) ⭐ 3,080 | 🐛 23 | 🌐 Go | 📅 2026-06-11: Build APIs in 5 minutes with GraphQL. An instant GraphQL to SQL compiler.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 821 | 🐛 40 | 🌐 Go | 📅 2026-06-11 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,709 | 🐛 404 | 🌐 C# | 📅 2026-06-11 - GraphQL server for .Net Core and .NET Framework.
...
* [Snowflaqe](https://github.com/Zaid-Ajaj/Snowflaqe) ⭐ 161 | 🐛 22 | 🌐 F# | 📅 2024-10-10 - Type-safe GraphQL code generator for F# and [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,092 | 🐛 209 | 🌐 F# | 📅 2026-06-11
...
* [Hasura](https://github.com/hasura/graphql-engine) ⭐ 32,045 | 🐛 2,378 | 🌐 TypeScript | 📅 2026-06-11 - Hasura gives Instant Realtime GraphQL APIs over PostgreSQL. Works with an existing database too.
...
* [apollo-android](https://github.com/apollographql/apollo-android) ⭐ 3,951 | 🐛 115 | 🌐 Kotlin | 📅 2026-06-12 - 📟 A strongly-typed, caching GraphQL client for Android, written in Java.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,746 | 🐛 110 | 🌐 Java | 📅 2026-05-24 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [juniper](https://github.com/graphql-rust/juniper) ⭐ 5,965 | 🐛 102 | 🌐 Rust | 📅 2026-06-12 - GraphQL server library for Rust.
* [async-graphql](https://github.com/async-graphql/async-graphql) ⭐ 3,668 | 🐛 246 | 🌐 Rust | 📅 2026-04-21 - High-performance server-side library that supports all GraphQL specifications.
...
* [graphql-crystal](https://github.com/ziprandom/graphql-crystal) ⭐ 213 | 🐛 9 | 🌐 Crystal | 📅 2020-07-01 - library inspired by [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,449 | 🐛 61 | 🌐 Ruby | 📅 2026-05-28 & [go-graphql](https://github.com/playlyfe/go-graphql) ⭐ 246 | 🐛 18 | 🌐 Go | 📅 2020-01-22 & [graphql-parser](https://github.com/graphql-dotnet/parser) ⭐ 218 | 🐛 9 | 🌐 C# | 📅 2026-04-10.
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 44,844 | 🐛 1,710 | 🌐 JavaScript | 📅 2026-06-12 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,843 | 🐛 383 | 🌐 TypeScript | 📅 2026-06-11 - An in-browser IDE for exploring GraphQL.
...
* [Altair GraphQL Client](https://github.com/altair-graphql/altair) ⭐ 5,410 | 🐛 160 | 🌐 TypeScript | 📅 2026-06-09 - A beautiful feature-rich GraphQL Client for all platforms.
...
* [graphql-to-karate](https://github.com/wbaldoumas/graphql-to-karate) ⭐ 16 | 🐛 2 | 🌐 C# | 📅 2026-06-12 - **Generate Karate API tests** from your GraphQL schemas
...
* [InQL Scanner](https://github.com/doyensec/inql) ⭐ 1,781 | 🐛 38 | 🌐 Kotlin | 📅 2026-06-08 - A Burp Extension for GraphQL Security Testing
...
* [Apollo Client Developer Tools](https://github.com/apollographql/apollo-client-devtools) ⭐ 1,524 | 🐛 56 | 🌐 TypeScript | 📅 2026-06-11 - GraphQL debugging tools for Apollo Client in the Chrome developer console
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 46,237 | 🐛 2,620 | 🌐 TypeScript | 📅 2026-06-11 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.
* [Bit](https://github.com/teambit/bit) ⭐ 18,407 | 🐛 83 | 🌐 TypeScript | 📅 2026-06-12 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).
* [amplication](https://github.com/amplication/amplication) ⭐ 16,013 | 🐛 655 | 🌐 TypeScript | 📅 2026-06-12: Amplication is an open‑source low code development tool. It builds database applications with REST API and GraphQL for CRUD with relations, sorting, filtering, pagination.
...
* [raphql-inspector](https://github.com/kamilkisiela/graphql-inspector) ⭐ 1,751 | 🐛 136 | 🌐 TypeScript | 📅 2026-06-10: alidate schema, get schema change notifications, validate operations, find breaking changes, look for similar types, schema coverage.
...
* [ts-graphql-plugin](https://github.com/Quramy/ts-graphql-plugin) ⭐ 755 | 🐛 30 | 🌐 TypeScript | 📅 2026-06-11 - A language service plugin complete and validate GraphQL query in TypeScript template strings.
...
* [Typetta](https://github.com/twinlogix/typetta) ⭐ 115 | 🐛 59 | 🌐 TypeScript | 📅 2026-06-11 - Node.js ORM written in TypeScript for type lovers. Typetta is the perfect ORM for the GraphQL + NodeJS + Typescript stack.
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 20,147 | 🐛 999 | 🌐 Rust | 📅 2026-06-11
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 16,314 | 🐛 532 | 🌐 Go | 📅 2026-06-11 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 22,970 | 🐛 245 | 🌐 Python | 📅 2026-06-10 - GraphQL-first headless e-commerce platform.
