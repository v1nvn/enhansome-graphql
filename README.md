...
* [GraphQL](https://github.com/graphql/graphql-spec) ⭐ 14,626 | 🐛 194 | 🌐 JavaScript | 📅 2026-04-09 - Working draft of the specification for GraphQL.
...
* [graphql-js](https://github.com/graphql/graphql-js) ⭐ 20,323 | 🐛 132 | 🌐 TypeScript | 📅 2026-04-13 - A reference implementation of GraphQL for JavaScript.
...
* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,718 | 🐛 420 | 🌐 TypeScript | 📅 2026-04-12 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
* [aws-amplify](https://github.com/aws-amplify/amplify-js) ⭐ 9,583 | 🐛 478 | 🌐 TypeScript | 📅 2026-04-13 - A client library developed by Amazon for caching, analytics and more that includes a way to fetch GraphQL queries.
...
* [gqty](https://github.com/gqty-dev/gqty) ⭐ 1,033 | 🐛 52 | 🌐 TypeScript | 📅 2026-04-14 - A No GraphQL client for TypeScript
...
* [sveltekit-kitql](https://github.com/jycouet/kitql) ⭐ 452 | 🐛 11 | 🌐 TypeScript | 📅 2026-04-13 - A set of tools, helping you building efficient apps in a fast way with SvelteKit and GraphQL.
...
* [relay](https://github.com/facebook/relay) ⭐ 18,929 | 🐛 833 | 🌐 Rust | 📅 2026-04-14 - Relay is a JavaScript framework for building data-driven React applications.
...
* [@gqty/react](https://github.com/gqty-dev/gqty) ⭐ 1,033 | 🐛 52 | 🌐 TypeScript | 📅 2026-04-14 - A No GraphQL client for TypeScript
...
* [apollo-server](https://github.com/apollographql/apollo-server) ⭐ 13,936 | 🐛 82 | 🌐 TypeScript | 📅 2026-04-13 - Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
...
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,229 | 🐛 590 | 🌐 TypeScript | 📅 2026-04-13: GraphQL code generator with flexible support for custom plugins and templates like TypeScript (frontend and backend), React Hooks, resolvers signatures and more.
...
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 96 | 🐛 8 | 🌐 TypeScript | 📅 2026-04-13 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,564 | 🐛 119 | 🌐 TypeScript | 📅 2026-04-12, [Zod](https://github.com/colinhacks/zod) ⭐ 42,393 | 🐛 316 | 🌐 TypeScript | 📅 2026-02-15, or [Yup](https://github.com/jquense/yup) ⭐ 23,687 | 🐛 240 | 🌐 TypeScript | 📅 2026-04-10.
...
* [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,423 | 🐛 158 | 🌐 TypeScript | 📅 2026-04-14 - Tool library for building and maintaining GraphQL-JS servers.
...
* [graphql-mesh](https://github.com/urigo/graphql-mesh) ⭐ 3,496 | 🐛 229 | 🌐 TypeScript | 📅 2026-04-13 - use GraphQL query language to access data in remote APIs that don't run GraphQL (and also ones that do run GraphQL).
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,214 | 🐛 22 | 🌐 Python | 📅 2026-04-13 - Runs arbitrary queries matching a GraphQL schema to find server errors.
...
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,193 | 🐛 165 | 🌐 TypeScript | 📅 2026-04-13 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 138,903 | 🐛 3,742 | 🌐 JavaScript | 📅 2026-04-14 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
...
* [NAPERG](https://github.com/alan345/naperg) ⭐ 1,389 | 🐛 0 | 🌐 TypeScript | 📅 2026-04-12 - Fullstack Boilerplate GraphQL. Made with React & Prisma + authentication & roles.
...
* [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,428 | 🐛 77 | 🌐 Ruby | 📅 2026-04-13 - Ruby implementation of Facebook's GraphQL.
...
* [wp-graphql](https://github.com/wp-graphql/wp-graphql) ⭐ 3,776 | 🐛 109 | 🌐 PHP | 📅 2026-04-14 - GraphQL API for WordPress.
...
* [strawberry](https://github.com/strawberry-graphql/strawberry) ⭐ 4,645 | 🐛 451 | 🌐 Python | 📅 2026-04-14 - A new GraphQL library for Python.
...
* [DGS Framework](https://github.com/Netflix/dgs-framework) ⭐ 3,323 | 🐛 46 | 🌐 Kotlin | 📅 2026-04-06 - A GraphQL server framework for Spring Boot, developed by Netflix.
...
* [graphql-java-extended-scalars](https://github.com/graphql-java/graphql-java-extended-scalars) ⭐ 284 | 🐛 3 | 🌐 Java | 📅 2026-03-09 - Extended scalars for graphql-java.
...
* [graphql-kotlin](https://github.com/ExpediaGroup/graphql-kotlin) ⭐ 1,800 | 🐛 91 | 🌐 Kotlin | 📅 2026-04-13 - GraphQL Kotlin implementation.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,709 | 🐛 388 | 🌐 Go | 📅 2026-04-13 - Go generate based graphql server library.
...
* [graphql-go](https://github.com/graph-gophers/graphql-go) ⭐ 4,748 | 🐛 13 | 🌐 Go | 📅 2026-04-13 - GraphQL server with a focus on ease of use.
* [graphjin](https://github.com/dosco/graphjin) ⭐ 3,050 | 🐛 21 | 🌐 Go | 📅 2026-04-10: Build APIs in 5 minutes with GraphQL. An instant GraphQL to SQL compiler.
* [graphql-go-tools](https://github.com/wundergraph/graphql-go-tools) ⭐ 819 | 🐛 43 | 🌐 Go | 📅 2026-04-10 - A graphQL Router / API Gateway framework written in Golang, focussing on correctness, extensibility, and high-performance. Supports Federation v1 & v2, Subscriptions & more.
...
* [sangria](https://github.com/sangria-graphql/sangria) ⭐ 1,963 | 🐛 64 | 🌐 Scala | 📅 2026-04-13 - Scala GraphQL server implementation.
* [caliban](https://github.com/ghostdogpr/caliban) ⭐ 991 | 🐛 27 | 🌐 Scala | 📅 2026-04-13 - Caliban is a purely functional library for creating GraphQL backends in Scala.
...
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,683 | 🐛 366 | 🌐 C# | 📅 2026-04-13 - GraphQL server for .Net Core and .NET Framework.
...
* [Snowflaqe](https://github.com/Zaid-Ajaj/Snowflaqe) ⭐ 161 | 🐛 22 | 🌐 F# | 📅 2024-10-10 - Type-safe GraphQL code generator for F# and [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,069 | 🐛 225 | 🌐 F# | 📅 2026-04-14
...
* [Hasura](https://github.com/hasura/graphql-engine) ⭐ 31,941 | 🐛 2,376 | 🌐 TypeScript | 📅 2026-04-13 - Hasura gives Instant Realtime GraphQL APIs over PostgreSQL. Works with an existing database too.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,914 | 🐛 157 | 🌐 TypeScript | 📅 2026-04-13 - Lightning-fast GraphQL APIs for PostgreSQL: highly customisable; extensible via plugins; realtime.
...
* [apollo-android](https://github.com/apollographql/apollo-android) ⭐ 3,954 | 🐛 115 | 🌐 Kotlin | 📅 2026-04-14 - 📟 A strongly-typed, caching GraphQL client for Android, written in Java.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,732 | 🐛 108 | 🌐 Java | 📅 2026-03-08 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [apollo-ios](https://github.com/apollographql/apollo-ios) ⭐ 4,037 | 🐛 93 | 🌐 Swift | 📅 2026-04-07 - 📱 A strongly-typed, caching GraphQL client for iOS, written in Swift.
...
* [juniper](https://github.com/graphql-rust/juniper) ⭐ 5,956 | 🐛 104 | 🌐 Rust | 📅 2026-04-13 - GraphQL server library for Rust.
...
* [tailcall](https://github.com/tailcallhq/tailcall) ⭐ 1,431 | 🐛 14 | 🌐 Rust | 📅 2026-04-13 - A platform for building high-performance GraphQL backends.
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 42,884 | 🐛 1,633 | 🌐 JavaScript | 📅 2026-04-13 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,817 | 🐛 413 | 🌐 TypeScript | 📅 2026-03-05 - An in-browser IDE for exploring GraphQL.
* [GraphQL Voyager](https://github.com/APIs-guru/graphql-voyager) ⭐ 8,108 | 🐛 106 | 🌐 TypeScript | 📅 2026-03-30 - Represent any GraphQL API as an interactive graph.
...
* [graphql-to-karate](https://github.com/wbaldoumas/graphql-to-karate) ⭐ 16 | 🐛 3 | 🌐 C# | 📅 2026-04-13 - **Generate Karate API tests** from your GraphQL schemas
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 45,755 | 🐛 2,553 | 🌐 TypeScript | 📅 2026-04-13 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.

* [Bit](https://github.com/teambit/bit) ⭐ 18,378 | 🐛 70 | 🌐 TypeScript | 📅 2026-04-14 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).

* [amplication](https://github.com/amplication/amplication) ⭐ 15,988 | 🐛 624 | 🌐 TypeScript | 📅 2026-04-14: Amplication is an open‑source low code development tool. It builds database applications with REST API and GraphQL for CRUD with relations, sorting, filtering, pagination.

* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,229 | 🐛 590 | 🌐 TypeScript | 📅 2026-04-13 - GraphQL code generator based on schema and documents.
...
* [ts-graphql-plugin](https://github.com/Quramy/ts-graphql-plugin) ⭐ 754 | 🐛 30 | 🌐 TypeScript | 📅 2026-04-14 - A language service plugin complete and validate GraphQL query in TypeScript template strings.
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 19,792 | 🐛 938 | 🌐 Rust | 📅 2026-04-14
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 16,003 | 🐛 543 | 🌐 Go | 📅 2026-04-14 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 22,792 | 🐛 247 | 🌐 Python | 📅 2026-04-13 - GraphQL-first headless e-commerce platform.
