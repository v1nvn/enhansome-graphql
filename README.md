...
* [GraphQL](https://github.com/graphql/graphql-spec) ⭐ 14,752 | 🐛 205 | 🌐 JavaScript | 📅 2026-03-04 - Working draft of the specification for GraphQL.
...
* [apollo-client](https://github.com/apollographql/apollo-client) ⭐ 19,722 | 🐛 422 | 🌐 TypeScript | 📅 2026-03-07 - A fully-featured, production ready caching GraphQL client for every UI framework and GraphQL server.
...
* [graphql-request](https://github.com/prisma-labs/graphql-request) ⭐ 6,116 | 🐛 48 | 🌐 TypeScript | 📅 2026-02-28 - A minimal GraphQL client for Node and browsers.
...
* [vue-apollo](https://github.com/vuejs/vue-apollo) ⭐ 6,057 | 🐛 277 | 🌐 TypeScript | 📅 2026-03-04 - Apollo/GraphQL integration for VueJS.
...
* [relay](https://github.com/facebook/relay) ⭐ 18,940 | 🐛 819 | 🌐 Rust | 📅 2026-03-07 - Relay is a JavaScript framework for building data-driven React applications.
...
* [apollo-server](https://github.com/apollographql/apollo-server) ⭐ 13,949 | 🐛 79 | 🌐 TypeScript | 📅 2026-03-08 - Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
* [graphql-yoga](https://github.com/prisma-labs/graphql-yoga) ⭐ 8,492 | 🐛 128 | 🌐 TypeScript | 📅 2026-03-06 - Fully-featured GraphQL Server with focus on easy setup, performance and great developer experience.
...
* [graphitejs](https://github.com/graphitejs/server) ⭐ 121 | 🐛 16 | 🌐 JavaScript | 📅 2026-03-05 - Framework NodeJS for GraphQL.
...
* [graphql-scalars](https://github.com/Urigo/graphql-scalars) ⭐ 1,935 | 🐛 42 | 🌐 TypeScript | 📅 2026-03-07 - A library of custom GraphQL Scalars for creating precise type-safe GraphQL schemas.

#### Type

* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,221 | 🐛 621 | 🌐 TypeScript | 📅 2026-03-06: GraphQL code generator with flexible support for custom plugins and templates like TypeScript (frontend and backend), React Hooks, resolvers signatures and more.
...
* [gqloom](https://github.com/modevol-com/gqloom) ⭐ 93 | 🐛 9 | 🌐 TypeScript | 📅 2026-03-05 - GQLoom is a GraphQL weaver for TypeScript/JavaScript that weaves GraphQL schema and resolvers using [Valibot](https://github.com/fabian-hiller/valibot) ⭐ 8,478 | 🐛 139 | 🌐 TypeScript | 📅 2026-03-08, [Zod](https://github.com/colinhacks/zod) ⭐ 42,063 | 🐛 269 | 🌐 TypeScript | 📅 2026-02-15, or [Yup](https://github.com/jquense/yup) ⭐ 23,690 | 🐛 240 | 🌐 TypeScript | 📅 2026-03-07.
...
* [graphql-tools](https://github.com/apollographql/graphql-tools) ⭐ 5,420 | 🐛 154 | 🌐 TypeScript | 📅 2026-03-07 - Tool library for building and maintaining GraphQL-JS servers.
...
* [graphql-mesh](https://github.com/urigo/graphql-mesh) ⭐ 3,488 | 🐛 216 | 🌐 TypeScript | 📅 2026-03-06 - use GraphQL query language to access data in remote APIs that don't run GraphQL (and also ones that do run GraphQL).
* [schemathesis](https://github.com/schemathesis/schemathesis) ⭐ 3,092 | 🐛 40 | 🌐 Python | 📅 2026-03-08 - Runs arbitrary queries matching a GraphQL schema to find server errors.
...
* [graphql-modules](https://github.com/Urigo/graphql-modules) ⭐ 1,328 | 🐛 52 | 🌐 TypeScript | 📅 2026-03-07 - Separate GraphQL server into smaller, reusable parts by modules or features.
...
* [WunderGraph Cosmo](https://github.com/wundergraph/cosmo) ⭐ 1,173 | 🐛 144 | 🌐 TypeScript | 📅 2026-03-08 - The Open-Source GraphQL Federation Solution with Full Lifecycle API Management for (Federated) GraphQL. Schema Registry, composition checks, analytics, metrics, tracing and routing.
...
* [Next.js TypeScript and GraphQL Example](https://github.com/zeit/next.js/tree/canary/examples/with-typescript-graphql) ⭐ 138,201 | 🐛 3,420 | 🌐 JavaScript | 📅 2026-03-08 - A type-protected GraphQL example on Next.js running [graphql-codegen](https://graphql-code-generator.com/) under the hood
* [React Starter Kit](https://github.com/kriasoft/react-starter-kit) ⭐ 23,519 | 🐛 8 | 🌐 TypeScript | 📅 2026-03-02 - front-end starter kit using React, Relay, GraphQL, and JAM stack architecture.
...
* [NAPERG](https://github.com/alan345/naperg) ⭐ 1,368 | 🐛 0 | 🌐 TypeScript | 📅 2026-03-08 - Fullstack Boilerplate GraphQL. Made with React & Prisma + authentication & roles.
...
* [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,430 | 🐛 73 | 🌐 Ruby | 📅 2026-03-06 - Ruby implementation of Facebook's GraphQL.
...
* [graphql-php](https://github.com/webonyx/graphql-php) ⭐ 4,710 | 🐛 56 | 🌐 PHP | 📅 2026-03-07 - A PHP port of GraphQL reference implementation.
* [wp-graphql](https://github.com/wp-graphql/wp-graphql) ⭐ 3,770 | 🐛 109 | 🌐 PHP | 📅 2026-03-06 - GraphQL API for WordPress.
* [lighthouse](https://github.com/nuwave/lighthouse) ⭐ 3,480 | 🐛 133 | 🌐 PHP | 📅 2026-03-01 - A PHP package that allows to serve a GraphQL endpoint from your Laravel application.
...
* [strawberry](https://github.com/strawberry-graphql/strawberry) ⭐ 4,626 | 🐛 455 | 🌐 Python | 📅 2026-03-07 - A new GraphQL library for Python.
...
* [Ariadne](https://github.com/mirumee/ariadne) ⭐ 2,323 | 🐛 38 | 🌐 Python | 📅 2026-03-06 - library for implementing GraphQL servers using schema-first approach. Asynchronous query execution, batteries included for ASGI, WSGI and popular webframeworks, [fully documented](https://ariadnegraphql.org).
...
* [graphql-java](https://github.com/graphql-java/graphql-java) ⭐ 6,231 | 🐛 61 | 🌐 Java | 📅 2026-03-08 - GraphQL Java implementation.
* [DGS Framework](https://github.com/Netflix/dgs-framework) ⭐ 3,307 | 🐛 47 | 🌐 Kotlin | 📅 2026-03-02 - A GraphQL server framework for Spring Boot, developed by Netflix.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,715 | 🐛 109 | 🌐 Java | 📅 2026-03-07 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [Light Java GraphQL](https://github.com/networknt/light-graphql-4j) ⭐ 34 | 🐛 10 | 🌐 JavaScript | 📅 2026-03-04: A lightweight, fast microservices framework with all cross-cutting concerns addressed and ready to plug in GraphQL schema.
...
* [graphql-java-codegen-maven-plugin](https://github.com/kobylynskyi/graphql-java-codegen-maven-plugin) ⭐ 17 | 🐛 0 | 📅 2020-04-09 - Schema-first maven plugin for generating Java types and Resolver interfaces. Works perfectly in conjunction with graphql-java-tools. Inspired by [swagger-codegen-maven-plugin](https://github.com/swagger-api/swagger-codegen/tree/master/modules/swagger-codegen-maven-plugin) ⭐ 17,718 | 🐛 3,444 | 🌐 Mustache | 📅 2026-02-18.
...
* [graphql-java-datetime](https://github.com/donbeave/graphql-java-datetime) ⭐ 151 | 🐛 13 | 🌐 Java | 📅 2026-03-04 - GraphQL ISO Date is a set of RFC 3339 compliant date/time scalar types to be used with graphql-java.

<a name="java-example" />

#### Java Examples

* [light-java-graphql examples](https://github.com/networknt/light-example-4j/tree/master/graphql) ⭐ 150 | 🐛 11 | 🌐 Java | 📅 2026-03-04 - Examples of Light Java GraphQL and tutorials.
...
* [graphql-kotlin](https://github.com/ExpediaGroup/graphql-kotlin) ⭐ 1,799 | 🐛 90 | 🌐 Kotlin | 📅 2026-03-03 - GraphQL Kotlin implementation.
...
* [gqlgen](https://github.com/99designs/gqlgen) ⭐ 10,679 | 🐛 379 | 🌐 Go | 📅 2026-03-07 - Go generate based graphql server library.
...
* [sangria](https://github.com/sangria-graphql/sangria) ⭐ 1,963 | 🐛 62 | 🌐 Scala | 📅 2026-03-05 - Scala GraphQL server implementation.
* [caliban](https://github.com/ghostdogpr/caliban) ⭐ 986 | 🐛 27 | 🌐 Scala | 📅 2026-03-07 - Caliban is a purely functional library for creating GraphQL backends in Scala.
...
* [graphql-dotnet](https://github.com/graphql-dotnet/graphql-dotnet) ⭐ 5,983 | 🐛 113 | 🌐 C# | 📅 2026-03-07 - GraphQL for .NET.
* [Hot Chocolate](https://github.com/ChilliCream/hotchocolate) ⭐ 5,672 | 🐛 381 | 🌐 C# | 📅 2026-03-07 - GraphQL server for .Net Core and .NET Framework.
...
* [Snowflaqe](https://github.com/Zaid-Ajaj/Snowflaqe) ⭐ 160 | 🐛 22 | 🌐 F# | 📅 2024-10-10 - Type-safe GraphQL code generator for F# and [Fable](https://github.com/fable-compiler/Fable) ⭐ 3,065 | 🐛 233 | 🌐 F# | 📅 2026-03-07
...
* [absinthe-graphql](https://github.com/absinthe-graphql/absinthe) ⭐ 4,394 | 🐛 75 | 🌐 Elixir | 📅 2026-02-09 - Fully Featured Elixir GraphQL Library.
...
* [Hasura](https://github.com/hasura/graphql-engine) ⭐ 31,913 | 🐛 2,375 | 🌐 TypeScript | 📅 2026-03-06 - Hasura gives Instant Realtime GraphQL APIs over PostgreSQL. Works with an existing database too.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,911 | 🐛 150 | 🌐 TypeScript | 📅 2026-03-06 - Lightning-fast GraphQL APIs for PostgreSQL: highly customisable; extensible via plugins; realtime.
...
* [apollo-android](https://github.com/apollographql/apollo-android) ⭐ 3,950 | 🐛 113 | 🌐 Kotlin | 📅 2026-03-06 - 📟 A strongly-typed, caching GraphQL client for Android, written in Java.
* [manifold-graphql](https://github.com/manifold-systems/manifold/tree/master/manifold-deps-parent/manifold-graphql) ⭐ 2,715 | 🐛 109 | 🌐 Java | 📅 2026-03-07 - Comprehensive GraphQL client use. Schema-first. Type-safe GraphQL types, queries, and results, no code generators, no POJOs, no annotations. Excellent [IDE support](http://manifold.systems/images/graphql.mp4) with IntelliJ IDEA and Android Studio. See the [Java example](#example-java) below.
...
* [juniper](https://github.com/graphql-rust/juniper) ⭐ 5,944 | 🐛 104 | 🌐 Rust | 📅 2026-03-06 - GraphQL server library for Rust.
* [async-graphql](https://github.com/async-graphql/async-graphql) ⭐ 3,633 | 🐛 239 | 🌐 Rust | 📅 2026-03-06 - High-performance server-side library that supports all GraphQL specifications.
* [tailcall](https://github.com/tailcallhq/tailcall) ⭐ 1,432 | 🐛 12 | 🌐 Rust | 📅 2026-03-05 - A platform for building high-performance GraphQL backends.
...
* [graphql-crystal](https://github.com/ziprandom/graphql-crystal) ⭐ 213 | 🐛 9 | 🌐 Crystal | 📅 2020-07-01 - library inspired by [graphql-ruby](https://github.com/rmosolgo/graphql-ruby) ⭐ 5,430 | 🐛 73 | 🌐 Ruby | 📅 2026-03-06 & [go-graphql](https://github.com/playlyfe/go-graphql) ⭐ 246 | 🐛 18 | 🌐 Go | 📅 2020-01-22 & [graphql-parser](https://github.com/graphql-dotnet/parser) ⭐ 220 | 🐛 7 | 🌐 C# | 📅 2026-02-27.
...
* [Bruno](https://github.com/usebruno/bruno) ⭐ 41,502 | 🐛 1,747 | 🌐 JavaScript | 📅 2026-03-06 - Fast, open source API client, which stores collections offline-only in a Git-friendly plain text markup language.
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,803 | 🐛 411 | 🌐 TypeScript | 📅 2026-03-05 - An in-browser IDE for exploring GraphQL.
* [GraphQL Voyager](https://github.com/APIs-guru/graphql-voyager) ⭐ 8,092 | 🐛 105 | 🌐 TypeScript | 📅 2026-02-22 - Represent any GraphQL API as an interactive graph.
* [GraphQL Editor](https://github.com/graphql-editor/graphql-editor) ⭐ 6,075 | 🐛 20 | 🌐 TypeScript | 📅 2025-09-10 - Visual Editor & GraphQL IDE.
* [Altair GraphQL Client](https://github.com/altair-graphql/altair) ⭐ 5,394 | 🐛 48 | 🌐 TypeScript | 📅 2026-03-07 - A beautiful feature-rich GraphQL Client for all platforms.
...
* [graphql-to-karate](https://github.com/wbaldoumas/graphql-to-karate) ⭐ 16 | 🐛 3 | 🌐 C# | 📅 2026-03-07 - **Generate Karate API tests** from your GraphQL schemas
...
* [GraphQL Cop](https://github.com/dolevf/graphql-cop) ⭐ 613 | 🐛 1 | 🌐 Python | 📅 2025-11-20 - Security Audit Utility for GraphQL
...
* [Apollo Client Developer Tools](https://github.com/apollographql/apollo-client-devtools) ⭐ 1,524 | 🐛 51 | 🌐 TypeScript | 📅 2026-03-08 - GraphQL debugging tools for Apollo Client in the Chrome developer console
...
* [Prisma](https://github.com/prisma/prisma) ⭐ 45,471 | 🐛 2,510 | 🌐 TypeScript | 📅 2026-03-05 - Turn your database into a GraphQL API. Prisma lets you design your data model and have a production ready GraphQL API online in minutes.
* [Bit](https://github.com/teambit/bit) ⭐ 18,360 | 🐛 66 | 🌐 TypeScript | 📅 2026-03-06 - Organize GraphQL API as components to be consumed with NPM or modified from any project, [example-explanation](https://hackernoon.com/make-your-graphql-api-easier-to-adopt-through-components-74b022f195c1)).
...
* [graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) ⭐ 11,221 | 🐛 621 | 🌐 TypeScript | 📅 2026-03-06 - GraphQL code generator based on schema and documents.
...
* [raphql-inspector](https://github.com/kamilkisiela/graphql-inspector) ⭐ 1,738 | 🐛 133 | 🌐 TypeScript | 📅 2026-03-07: alidate schema, get schema change notifications, validate operations, find breaking changes, look for similar types, schema coverage.
* [openapi-to-graphql](https://github.com/ibm/openapi-to-graphql) ⭐ 1,645 | 🐛 141 | 🌐 TypeScript | 📅 2025-09-17 - Take any OpenAPI Specification (OAS) or swagger and create a GraphQL interface - Two minute video and resources [here](https://developer.ibm.com/open/projects/openapi-to-graphql/)
...
* [ts-graphql-plugin](https://github.com/Quramy/ts-graphql-plugin) ⭐ 760 | 🐛 29 | 🌐 TypeScript | 📅 2026-03-07 - A language service plugin complete and validate GraphQL query in TypeScript template strings.
...
* [Cube](https://cube.dev) - [Headless BI](https://cube.dev/blog/headless-bi) for building data applications with SQL, REST, and [GraphQL API](https://cube.dev/docs/backend/graphql). Connect any database or data warehouse and instantly get a GraphQL API with sub-second latency on top of it. - [Source Code](https://github.com/cube-js/cube.js) ⭐ 19,595 | 🐛 887 | 🌐 Rust | 📅 2026-03-07
* [Weaviate](https://github.com/semi-technologies/weaviate) ⭐ 15,757 | 🐛 591 | 🌐 Go | 📅 2026-03-07 - Weaviate is a cloud-native, modular, real-time vector search engine with a [GraphQL interface](https://weaviate.io/developers/weaviate/api/graphql) built to scale your machine learning models.
...
* [Saleor](https://github.com/mirumee/saleor/) ⭐ 22,670 | 🐛 246 | 🌐 Python | 📅 2026-03-06 - GraphQL-first headless e-commerce platform.
